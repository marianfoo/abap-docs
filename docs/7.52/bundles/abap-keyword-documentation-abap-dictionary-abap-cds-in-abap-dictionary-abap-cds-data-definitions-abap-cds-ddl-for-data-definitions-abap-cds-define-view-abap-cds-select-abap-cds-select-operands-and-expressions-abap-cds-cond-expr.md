...
The following tables show you which [predefined data types](javascript:call_link\('abenddic_builtin_types.htm'\)) of the ABAP Dictionary can be [compared](javascript:call_link\('abencds_cond_expr_comp.htm'\)) with each other in a [condition](javascript:call_link\('abencds_f1_conditional_expression.htm'\)) of a [CDS view](javascript:call_link\('abencds_view_glosry.htm'\) "Glossary Entry").
...
Rules for conditions [cond\_exp](javascript:call_link\('abencds_f1_conditional_expression.htm'\)) in a [CDS view](javascript:call_link\('abencds_view_glosry.htm'\) "Glossary Entry"):
...
-   A field of the source data source cannot be specified using an alternative element name of the current CDS defined using [AS](javascript:call_link\('abencds_f1_select_list_entry.htm'\)).
...
-   lhs expects a [field](javascript:call_link\('abencds_f1_field.htm'\)) of the target data source of the current [association](javascript:call_link\('abencds_f1_association.htm'\)).
...
Rules for conditions [cond\_exp](javascript:call_link\('abencds_f1_conditional_expression.htm'\)) in a [complex case distinction](javascript:call_link\('abencds_f1_searched_case_expr.htm'\)) of a [CDS view](javascript:call_link\('abencds_view_glosry.htm'\) "Glossary Entry"):
