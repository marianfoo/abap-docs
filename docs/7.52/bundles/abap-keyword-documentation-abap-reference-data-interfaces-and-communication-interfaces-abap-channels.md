...
description: |
  !Example(exa.gif 'Example') APC, AS ABAP as WebSocket Server(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenapc_abexa.htm) !Example(exa.gif 'Example') APC, AS ABAP as WebSocket Client(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenapc_ws_client_abexa.htm) !Ex
version: "7.52"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenapc_abexas.htm"
...
Continue
![Example](exa.gif "Example") [APC, AS ABAP as WebSocket Server](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenapc_abexa.htm)
![Example](exa.gif "Example") [APC, AS ABAP as WebSocket Client](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenapc_ws_client_abexa.htm)
![Example](exa.gif "Example") [APC, AS ABAP as TCP Socket Client](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenapc_tcp_client_abexa.htm)
![Example](exa.gif "Example") [APC, Creating a Detached Client](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenapc_detached_client_abexa.htm)
![Example](exa.gif "Example") [APC, AS ABAP as Attached Client](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenapc_attached_client_abexa.htm)
![Example](exa.gif "Example") [APC, System-Wide Access](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenapc_connect_via_handle_abexa.htm)
...
description: |
  This example demonstrates ABAP push channels(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenapc_glosry.htm 'Glossary Entry') in AS ABAP as a WebSocket server. Source Code REPORT demo_apc_wsp. CLASS demo DEFINITION. PUBLIC SECTION. CLASS-METHODS main. CLASS-METHODS class_construc
version: "7.52"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenapc_abexa.htm"
...
This example demonstrates [ABAP push channels](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenapc_glosry.htm "Glossary Entry") in AS ABAP as a WebSocket server.
...
-   Is the APC in question associated with an [ABAP messaging channel (AMC)](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenamc.htm)?

-   Is an APC used together with the [Push Channel Protocol (PCP)](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenpush_channel_protocol_glosry.htm "Glossary Entry") or is an APC used without this protocol?

-   Is a stateful service used when the subprotocol PCP is used?

The Web page is provided by an [ICF](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenicf.htm) HTTP service whose URL is constructed in the program for the current application server. If the standard browser does not support communication using the WebSocket protocol, the URL must be opened using a suitable browser instead.
...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenapc_ws_client_abexa.htm"
...
This example demonstrates how an ABAP program can create an [APC client](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenapc.htm) for the WebSocket protocol.
...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenapc_tcp_client_abexa.htm"
...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenapc_connect_via_handle_abexa.htm"
...
An APC connection from the executable example [AS ABAP as WebSocket Server](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenapc_abexa.htm) publishes its connection handle as follows:
