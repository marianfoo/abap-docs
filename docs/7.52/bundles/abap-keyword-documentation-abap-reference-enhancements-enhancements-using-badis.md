...
- [abenbadi_enhancement.htm](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenbadi_enhancement.htm)
- [abapget_badi.htm](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapget_badi.htm)
- [abapcall_badi.htm](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapcall_badi.htm)
...
> **📖 Official SAP Documentation**: [abenbadi_enhancement.htm](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenbadi_enhancement.htm)
...
-   Whether a BAdI is intended for single or multiple use. If a BAdI is intended for single use, only a single [BAdI implementation can be used in one](javascript:call_link\('abenbadi_implementation_glosry.htm'\) "Glossary Entry") [internal session](javascript:call_link\('abeninternal_session_glosry.htm'\) "Glossary Entry"), and one BAdI implementation must be available for each use.
...
**📖 Source**: [abenbadi_enhancement.htm](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenbadi_enhancement.htm)

### abapget_badi.htm

> **📖 Official SAP Documentation**: [abapget_badi.htm](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapget_badi.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abapget_badi.htm](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapget_badi.htm)

### abapcall_badi.htm

> **📖 Official SAP Documentation**: [abapcall_badi.htm](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapcall_badi.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.


**📖 Source**: [abapcall_badi.htm](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapcall_badi.htm)
