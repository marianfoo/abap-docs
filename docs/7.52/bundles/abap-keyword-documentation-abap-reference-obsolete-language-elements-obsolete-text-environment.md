...
description: |
  -   SET LOCALE - obsolete_parameters(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapset_locale_obsolete.htm) -   GET LOCALE - obsolete_parameters(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapget_locale_obsolete.htm) SET LOCALE - obsolete_parameters(https://
version: "7.52"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abentext_environment_obsolete.htm"
...
-   [SET LOCALE - obsolete\_parameters](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapset_locale_obsolete.htm)

-   [GET LOCALE - obsolete\_parameters](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapget_locale_obsolete.htm)
...
description: |
  ... COUNTRY cntry MODIFIER mod Extras: 1. ... COUNTRY cntry(#!ABAP_ADDITION_1@1@) 2. ... MODIFIER mod(#!ABAP_ADDITION_2@2@) Effect ABAP syntax allows you to specify the additions COUNTRY and MODIFIER for the statementSET LOCALE LANGUAGE(https://help.sap.com/doc/abapdocu_752_i
version: "7.52"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapset_locale_obsolete.htm"
...
title: "Obsolete Syntax"
description: |
  ... COUNTRY cntry MODIFIER mod Extras: 1. ... COUNTRY cntry(#!ABAP_ADDITION_1@1@) 2. ... MODIFIER mod(#!ABAP_ADDITION_2@2@) Effect Although ABAP syntax requires the specification of the additions COUNTRY and MODIFIER for the statement GET LOCALE(https://help.sap.com/doc/abapdocu_752_index_ht
version: "7.52"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapget_locale_obsolete.htm"
...
Although ABAP syntax requires the specification of the additions COUNTRY and MODIFIER for the statement [GET LOCALE](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapget_locale.htm), you should not use the results of these additions.
...
The addition COUNTRY of the statement GET LOCALE does not extract the [formatting setting](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenformat_setting_glosry.htm "Glossary Entry") that can be set using [SET COUNTRY](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapset_country.htm).
