...
description: |
  The mesh path result is a description of a set of rows in the last node path node of the expression. The result is used in statements and expressions for using mesh paths(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenmesh_path_usage.htm) (with one exception); either for navigating
version: "7.52"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenmesh_path_result.htm"
...
---
title: "Meshes - Result of Initial Association"
description: |
  An initial association with the syntax(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenmesh_path.htm) ...rnode_associ(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenmesh_path_assoc.htm) source cond(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-
version: "7.52"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenmesh_path_result_init_assoc.htm"
...
description: |
  A path extension with the syntax(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenmesh_path.htm) ..._assoc1(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenmesh_path_assoc.htm)  cond(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenmesh_path_
version: "7.52"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenmesh_path_result_chaining.htm"
...
A path extension with the [syntax](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenmesh_path.htm)

...[\\\_assoc1](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenmesh_path_assoc.htm)\[ *\[* [cond](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenmesh_path_assoc_cond.htm)*\]* \] [\\\_assoc2](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenmesh_path_assoc.htm)\[ *\[*[cond](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenmesh_path_assoc_cond.htm)*\]* \] ...
...
-   All rows meet the [ON condition](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abaptypes_mesh_association.htm) of the association used with respect to the set of rows described in the preceding association. Every tcomp column specified in the ON condition has the same content as in the scomp column (of the root node a row of its result) assigned to the ON condition.
...
description: |
  !Example(exa.gif 'Example') Forward Associations in Mesh Paths(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenmesh_for_forward_abexa.htm) !Example(exa.gif 'Example') Inverse Associations in Mesh Paths(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenmesh_for_inv
version: "7.52"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenmesh_path_result_abexas.htm"
...
Continue
![Example](exa.gif "Example") [Forward Associations in Mesh Paths](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenmesh_for_forward_abexa.htm)
![Example](exa.gif "Example") [Inverse Associations in Mesh Paths](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenmesh_for_inverse_abexa.htm)
![Example](exa.gif "Example") [Reflexive Associations in Mesh Paths](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenmesh_for_reflex_sngl_abexa.htm)
...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenmesh_for_forward_abexa.htm"
...
[Table comprehensions](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenmesh_for.htm) are used to construct and return internal tables that are described using forward associations in the mesh nodesmesh-node2 and mesh-node3.
...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenmesh_for_inverse_abexa.htm"
...
[Table comprehensions](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenmesh_for.htm) are used to construct and return internal tables that are described using inverse associations in the mesh nodesmesh-node2 and mesh-node1.
