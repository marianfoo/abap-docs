...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenevent_blocks.htm"
abapFile: "abenevent_blocks.htm"
keywords: ["select", "do", "try", "method", "class", "data", "types", "abenevent", "blocks"]
---
...
Within an event block, no local data types or data objects can be declared. All declarative statements in event blocks belong to the ABAP program, and are visible in all subsequent processing blocks. An event block works with the global data types and data objects of the [framework program](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenframe_program_glosry.htm "Glossary Entry"), and therefore should not contain any of its own declarations. Exception: The event blocks AT SELECTION-SCREEN ... and GET ... are implemented internally as procedures and can contain local data).
...
-   [Program constructor event](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenprogram_constructor.htm)
    This event occurs in all [program types](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenprogram_type_glosry.htm "Glossary Entry"), except for class pools and interface pools.

-   [Reporting Events](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenabap_processing_blocks.htm)
    These events only occur in [executable programs](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenexecutable_program_glosry.htm "Glossary Entry").

-   [Selection screen and list events](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenabap_screen_events.htm) occur during [selection screen processing](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenexecutable_program_glosry.htm "Glossary Entry") or [list processing](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenlist_processing_glosry.htm "Glossary Entry").

Programming Guideline

[No implementations in dialog modules and event blocks](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abendial_mod_event_block_guidl.htm "Guideline")

Notes

-   When the execution of each event block is completed, the statement [NEW-LINE](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapnew-line.htm) is executed.

-   With the exception of AT SELECTION-SCREEN ... and GET ... event blocks can be listed multiple times in a program. Event block [START-OF-SELECTION](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapstart-of-selection.htm) can also be implicitly listed multiple times. Whenever an event occurs, all associated event blocks are executed in the order of their occurrence. Where event blocks are implicitly listed multiple times, the extended program check posts a warning.

Continue
[Program Constructor](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenprogram_constructor.htm)
[Reporting Events](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenabap_processing_blocks.htm)
[Selection Screen and List Events](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenabap_screen_events.htm)
...
description: |
  The program constructor can be used to initialize the global data of a program. It is introduced using the statement -   LOAD-OF-PROGRAM(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapload-of-program.htm) The associated event occurs when a program is loaded into the internal sessi
version: "7.52"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenprogram_constructor.htm"
...
description: |
  Event key words for reporting(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenreporting_glosry.htm 'Glossary Entry') events include: -   INITIALIZATION(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapinitialization.htm), -   START-OF-SELECTION(https://help.sap.com
version: "7.52"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenabap_processing_blocks.htm"
...
description: |
  Quick Reference(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapinitialization_shortref.htm) Syntax INITIALIZATION. Effect This event keyword defines an event block for initializing an executable program. The associated event is raised by the ABAP runtime environment(https://help.
version: "7.52"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapinitialization.htm"
...
[Quick Reference](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapinitialization_shortref.htm)
...
description: |
  Selection screen and list events are events from classical screen(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abendynpro_glosry.htm 'Glossary Entry') processing, which are converted by the ABAP runtime environment into ABAP events and are handled directly in the ABAP program instead
version: "7.52"
category: "ui"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenabap_screen_events.htm"
...
Selection screen and list events are events from classical [screen](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abendynpro_glosry.htm "Glossary Entry") processing, which are converted by the ABAP runtime environment into ABAP events and are handled directly in the ABAP program instead of in the [dynpro flow logic](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abendynpro_flow_logic_glosry.htm "Glossary Entry").

-   [Selection screen events](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenselection_screen_events.htm)occur during [selection screen processing](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenexecutable_program_glosry.htm "Glossary Entry").

-   [List events](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenabap_lists_interactive.htm) occur during classical [list processing](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenlist_processing_glosry.htm "Glossary Entry").
