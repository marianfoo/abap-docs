...
[Quick Reference](javascript:call_link\('abapadd_then_from_shortref.htm'\))
...
The [calculation type](javascript:call_link\('abenarith_type.htm'\)) of the addition is, as usual, determined from the operands in question.
