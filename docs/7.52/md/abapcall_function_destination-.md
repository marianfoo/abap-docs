...
description: |
  Quick Reference(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapcall_function_shortref.htm) Syntax Forms Synchronous RFC(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapcall_function_destination.htm) 1. CALL FUNCTION func DESTINATION dest parameter_list(https://
version: "7.52"
category: "general"
type: "abap-reference"
...
keywords: ["do", "while", "if", "try", "class", "data", "internal-table", "abapcall", "function", "destination"]
---
