...
If the data object func is specified as a [variable](javascript:call_link\('abenconstant_glosry.htm'\) "Glossary Entry"), it is specified only dynamically and the content is not evaluated statically.
