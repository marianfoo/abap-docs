...
-   All [concrete](javascript:call_link\('abenconcrete_glosry.htm'\) "Glossary Entry") methods that are declared using [METHODS](javascript:call_link\('abapmethods.htm'\)) or [CLASS-METHODS](javascript:call_link\('abapclass-methods.htm'\)) in the declaration part of the class.
    
-   All concrete methods of interfaces that are specified by the statement [INTERFACES](javascript:call_link\('abapinterfaces.htm'\)) in the declaration part of the class.
    
-   All methods inherited from superclasses that are specified by the statement [METHODS ... REDEFINITION](javascript:call_link\('abapmethods_redefinition.htm'\)) in the declaration part of the class.
