...
Declaration of the public class CL\_DEMO\_FLIGHT\_LIST. Class is shared-memory-enabled and [root class](javascript:call_link\('abenroot_class_glosry.htm'\) "Glossary Entry") of the [area](javascript:call_link\('abenarea_glosry.htm'\) "Glossary Entry") CL\_DEMO\_FLIGHTS, which is managed in transaction SHMA.
