...
-   [*\[*GLOBAL*\]* FRIENDS *\[*class1 class2 ...*\]* *\[* intf2 ...*\]*](javascript:call_link\('abapclass_options.htm'\))
    Describes other classes class1 class2 ... or interfaces intf1 intf2 ... as [friends](javascript:call_link\('abenfriend_glosry.htm'\) "Glossary Entry"), which are permitted to access all components of class.