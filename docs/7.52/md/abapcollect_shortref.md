...
description: |
  Reference(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapcollect.htm) Syntax COLLECT wa INTO itab  ASSIGNING <fs> CASTING  REFERENCE INTO dref . Effect Inserts work areas wa as rows in an internal table itab. Here, the primary table key already exis
version: "7.52"
category: "ui"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapcollect_shortref.htm"
