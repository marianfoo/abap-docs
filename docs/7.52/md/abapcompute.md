...
If functional method calls, predefined functions, constructor expressions, or table expressions are specified on the right side, COMPUTE works like an [assignment of return values](javascript:call_link\('abenequals_return_values.htm'\)).
