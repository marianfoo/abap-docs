...
-   [HANDLE handle](javascript:call_link\('abapcreate_data_handle.htm'\))
    Specifies the data type using a handle reference to an [RTTS](javascript:call_link\('abenrtts_glosry.htm'\) "Glossary Entry") [type description object](javascript:call_link\('abentype_object_glosry.htm'\) "Glossary Entry").