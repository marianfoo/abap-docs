...
INSERT [line\_spec](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapinsert_itab_linespec.htm) INTO [itab\_position](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapinsert_itab_position.htm) *\[*[result](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapinsert_itab_result.htm)*\]*.

Effect

This statement adds one or more rows [line\_spec](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapinsert_itab_linespec.htm) to a position [itab\_position](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapinsert_itab_position.htm) in an internal table. The position can be specified using the primary table key or a table index. Use [result](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapinsert_itab_result.htm) when appending a single row to set a reference to the appended row in the form of a field symbol or a data reference.

When the row is in inserted, all existing unique table keys are checked. These can be a [primary table key](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenprimary_table_key_glosry.htm "Glossary Entry") and multiple unique [secondary table keys](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abensecondary_table_key_glosry.htm "Glossary Entry"). The system handles any duplicates of the various key according to the following hierarchy:
...
2.  If attempting to insert a single row using the key or the index would produce duplicates with respect to a unique secondary key, a handleable exception of the class CX\_SY\_ITAB\_DUPLICATE\_KEY is raised.
...
-   A special variant [INSERT mesh\_path](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenmesh_insert.htm) can be used to insert rows into the last node of a [mesh path](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenmesh_path_glosry.htm "Glossary Entry").
    

Example

Inserts single rows in a [standard table](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenstandard_table_glosry.htm "Glossary Entry") int\_tab using the table index and inserts references to these rows in a [hashed table](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenhashed_table_glosry.htm "Glossary Entry") ref\_tab using the table key. The output in the [LOOP](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abaploop_at_itab.htm) loops produces the numbers 10 to 1 for int\_tab and the numbers 1 to 10 for ref\_tab.
...
Continue
[INSERT - line\_spec](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapinsert_itab_linespec.htm)
[INSERT - itab\_position](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapinsert_itab_position.htm)
[INSERT - result](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapinsert_itab_result.htm)
![Example](exa.gif "Example") [Internal Tables, Inserting Rows](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abeninsert_lines_abexa.htm)