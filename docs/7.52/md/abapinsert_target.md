...
-   The addition CLIENT SPECIFIED cannot be used if a subquery is used as the [data source](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapinsert_source.htm).
