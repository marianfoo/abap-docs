...
-   the [output behavior](javascript:call_link\('abaploop_at_itab_group_by_binding.htm'\)) cannot be defined for a row of the group as a representative, a group key binding must be defined,
