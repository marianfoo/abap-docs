...
The [DDL source code](javascript:call_link\('abenddl_source_code_glosry.htm'\) "Glossary Entry") that defines the actual [CDS entity](javascript:call_link\('abencds_entity_glosry.htm'\) "Glossary Entry") DEMO\_CDS\_SPFLI\_CLIENT\_0A looks like this:
