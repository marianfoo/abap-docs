...
description: |
  Quick Reference(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapmodify_itab_shortref.htm) Syntax ...  ASSIGNING <fs> CASTING    REFERENCE INTO dref . Effect These additions are possible only when modifying single rows(https://help.sap.com/doc/abapdocu_752_in
version: "7.52"
category: "data-structures"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapmodify_itab_result.htm"
...
These additions are possible only when modifying [single rows](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapmodify_itab_single.htm). If modified successfully, the addition ASSIGNING is used to assign the row to a field symbol and the addition REFERENCE INTO is used to set a reference to the modified row in a reference variable.
