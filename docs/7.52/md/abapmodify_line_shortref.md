...
description: |
  Reference(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapmodify_line.htm) Syntax MODIFY  LINE line OF PAGE pageCURRENT PAGE INDEX idx  CURRENT LINE  LINE VALUE FROM wa FIELD VALUE dobj1 FROM wa1 dobj2 FROM
version: "7.52"
category: "ui"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapmodify_line_shortref.htm"
...
[Reference](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapmodify_line.htm)
...
-   [LINE line](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapmodify_line.htm)
    Specifies the line to be changed in line.
    
-   [OF *{*PAGE page*}**|**{*CURRENT PAGE*}*](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapmodify_line.htm)
    Specifies the page in page or the top page displayed in the list in which a list event was raised.
    
-   [INDEX idx](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapmodify_line.htm)
    Specifies the list index in idx. If not specified, the list level is used on which a list event was raised.
    
-   [CURRENT LINE](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapmodify_line.htm)
    Specifies the line in which a list event was raised.
    
-   [LINE VALUE FROM wa](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapmodify_line_modification.htm)
    Overwrites the whole list line with the content of wa.
    
-   [FIELD VALUE dobj1 *\[*FROM wa1*\]* dobj2 *\[*FROM wa2*\]* ...](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapmodify_line_modification.htm)
...
-   [LINE FORMAT ext\_format\_options](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapmodify_line_modification.htm)
    Formats the whole list line using the additions of the statement FORMAT.
    
-   [FIELD FORMAT dobj1 ext\_format\_options1 dobj2 ext\_format\_options2 ...](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapmodify_line_modification.htm)
