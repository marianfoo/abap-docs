...
title: "PUT"
description: |
  Quick Reference(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapput_shortref.htm) Obsolete Syntax PUT  node  <node> . Effect This statement is only allowed in the database program(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abendatabase_program_glosry.htm '
version: "7.52"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapput.htm"
...
[Quick Reference](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapput_shortref.htm)
...
The database program must contain one of the statements [NODES](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapnodes.htm) or [TABLES](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abaptables.htm) for the node node. The syntax of the statement PUT is based on the [node type](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapnodes.htm).
...
-   See also [Database Program](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenldb_program.htm).
