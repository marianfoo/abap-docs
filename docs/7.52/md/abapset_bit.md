...
title: "SET BIT"
description: |
  Quick Reference(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapset_bit_shortref.htm) Syntax SET BIT bitpos OF byte_string TO val. Effect This statement sets the bit in bit position bitpos of the variable byte_string to 1 or, if specified, to the value of data object val.
version: "7.52"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapset_bit.htm"
abapFile: "abapset_bit.htm"
keywords: ["loop", "do", "if", "try", "data", "abapset", "bit"]
---
...
[Quick Reference](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapset_bit_shortref.htm)
...
-   If byte\_string has the [deep](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abendeep_glosry.htm "Glossary Entry") type xstring, a bit is set in the referenced byte string, not in the reference.
    
-   Setting single bits is especially suited to preparing operators in [bit expressions](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapcompute_bit.htm).
    
-   The predefined function [bit-set](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenbit_functions.htm) can also be used to set an individual bit.
