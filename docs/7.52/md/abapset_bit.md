...
[Quick Reference](javascript:call_link\('abapset_bit_shortref.htm'\))
...
-   Setting single bits is especially suited to preparing operators in [bit expressions](javascript:call_link\('abapcompute_bit.htm'\)).
    
-   The predefined function [bit-set](javascript:call_link\('abenbit_functions.htm'\)) can also be used to set an individual bit.
