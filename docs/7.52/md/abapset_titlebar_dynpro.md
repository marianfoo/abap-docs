...
-   The GUI title of the dynpro must be set before the [PBO](javascript:call_link\('abenpbo_glosry.htm'\) "Glossary Entry") event. If no GUI title is set for a dynpro, the word "SAP" is displayed in the title bar.
