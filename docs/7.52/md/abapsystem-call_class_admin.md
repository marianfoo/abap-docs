...
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapsystem-call_class_admin.htm"
...
[9\. SYSTEM-CALL QUERY METHOD INCLUDE FROM incl CLASS INTO c](#!ABAP_VARIANT_9@9@)
                                              METHOD INTO m.
...
Entry for method m in class c created.
...
If the optional addition AS EXTENSION is specified, the method is flagged as an enhancement method ( [enhancement implementation element](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenenhancement_impl_elem_glosry.htm "Glossary Entry")).
...
Addition 2,,... NO EXTENSIONS

Effect

If the optional addition NO EXTENSIONS is specified, the call only sets sy-subrc to 0 if the method searched for is not flagged as an enhancement method [enhancement implementation element](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenenhancement_impl_elem_glosry.htm "Glossary Entry")).
...
No entry for m in class c exists.
...
Entry for method m in class c renamed.
...
The system checks whether or not a method entry exists for the method specified in the include name incl. If so, the class name in c and the method name in m.
Return Value
...
-   Cause: Basic entry for class c does not exist.
