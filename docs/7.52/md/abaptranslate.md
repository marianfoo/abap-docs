...
title: "TRANSLATE"
description: |
  Quick Reference(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abaptranslate_shortref.htm) Syntax TRANSLATE text TO UPPERLOWER CASE  USING mask. Extras:  1. ... TO UPPERLOWER CASE(#!ABAP_ADDITION_1@1@)  2. ... USING mask(#!ABAP_ADDITION_2@2@) Effe
version: "7.52"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abaptranslate.htm"
...
[Quick Reference](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abaptranslate_shortref.htm)
...
To modify the case of the letters in a character string in an operand position, a [case function](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abencase_functions.htm) can be used that includes the functions of the statement TRANSLATE.
...
To translate a character string in an operand position, a [translate function](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abentranslate_functions.htm) that includes the functions of the statement TRANSLATE can also be used.
