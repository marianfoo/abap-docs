...
[Using Predefined Types](javascript:call_link\('abaptypes_simple.htm'\))
...
Outside classes, LIKE can also be used with an [obsolete type reference](javascript:call_link\('abenlike_obsolete.htm'\)).
