...
title: "TYPES - BOXED"
description: |
  Quick Reference(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abaptypes_begin_of_shortref.htm) Syntax TYPES comp TYPE struc_type BOXED. Effect This statement defines a substructure comp of a structure as a static box(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenst
version: "7.52"
category: "types"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abaptypes_boxed.htm"
...
This statement defines a substructure comp of a structure as a [static box](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenstatic_boxes.htm). It can only be located within a structure definition with the additions [BEGIN OF](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abaptypes_struc.htm) and [END OF](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abaptypes_struc.htm) of the statement TYPES, and only at the top component level and not within nested BEGIN OF ... END OF blocks.
...
-   The addition BOXED can also be used in the statement [DATA](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapdata_boxed.htm) to declare a structured attribute of a class or an interface.
