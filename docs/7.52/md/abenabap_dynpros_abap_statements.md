...
description: |
  The following statements can be used to call and process dynpros(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abendynpro_glosry.htm 'Glossary Entry') in an ABAP program: -   CALL SCREEN(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapcall_screen.htm) -   SET PF-STAT
version: "7.52"
category: "ui"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenabap_dynpros_abap_statements.htm"
