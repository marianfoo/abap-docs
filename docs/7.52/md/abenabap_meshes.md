...
These are special [structures](javascript:call_link\('abenstructure_glosry.htm'\) "Glossary Entry"). Their components (referred to as nodes) are either structured internal tables or reference variables that point to structured internal tables.
