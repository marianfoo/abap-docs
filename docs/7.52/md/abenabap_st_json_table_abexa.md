...
The example demonstrates the simple transformation of an internal table into[JSON data](javascript:call_link\('abenjson_oview.htm'\)).
...
The transformation is written in a way that means the generated XML data have a valid [JSON XML](javascript:call_link\('abenabap_json_xml.htm'\)) format.
