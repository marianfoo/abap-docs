...
Readers of this class parse XML data from a HTTP service in [ICF](javascript:call_link\('abenicf_glosry.htm'\) "Glossary Entry").
...
[Transformation from a XML Reader](javascript:call_link\('abensxml_trafo_from_reader_abexa.htm'\))
