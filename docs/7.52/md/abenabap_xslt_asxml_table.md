...
The asXML representation of internal tables is mainly relevant for XSL transformations. In simple transformations, this representation is important only when using the statement [tt:copy](javascript:call_link\('abenst_tt_copy.htm'\)).
