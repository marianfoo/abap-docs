...
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenappend_lines_abexa.htm"
...
It could be better to use the value operator [VALUE for internal tables](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenvalue_constructor_params_itab.htm) rather than using APPEND VALUE #( ... ) shown here.