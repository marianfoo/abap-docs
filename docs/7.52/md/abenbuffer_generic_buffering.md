...
-   When using generic buffering, any Open SQL statements must respect the generic key to prevent them from [bypassing](javascript:call_link\('abenbuffer_restrictions.htm'\)) table buffering.
