...
-   In READ\_SPFLI\_INTO\_TABLE, the non-class-based exception NOT\_FOUND is triggered by [MESSAGE ... RAISING](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapmessage_raising.htm).

-   In READ\_SPFLI\_INTO\_TABLE\_NEW, the class-based exception is triggered CX\_NO\_FLIGHT\_FOUND by[RAISE EXCEPTION ... MESSAGE](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapraise_exception.htm). CX\_NO\_FLIGHT\_FOUND implements the interface IF\_T100\_DYN\_MSG.
