...
description: |
  The example demonstrates the evaluation(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abencds_meta_data_extension_eval.htm) of CDS annotations that are defined in CDS metadata extensions. Source Code REPORT demo_cds_mde_variants. CLASS demo DEFINITION. PUBLIC SECTION. CLASS-METHODS
version: "7.52"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abencds_annotate_view_abexa.htm"
