...
arg: see below
sub: non-empty [numeric literal](javascript:call_link\('abencds_f1_literal.htm'\))
...
arg: see below
pos and len: positive [numeric literal](javascript:call_link\('abencds_f1_literal.htm'\)) not equal to zero
