...
-   [Conversion functions](javascript:call_link\('abencds_f1_date_time_conversions.htm'\)) make it possible to transform a time stamp to date fields and time fields and to transform date fields and time fields to a timestamp.
