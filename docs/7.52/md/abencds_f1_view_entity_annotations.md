...
false:
The key fields of the CDS database view are determined as for classic views in ABAP Dictionary, regardless of the addition [KEY](javascript:call_link\('abencds_f1_select_list_entry.htm'\)).
...
Name of the [CDS database view](javascript:call_link\('abencds_database_view_glosry.htm'\) "Glossary Entry") in the CDS view
...
Defines implicit [access control](javascript:call_link\('abencds_access_control_glosry.htm'\) "Glossary Entry") when Open SQL is used to access the CDS view

#CHECK:
If Open SQL is used to access the view, [access control](javascript:call_link\('abencds_authorizations.htm'\)) is performed implicitly if a [CDS role](javascript:call_link\('abencds_role_glosry.htm'\) "Glossary Entry") role is assigned to the view. If there is no role for the view, a syntax check warning occurs.
#NOT\_REQUIRED:
...
Defines [client handling](javascript:call_link\('abencds_view_client_handling_obs.htm'\)) when Open SQL is used to access the CDS view (obsolete).
...
Defines the [client dependency](javascript:call_link\('abencds_client_handling.htm'\)) when Open SQL is used to access the CDS view.
...
Defines [client handling](javascript:call_link\('abencds_client_handling.htm'\)) when Open SQL is used to access the CDS view.
...
Defines the handling of [obsolete data](javascript:call_link\('abencds_data_aging.htm'\)) for the CDS view.
...
Defines the handling of [obsolete data](javascript:call_link\('abencds_data_aging.htm'\)) on a [SAP HANA database](javascript:call_link\('abenhana_database_glosry.htm'\) "Glossary Entry") when Open SQL is used to access the CDS view
...
Activates [SAP buffering](javascript:call_link\('abensap_buffering_glosry.htm'\) "Glossary Entry") with single table buffering for the CDS view business\_partner.
