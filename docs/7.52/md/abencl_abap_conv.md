...
The class [CL\_ABAP\_CODEPAGE](javascript:call_link\('abencl_abap_codepage.htm'\)) wraps the classes above to make it easier to handle code pages when processing character and byte strings.