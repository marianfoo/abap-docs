...
description: |
  Classes and interfaces in ABAP Objects can be declared either globally or locally. -   Global classes and interfaces are saved in the central class library(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenclass_library_glosry.htm 'Glossary Entry') of the repository(https://help.sap
version: "7.52"
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenclass_interface_definition.htm"
