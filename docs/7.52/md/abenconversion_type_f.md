...
The content of the source field is first converted to the data type i (see above), and then to the type x (see the [conversion table for source field type i, (b, s)](javascript:call_link\('abenconversion_type_ibs.htm'\))).
