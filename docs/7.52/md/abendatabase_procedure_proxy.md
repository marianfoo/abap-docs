...
-   Using a tool in the ABAP perspective of the [ABAP Development Tools](javascript:call_link\('abenadt_glosry.htm'\) "Glossary Entry") The SQLScript procedure must exist in the [SAP HANA repository](javascript:call_link\('abensap_hana_repository_glosry.htm'\) "Glossary Entry") in [SAP HANA XSC](javascript:call_link\('abenxsc_glosry.htm'\) "Glossary Entry").
...
-   Database procedure proxies are mainly intended for use with SQLScript procedures in [SAP HANA XSC](javascript:call_link\('abenxsc_glosry.htm'\) "Glossary Entry"). [ADT](javascript:call_link\('abenadt_glosry.htm'\) "Glossary Entry") only supports proxies of this type.
