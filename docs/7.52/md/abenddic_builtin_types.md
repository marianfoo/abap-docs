...
The following tables show the built-in types in [ABAP Dictionary](javascript:call_link\('abenabap_dictionary_glosry.htm'\) "Glossary Entry") and their fundamental technical attributes. For each built-in data type in ABAP Dictionary, the last column specifies the [built-in ABAP type](javascript:call_link\('abenpredefined_abap_type_glosry.htm'\) "Glossary Entry") to which the built-in type is mapped in type references from an ABAP program to ABAP Dictionary. An initial value is assigned to most built-in data types. These initial values are applied, for example, when initial [dynpro fields](javascript:call_link\('abendynpro_field_glosry.htm'\) "Glossary Entry") are displayed and when database fields are [initialized](javascript:call_link\('abenddic_database_tables_init.htm'\)).
...
See [Date Types and Time Types](javascript:call_link\('abenddic_date_time_types.htm'\)).
...
[c](javascript:call_link\('abenbuiltin_types_character.htm'\)), length 3
...
[c](javascript:call_link\('abenbuiltin_types_character.htm'\)), length 1
...
[Currency key](javascript:call_link\('abencurrency_key_glosry.htm'\) "Glossary Entry") for [currency fields](javascript:call_link\('abencurrency_field_glosry.htm'\) "Glossary Entry")

[c](javascript:call_link\('abenbuiltin_types_character.htm'\)), length 5
...
[Quantity field](javascript:call_link\('abenquantity_glosry.htm'\) "Glossary Entry") in [BCD](javascript:call_link\('abenbcd_glosry.htm'\) "Glossary Entry") format
...
[Unit key](javascript:call_link\('abenunit_glosry.htm'\) "Glossary Entry") of a [quantity field](javascript:call_link\('abenquantity_glosry.htm'\) "Glossary Entry")
