...
description: |
  A CDS view is defined for existing database tables(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenddic_database_tables.htm) and any other views(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenddic_views.htm) or CDS views in ABAP Dictionary using the statement DEFI
version: "7.52"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenddic_cds_views.htm"
