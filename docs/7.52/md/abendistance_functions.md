...
title: "Syntax"
description: |
  ... distance( val1 = text1(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenstring_functions_val.htm) val2 = text2(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenstring_functions_val.htm) max = max ) ... Effect This function returns the Levenshtein distance
version: "7.52"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abendistance_functions.htm"
abapFile: "abendistance_functions.htm"
keywords: ["insert", "delete", "do", "if", "try", "class", "data", "abendistance", "functions"]
---
...
... distance( [val1 = text1](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenstring_functions_val.htm) [val2 = text2](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenstring_functions_val.htm) *\[*max = max*\]* ) ...

Effect

This function returns the Levenshtein distance between two strings [text1](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenstring_functions_val.htm) and [text2](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenstring_functions_val.htm). This distance is the minimum number of insert, delete, and replace operations required to change one string to another and hence reflects the similarity of the two strings. The return value has the type i.
...
[Character String Functions, distance](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenstring_function_distance_abexa.htm)
