...
[ABAP - Keyword Documentation](javascript:call_link\('abenabap.htm'\)) →  [ABAP - Reference](javascript:call_link\('abenabap_reference.htm'\)) →  [SAP GUI User Dialogs](javascript:call_link\('abenabap_screens.htm'\)) →  [Dynpros](javascript:call_link\('abenabap_dynpros.htm'\)) →  [Statements in the Screen Flow Logic](javascript:call_link\('abenabap_dynpros_dynpro_statements.htm'\)) →  [FIELD](javascript:call_link\('dynpfield.htm'\)) → 
...
-   A field whose content is empty at [PBO](javascript:call_link\('abenpbo_glosry.htm'\) "Glossary Entry") and which is not changed by the user is not transported by the FIELD statement. This applies to the full row in the [LOOP](javascript:call_link\('dynploop.htm'\))s for [table control](javascript:call_link\('abentable_control_glosry.htm'\) "Glossary Entry")s and [step loop](javascript:call_link\('abenstep_loop_glosry.htm'\) "Glossary Entry")s.
...
Continue
![Example](exa.gif "Example") [Screens, FIELD Statement](javascript:call_link\('abendynpro_field_abexa.htm'\))