...
description: |
  In the event blocks at POH(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenpoh_glosry.htm 'Glossary Entry') and POV(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenpov_glosry.htm 'Glossary Entry'), only FIELD statements are possible. The statement MODULE can only be
version: "7.52"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abendynp_field_help.htm"
