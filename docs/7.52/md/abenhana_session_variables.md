...
-   CDS\_CLIENT is set to the specified value when the database is accessed with an Open SQL statement with the addition [USING CLIENT](javascript:call_link\('abapselect_client.htm'\)).
