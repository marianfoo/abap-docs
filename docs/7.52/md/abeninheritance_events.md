...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abeninheritance_events.htm"
...
Note the latter especially when raising static events in static methods, since a static method is always executed in the class in which it was declared (also refer to [Inheritance and Static Components](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abeninheritance_statical.htm)).
