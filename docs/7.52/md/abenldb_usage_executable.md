...
description: |
  -   How the Association Works(#abenldb-usage-executable-1--------selection-screen---@ITOC@@ABENLDB_USAGE_EXECUTABLE_2) -   Runtime Behavior(#@@ITOC@@ABENLDB_USAGE_EXECUTABLE_3) How the Association Works When an executable program(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abene
version: "7.52"
category: "database"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenldb_usage_executable.htm"
...
Authorization checks performed by the statement [AUTHORITY-CHECK](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapauthority-check.htm) are useful in the following subroutines of the database program or the event blocks of the executable program:
