...
Name of the database table or of the view specified at runtime when calling [SELECT](javascript:call_link\('abapselect.htm'\)), [INSERT](javascript:call_link\('abapinsert_dbtab.htm'\)), [UPDATE](javascript:call_link\('abapupdate.htm'\)), [MODIFY](javascript:call_link\('abapmodify_dbtab.htm'\)), and [DELETE](javascript:call_link\('abapdelete_dbtab.htm'\))
...
DUPREC errors returned from [INSERT](javascript:call_link\('abapinsert_dbtab.htm'\)) ... FROM TABLE itab
