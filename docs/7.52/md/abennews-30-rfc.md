...
The calling program can be a dialog program and display a [dynpro](javascript:call_link\('abendynpro_glosry.htm'\) "Glossary Entry"). However, the dynpro remains inactive during communication.
