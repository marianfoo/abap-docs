...
The statements [INCLUDE STRUCTURE rec.](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapinclude_type.htm) and [INCLUDE TYPE type.](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapinclude_type.htm) were enhanced so that symbolic accesses to groups of fields in structures are possible.
...
-   [Flat</ structures and hierarchy views can be defined simultaneously.](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenflat_glosry.htm "Glossary Entry")
    
-   There are no problems in [alignment](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenalignment_glosry.htm "Glossary Entry") because the flat structure is automatically aligned so that it can carry the hierarhic structure.
