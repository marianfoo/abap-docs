...
The new integer power function [ipow](javascript:call_link\('abenpower_function.htm'\)) enables fields of any numerical type and with integer values to be raised to a power. The calculation type is determined by the base.
