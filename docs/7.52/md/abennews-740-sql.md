...
[External views](javascript:call_link\('abenexternal_views.htm'\)) in ABAP Dictionary make [SAP HANA views](javascript:call_link\('abenhana_view_glosry.htm'\) "Glossary Entry") known in ABAP programs. They also allow type references and access using Open SQL.
