...
Open SQL - SQL Functions

The following predefined [SQL functions](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abensql_functions.htm) can either be specified as standalone functions in Open SQL or as operands of [SQL expressions](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abapsql_expr.htm), in all places where SQL expressions are possible.

-   [Numeric functions](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abensql_arith_func.htm)

-   [String functions](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abensql_string_func.htm)

-   [Coalesce function](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abensql_coalesce.htm)

This translation does not reflect the current version of the documentation.
Continue
[sql\_exp - sql\_num\_func](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abensql_arith_func.htm)
[sql\_exp - sql\_string\_func](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abensql_string_func.htm)
[sql\_exp - sql\_coalesce](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abensql_coalesce.htm)