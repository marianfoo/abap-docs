...
description: |
  The strict mode of the syntax check in Release 7.50 applies to all Open SQL statements that use one of the following attributes introduced in Release 7.50(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abennews-750-open_sql.htm): -   A SELECT clause(https://help.sap.com/doc/abapdocu_
version: "7.52"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenopensql_strict_mode_750.htm"
