...
If these statements are specified outside of a template in the context of the transformation, the data declarations apply for the [main template](javascript:call_link\('abenst_tt_template_main.htm'\)).
