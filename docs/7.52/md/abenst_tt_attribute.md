...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenst_tt_attribute.htm"
...
This special form of non-literal attributes combines the tt:value command with the general syntax shown above.
...
To deserialize the above result again, the ST program below can be used, even though the order of the attributes is different.
