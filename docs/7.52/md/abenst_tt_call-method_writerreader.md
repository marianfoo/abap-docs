...
In the [static method](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenst_tt_call-method_static.htm) or [instance method](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenst_tt_call-method_instance.htm) called from an ST program, the attributes writer and reader can be used to access the XML stream where the serialization or deserialization is taking place.
