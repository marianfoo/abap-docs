...
title: "Syntax"
description: |
  <tt:copy ref='node' /> Effect Command tt:copy is used to serialize in and deserialize from the asXML format(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenabap_xslt_asxml.htm). It can be used on all data objects with the exception of reference variables or objects containin
version: "7.52"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenst_tt_copy.htm"
