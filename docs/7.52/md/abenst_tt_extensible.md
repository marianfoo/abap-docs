...
title: "Syntax"
description: |
  ... tt:extensible='on''deep-static''deep-dynamic''off''deep-off'  ... Effect In deserializations, XML elements in the input stream that are not specified in the ST program usually produce an error. If the processed XML format is to be extensible, elements that are not specified explicitl
version: "7.52"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenst_tt_extensible.htm"
abapFile: "abenst_tt_extensible.htm"
keywords: ["do", "if", "case", "data", "abenst", "extensible"]
---
...
-   "deep-dynamic" is effective across template calls using [tt:apply](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenst_tt_apply.htm) and [tt:call](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenst_tt_call.htm).

The deep extensibility that is configured using ″deep-static" and ″deep-dynamic" also takes effect in case distinctions with [tt:switch](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenst_tt_switch.htm) and groupings with [tt:group](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenst_tt_group.htm) by skipping unexpected elements that are not covered by a case.
