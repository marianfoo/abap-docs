...
Parameters are special [variables](javascript:call_link\('abenst_tt_variable.htm'\)) and can be used as such. Parameters also take effect as formal parameters of an ST program (or a subtemplate):
