...
The command tt:read makes it possible to read a value of the XML inbound stream into a [variable](javascript:call_link\('abenst_tt_variable.htm'\)) or a [parameter](javascript:call_link\('abenst_tt_parameter.htm'\)):
