...
The following XML namespaces in [asXML format](javascript:call_link\('abenabap_xslt_asxml.htm'\)) have to be used to specify types from the repository and the same ST program:
