...
description: |
  This example demonstrates the string functions shift(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenshift_functions.htm) and substring(https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abensubstring_functions.htm). Source Code REPORT demo_shift_substring. CLASS demo DE
version: "7.52"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenstring_function_shift_abexa.htm"
...
This example demonstrates the string functions [shift](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenshift_functions.htm) and [substring](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abensubstring_functions.htm).
