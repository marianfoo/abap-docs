...
The default value of occ is 1. Except in the case of the replacement function [replace](javascript:call_link\('abenreplace_functions.htm'\)), the value 0 raises an exception from the class CX\_SY\_STRG\_PAR\_VAL.
