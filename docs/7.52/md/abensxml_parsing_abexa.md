...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abensxml_parsing_abexa.htm"
...
Simple [token-based](https://help.sap.com/doc/abapdocu_752_index_htm/7.52/en-US/abenabap_sxml_lib_parse_iterative.htm) reading of XML data.
...
The program DEMO\_SXML\_PARSE\_XML executes the token-based parsing shown here for any XML data that you enter.