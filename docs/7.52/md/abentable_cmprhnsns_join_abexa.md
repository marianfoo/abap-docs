...
This example demonstrates a join between internal tables using [table comprehension](javascript:call_link\('abentable_comprehension_glosry.htm'\) "Glossary Entry").
