...
This example demonstrates how multiple rows in a [FOR expression](javascript:call_link\('abenfor_in_itab.htm'\)) of a [table comprehension](javascript:call_link\('abentable_comprehension_glosry.htm'\) "Glossary Entry") are created.
