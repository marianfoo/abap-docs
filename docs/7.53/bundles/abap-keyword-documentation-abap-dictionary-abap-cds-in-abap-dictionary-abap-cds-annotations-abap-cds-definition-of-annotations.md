...
The annotation can be used in CDS entities defined in [ABAP for Key Users](javascript:call_link\('abenabap_for_key_users_glosry.htm'\) "Glossary Entry"). This value is not evaluated yet.
#NOT\_RELEASED:
