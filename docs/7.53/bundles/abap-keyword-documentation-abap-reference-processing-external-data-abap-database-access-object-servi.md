...
- [abenabap_object_services_query.htm](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenabap_object_services_query.htm)
- [abenos_query_terms.htm](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenos_query_terms.htm)
- [abenos_query_comps.htm](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenos_query_comps.htm)
- [abenos_query_filter_cond.htm](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenos_query_filter_cond.htm)
- [abenos_query_sort_cond.htm](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenos_query_sort_cond.htm)
- [abenos_query_abexa.htm](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenos_query_abexa.htm)
...
> **📖 Official SAP Documentation**: [abenabap_object_services_query.htm](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenabap_object_services_query.htm)
...
**📖 Source**: [abenabap_object_services_query.htm](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenabap_object_services_query.htm)

### abenos_query_terms.htm

> **📖 Official SAP Documentation**: [abenos_query_terms.htm](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenos_query_terms.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abenos_query_terms.htm](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenos_query_terms.htm)

### abenos_query_comps.htm

> **📖 Official SAP Documentation**: [abenos_query_comps.htm](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenos_query_comps.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abenos_query_comps.htm](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenos_query_comps.htm)

### abenos_query_filter_cond.htm

> **📖 Official SAP Documentation**: [abenos_query_filter_cond.htm](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenos_query_filter_cond.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abenos_query_filter_cond.htm](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenos_query_filter_cond.htm)

### abenos_query_sort_cond.htm

> **📖 Official SAP Documentation**: [abenos_query_sort_cond.htm](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenos_query_sort_cond.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abenos_query_sort_cond.htm](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenos_query_sort_cond.htm)

### abenos_query_abexa.htm

> **📖 Official SAP Documentation**: [abenos_query_abexa.htm](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenos_query_abexa.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.


**📖 Source**: [abenos_query_abexa.htm](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenos_query_abexa.htm)
