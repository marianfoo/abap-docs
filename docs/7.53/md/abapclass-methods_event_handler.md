...
The class dialog\_box defines a static event handler close\_box for the event raised when the user chooses to close a [Control Frameworks](javascript:call_link\('abencontrol_framework_glosry.htm'\) "Glossary Entry") (CFW) dialog box.
