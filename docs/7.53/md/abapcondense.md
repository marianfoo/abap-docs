...
title: "CONDENSE"
description: |
  Quick Reference(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapcondense_shortref.htm) Syntax CONDENSE text NO-GAPS. Effect In the variable text, any leading and trailing blanks are removed and any other blanks that follow each other directly are replaced by exactly one blan
version: "7.53"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapcondense.htm"
