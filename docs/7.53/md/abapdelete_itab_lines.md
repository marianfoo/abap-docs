...
title: "Syntax"
description: |
  ... itab USING KEY keyname(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenkeyname.htm) FROM idx1 TO idx2 WHERE log_exp(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenlogexp.htm)(cond_syntax) ... Extras: 1. ... USING KEY keyna
version: "7.53"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapdelete_itab_lines.htm"
...
... itab *\[*USING KEY [keyname](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenkeyname.htm)*\]* *\[*FROM idx1*\]* *\[*TO idx2*\]*
...
To delete more than one row, at least one of the additions FROM, TO, or WHERE must be specified. USING KEY [keyname](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenkeyname.htm) is used to determine the table key to which the additions refer.
...
The statement DELETE FROM itab has the statement [DELETE FROM dbtab](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapdelete_dbtab.htm) with identical syntax. If an internal table has the same name as a database table, a statement like this accesses the internal table.

Example

Deletes all rows in an internal table from row 4. The result is the same as in the example for [APPEND ...](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapappend.htm). [SORTED BY](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapappend.htm).
...
-   [Optimizations of the WHERE condition](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenitab_where_optimization.htm) affect searches for the rows to delete but do not affect, for example, updates of the primary index of a standard table.
...
[Deleting Rows Using WHERE](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abendelete_itab_using_key_abexa.htm)
...
Continue
![Example](exa.gif "Example") [Internal Tables, Deleting Rows Using WHERE](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abendelete_itab_using_key_abexa.htm)