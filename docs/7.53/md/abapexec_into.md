...
title: "EXEC SQL - INTO"
description: |
  Syntax EXEC SQL. SELECT ... INTO STRUCTURE :host1 , host2 ... ENDEXEC. Effect In a native SELECT or FETCH statement specified between EXEC and ENDEXEC, an INTO clause can be specified to pass the read data to host variables(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/aba
version: "7.53"
category: "database"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapexec_into.htm"
