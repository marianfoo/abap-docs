...
  ENDINTERFACE.
[Advance Declaration of Interfaces](javascript:call_link\('abapinterface_deferred.htm'\))
...
-   The definition of an interface consists of a [declaration section](javascript:call_link\('abapinterface_definition.htm'\)) that starts with INTERFACE and is ended using ENDINTERFACE. Unlike classes, an interface does not have an implementation part.
