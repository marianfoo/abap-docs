...
[Quick Reference](javascript:call_link\('abapleave_screen_shortref.htm'\))
...
-   This statement must not be used when handling events of the [Control Framework](javascript:call_link\('abencontrol_framework_glosry.htm'\) "Glossary Entry")s.