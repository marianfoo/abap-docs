...
description: |
  Quick Reference(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapmodify_dbtab_shortref.htm) Obsolete Syntax MODIFY  dbtab  dbtab  VERSION vers. Effect This variant of the statement MODIFY works essentially like the short form(https://help.sap.com/doc/abapdocu_753_index_h
version: "7.53"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapmodify_dbtab_obsolete.htm"
...
This variant of the statement MODIFY works essentially like the [short form](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapmodify_obsolete.htm) of the ABAP SQL statement, but is one of a number of [obsolete access statements](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abendb_access_obsolete.htm) (alongside the addition VERSION), where dbtab must be the name of a database table or a [classic view](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenclassical_view_glosry.htm "Glossary Entry"), starting with "T" and comprising no more than five characters.
