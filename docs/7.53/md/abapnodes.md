...
-   Node Type C
    The data type of the table work area can be any data type from a [type group](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abentype_group_1_glosry.htm "Glossary Entry"). The name of the node can differ from the name of the type.
