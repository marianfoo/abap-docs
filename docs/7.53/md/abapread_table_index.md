...
... INDEX idx *\[*USING KEY [keyname](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenkeyname.htm)*\]* ...
...
If the addition USING KEY is not used, the addition INDEX can only be specified for [index tables](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenindex_table_glosry.htm "Glossary Entry") and determines the row to be read from the [primary table index](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenprimary_table_index_glosry.htm "Glossary Entry").

Note

[Table expressions](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abentable_expression_glosry.htm "Glossary Entry") enable reads to be performed in operand positions too. Here an index is specified as a numeric argument [idx](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abentable_exp_itab_line.htm).

Example

Reads the first ten rows of the internal table sflight\_tab using the primary table index. Instead of the DO loop, a [LOOP](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abaploop_at_itab.htm) or a corresponding iteration expression with [FOR](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenfor_itab.htm) is used for this purpose.
...
-   [Table expressions](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abentable_expression_glosry.htm "Glossary Entry") enable reads to be performed in operand positions too. The table key for an index is specified using [KEY keyname INDEX](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abentable_exp_itab_line.htm).
