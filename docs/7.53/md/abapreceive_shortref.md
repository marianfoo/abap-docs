---
title: "RECEIVE - Quick reference"
description: |
  Reference(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapreceive.htm) Syntax RECEIVE RESULTS FROM FUNCTION func KEEPING TASK IMPORTING p1 = a1 p2 = a2 ... TABLES t1 = itab1 t2 = itab2 ... EXCEPTIONS exc1 = n1 exc2 = n2 ... system_failure = n
version: "7.53"
category: "ui"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapreceive_shortref.htm"
...
[Reference](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapreceive.htm)
...
Receives, in a callback routine, the results of an [asynchronous RFC](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenasynchronous_rfc_glosry.htm "Glossary Entry").

Additions

-   [KEEPING TASK](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapreceive.htm)
    Prevents the RFC connection from being disconnected after results have been inherited.
    
-   [IMPORTING p1 = a1 p2 = a2 ...](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapreceive_para.htm)
    Inherits output parameters p1, p2, ... in actual parameters a1, a2, ...
    
-   [TABLES t1 = itab1 t2 = itab2 ...](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapreceive_para.htm)
    Assigns internal tables itab1, itab2, ... to table parameters t1, t2, etc.
    
-   [EXCEPTIONS](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapreceive_para.htm)
