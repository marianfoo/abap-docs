...
title: "Syntax"
description: |
  ... AVG( DISTINCT col(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenopen_sql_columns.htm) AS dtype ) ... Effect Aggregate expression AVG(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapselect_aggregate.htm) in ABAP SQL with a data type dtype specified. The
version: "7.53"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapselect_avg_as.htm"
abapFile: "abapselect_avg_as.htm"
keywords: ["select", "do", "if", "case", "data", "types", "abapselect", "avg"]
---
...
Length and decimal places must be specified with len and decimals. Literals or constant [host variables](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenopen_sql_host_variables.htm) of the [ABAP type](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenbuilt_in_types_complete.htm) b, s, i, or int8 can be specified for len and decimals. The value range of the data type dtype must cover the value range of the operand type:
...
-   For average values, the addition AS of AVG covers cases where aggregate expressions cannot currently be specified as operands of SQL expressions and the fact that FLTP cannot be cast to other numeric data types using [CAST](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abensql_cast.htm).
...
-   An aggregate expression AVG cannot be applied to operands with the data type INT8 without using the addition AS. The addition AS can also be used to form average values for columns with data type INT8. However, for the types [DF16\_...](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenddic_builtin_types.htm), [DF34\_...](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenddic_builtin_types.htm), AVG is only possible without the addition AS.
