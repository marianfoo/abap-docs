...
description: |
  Quick Reference(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapselection-screen_shortref.htm) Syntax SELECTION-SCREEN FUNCTION KEY n ldb_additions(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapselection-screen_ldb_additions.htm). Effect In the GUI status
version: "7.53"
category: "ui"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapselection-screen_functionkey.htm"
...
When the user chooses a pushbutton in the application toolbar, the runtime environment triggers the event [AT SELECTION-SCREEN](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapat_selection-screen.htm) and the associated function code is passed to the component ucomm of the interface work area sscrfields.
...
-   To assign icons, a [tooltip](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenquick_info_glosry.htm "Glossary Entry"), and appropriate text to the pushbuttons, a data object can be defined of the structured type SMP\_DYNTXT in ABAP Dictionary. The ID of the icon, a tooltip, and the associated text must be assigned to the components of this data object. The content of the whole structure must then be assigned to the component functxt\_0n of the interface work area sscrfields.
...
-   If the content of the component ucomm is set to a function code used in the GUI status during selection screen processing, the [selection screen processing](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenselscreen_processing_glosry.htm "Glossary Entry") is modified accordingly.
...
Continue
![Example](exa.gif "Example") [Selection Screens, Pushbuttons in the Application Toolbar](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenselscreen_pb_bar_abexa.htm)