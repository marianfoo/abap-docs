...
description: |
  Quick Reference(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapselection-screen_incl_shortref.htm) Syntax SELECTION-SCREEN INCLUDE COMMENT /pos(len) text FOR FIELD sel MODIF ID modid ID id. Effect The addition COMMENT creates an output field
version: "7.53"
category: "ui"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapselection-screen_include_comnt.htm"
