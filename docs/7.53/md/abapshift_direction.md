...
This example is a variant of the second example under [places](javascript:call_link\('abapshift_places.htm'\)). Using the addition CIRCULAR, the result becomes "you know I know".
