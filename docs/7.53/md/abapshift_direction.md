...
This example is a variant of the second example under [places](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapshift_places.htm). Using the addition CIRCULAR, the result becomes "you know I know".
