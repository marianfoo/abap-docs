...
description: |
  Reference(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abaptransfer.htm) Syntax TRANSFER dobj TO dset LENGTH len NO END OF LINE. Effect Transfers the data of the data object dobj to the file specified in dset. Additions -   LENGTH len Restricts the number of character
version: "7.53"
category: "ui"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abaptransfer_shortref.htm"
...
[Reference](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abaptransfer.htm)
