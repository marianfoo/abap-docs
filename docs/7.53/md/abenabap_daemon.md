...
description: |
  ABAP Daemon Framework (ADF for short) is an application programming interface (or API) used to create and handle ABAP Daemons(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenabap_daemon_glosry.htm 'Glossary Entry'). An ABAP Daemon is an instance of an ABAP Daemon class(https://hel
version: "7.53"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenabap_daemon.htm"
