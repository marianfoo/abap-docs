...
title: "Notes"
description: |
  -   Writes to the DOM must be avoided during sequential parsing(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenabap_ixml_lib_parse_event.htm), since this can produce unexpected behavior. -   iXML documents can also be specified as an XML target for XSL transformations called using
version: "7.53"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenabap_ixml_lib_dom_access_write.htm"
...
-   Writes to the DOM must be avoided during [sequential parsing](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenabap_ixml_lib_parse_event.htm), since this can produce unexpected behavior.

-   iXML documents can also be specified as an XML target for XSL transformations called using [CALL TRANSFORMATION](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapcall_transformation.htm).

-   If writes produce content of elements or attributes, the characters <, \>, &, ", and ' are transformed automatically into the associated [XML](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenxml_oview.htm) notation.
...
-   [Creating Nodes](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenixml_crea_elem_abexa.htm)

-   [Creating Elements](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenixml_crea_simple_elem_abexa.htm)