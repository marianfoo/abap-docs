...
description: |
  ABAP Objects is the object-oriented part of ABAP. ABAP Objects adds a complete set of language elements(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenobjects_keywords.htm) to ABAP (previously only a procedural language) that allow object-oriented programming(https://help.sap.com
version: "7.53"
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenabap_objects_oview.htm"
