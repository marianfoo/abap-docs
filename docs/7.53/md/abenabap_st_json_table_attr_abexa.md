...
description: |
  The example demonstrates a simple transformation used to create name attributes in JSON data(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenjson_oview.htm). Source Code REPORT demo_st_json_table_attributes. CLASS demo DEFINITION. PUBLIC SECTION. CLASS-METHODS main. ENDCLASS. CL
version: "7.53"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenabap_st_json_table_attr_abexa.htm"
