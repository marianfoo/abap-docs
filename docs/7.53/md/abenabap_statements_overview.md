...
This section contains a thematically organized overview of all statements that are opened using [ABAP keywords](javascript:call_link\('abenabap_keyword_glosry.htm'\) "Glossary Entry"). An alphabetic list of all ABAP words can be found under [ABAP Words](javascript:call_link\('abenabap_words.htm'\)).
