...
description: |
  The data objects of the byte-like data types are used to include byte strings. Properties Type Length Standard Length Name x 1 to 524,287 bytes 1 byte Byte field(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenbyte_field_glosry.htm 'Glossary Entry') xstring Variable Byte string(ht
version: "7.53"
category: "types"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenbuiltin_types_byte.htm"
