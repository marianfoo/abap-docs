...
-   [Right side](javascript:call_link\('abencds_cond_expr_where.htm'\)) of an expression [cond\_exp](javascript:call_link\('abencds_f1_conditional_expression.htm'\)) in the [default filter condition](javascript:call_link\('abencds_f1_association.htm'\)) of an [association](javascript:call_link\('abencds_f1_association.htm'\))
