...
-   The CL\_SQL\_STATEMENT class allows the statement passed to be executed once. The subclass [CL\_SQL\_PREPARED\_STATEMENT](javascript:call_link\('abencl_sql_prepared_statement.htm'\)) can be used to execute a statement multiple times with different parameters.
