...
description: |
  The methods CREATE_... of the class CL_SYSTEM_UUID create UUIDs(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenuuid_glosry.htm 'Glossary Entry') with a length of 16 bytes in the following formats: -   16-character byte-like representation -   22-character character-like represen
version: "7.53"
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abencl_system_uuid.htm"
...
The methods CREATE\_... of the class CL\_SYSTEM\_UUID create [UUIDs](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenuuid_glosry.htm "Glossary Entry") with a length of 16 bytes in the following formats:

-   16-character byte-like representation

-   22-character character-like representation in [Base64](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenbase64_glosry.htm "Glossary Entry")
