...
title: "Comments"
description: |
  A comment is an explanation that is added to the source text of a program to help the person reading the program to understand it. Comments are ignored when the program is generated by the ABAP Compiler. From a technical perspective, a comment can have any type of content. Two language elements are
version: "7.53"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abencomment.htm"
abapFile: "abencomment.htm"
keywords: ["loop", "do", "if", "try", "method", "class", "data", "types", "abencomment"]
---
...
-   The " character, which can be entered at any position in the line, indicates that the remaining content in the line is a comment. This rule does not apply to the " character in [character literals](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abencharacter_literal_glosry.htm "Glossary Entry") and [pseudo comments](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenpseudo_comment_glosry.htm "Glossary Entry").
...
-   [Make meaningful comments](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abencontent_guidl.htm "Guideline")
...
A special category of line end comments are [ABAP Doc comments](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenabap_doc_comment_glosry.htm "Glossary Entry") introduced using "!. These comments can be evaluated by an ABAP development environment and support [ABAP Doc](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenabap_doc_glosry.htm "Glossary Entry").
