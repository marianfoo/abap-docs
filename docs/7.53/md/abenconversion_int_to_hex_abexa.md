...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenconversion_int_to_hex_abexa.htm"
...
In part, the [calculation type](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenarith_type.htm) decfloat34 is forced to calculate numbers using powers of two. This prevents overflows when assigning the results of the function [ipow](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenipow_function_abexa.htm) to subtotals of the calculation type i or int8.
