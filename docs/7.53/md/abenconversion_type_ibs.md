...
description: |
  Target Conversion i, int8, (b, s) If an assignment is made to the same data type, the content is passed unconverted. Otherwise, the value of the integer is converted to the internal format i, int8, (b, s). If the value range(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenvalue_rang
version: "7.53"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenconversion_type_ibs.htm"
