...
description: |
  When a data type in ABAP Dictionary is activated, a runtime object(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenruntime_object_glosry.htm 'Glossary Entry') is created that consumers such as dictionary objects, ABAP programs, or dynpros can use to effectively access all relevant t
version: "7.53"
category: "types"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenddic_activation.htm"
