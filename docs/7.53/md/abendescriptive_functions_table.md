...
title: "Syntax"
description: |
  ... lines( arg ) ... The table function lines returns the number of rows (or lines) in an internal table. The argument arg is a functional operand position(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenfunctional_position_glosry.htm 'Glossary Entry') that expects an internal table
version: "7.53"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abendescriptive_functions_table.htm"
