...
The possible [arithmetic operators](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenarith_operators.htm) are applied to numbers that can be entered.