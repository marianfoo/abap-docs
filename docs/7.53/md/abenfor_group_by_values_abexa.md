...
description: |
  This example demonstrates the construction of the group key(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abengroup_key_glosry.htm 'Glossary Entry') using simple value assignments. Source Code REPORT demo_for_groups_by_values. CLASS demo DEFINITION. PUBLIC SECTION. CLASS-METHODS:
version: "7.53"
category: "data-structures"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenfor_group_by_values_abexa.htm"
