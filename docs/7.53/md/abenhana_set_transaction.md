...
description: |
  HANA-specific SQL(https://help.sap.com/viewer/4fe29514fd584807ac9f2a04f6754767/2.0.00/en-us) contains the following statements for setting transaction behavior: -   SET TRANSACTION AUTOCOMMIT DDL -   SET TRANSACTION ISOLATION LEVEL -   SET TRANSACTION LOCK WAIT TIMEOUT -   SET TRANSACTION READ ONL
version: "7.53"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenhana_set_transaction.htm"
