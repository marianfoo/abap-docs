...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenint_table_at_abexa.htm"
...
The executable example [Grouping in Control Levels](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenloop_group_by_levels_abexa.htm) shows how the same function can be provided using the addition [GROUP BY](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abaploop_at_itab_group_by.htm).