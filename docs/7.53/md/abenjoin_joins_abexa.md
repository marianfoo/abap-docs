...
This example demonstrates chaining and compounding of multiple [joins](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapselect_join.htm) in the SELECT statement.
