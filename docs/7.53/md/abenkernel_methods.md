...
Kernel methods allow you to directly call ABAP kernel functions implemented in C or C++. Kernel methods replace the previous concepts of [C calls](javascript:call_link\('abapcall-.htm'\)) and system calls. New C calls or system calls should be avoided.
