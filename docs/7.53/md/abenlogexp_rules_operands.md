...
-   It should be noted that some built-in functions operate like an [arithmetic expression](javascript:call_link\('abenarithmetic_expression_glosry.htm'\) "Glossary Entry") if they contain a [numeric expression](javascript:call_link\('abennumerical_expression_glosry.htm'\) "Glossary Entry") as an argument.
