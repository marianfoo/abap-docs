...
title: "Note"
description: |
  If an internal table with a header line(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenheader_line_glosry.htm 'Glossary Entry') is specified as an operand of an assignment, the header line is addressed in nearly all operand positions(https://help.sap.com/doc/abapdocu_753_index_ht
version: "7.53"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenlogexp_rules_operands_itab.htm"
...
Continue
![Example](exa.gif "Example") [Comparing Internal Tables](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abencompare_table_abexa.htm)