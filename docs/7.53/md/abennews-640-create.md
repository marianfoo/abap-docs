...
In the statement
[CREATE DATA dref TYPE REF TO (name).](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapcreate_data_reference.htm)
...
Previously, only non-generic table types could be specified in [CREATE DATA - TYPE](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapcreate_data_existing.htm). As of Release 6.40, table types with generic keys can also be specified. In this case, a new linked table type with a standard key is created and used.