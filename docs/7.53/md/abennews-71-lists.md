...
The new addition [ENVIRONMENT TIME FORMAT](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapwrite_to_options.htm) to the WRITE TO and WRITE statements supports the new [12 hour format](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abennews-710-others.htm).
