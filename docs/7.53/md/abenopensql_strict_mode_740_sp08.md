...
description: |
  The strict mode of the syntax check in Release 7.40, SP08 applies to all ABAP SQL statements that use one of the following attributes introduced in Release 7.40 SP08(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abennews-740_sp08-open_sql.htm): -   Columns dbtab~ specified in the S
version: "7.53"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenopensql_strict_mode_740_sp08.htm"
