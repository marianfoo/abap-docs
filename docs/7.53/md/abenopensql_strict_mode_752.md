...
description: |
  The strict mode of the syntax check in Release 7.52 applies to all ABAP SQL statements that use one of the following attributes introduced in Release 7.52(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abennews-752-open_sql.htm): -   Use of ONE TO MANY in LEFT OUTER JOIN(https://help
version: "7.53"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenopensql_strict_mode_752.htm"
