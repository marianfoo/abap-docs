...
description: |
  This example demonstrates a reduction(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenconstructor_expression_reduce.htm) of the columns of a nested internal table to a text string. Source Code REPORT demo_reduce_for_for. CLASS demo DEFINITION. PUBLIC SECTION. CLASS-METHODS main.
version: "7.53"
category: "data-structures"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenreduce_for_for_abexa.htm"
...
This example demonstrates a [reduction](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenconstructor_expression_reduce.htm) of the columns of a nested internal table to a text string.
