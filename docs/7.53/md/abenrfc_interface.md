...
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenrfc_interface.htm"
...
-   Converting actual parameters to the format required in the remote system and vice-versa. This includes any platform-dependent conversions (for different [code pages](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abencodepage_glosry.htm "Glossary Entry") or byte orders, for example). The conversion supports all ABAP data types.

-   Handling any communication errors and forwarding them to the caller if [requested](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenrfc_exception.htm).
