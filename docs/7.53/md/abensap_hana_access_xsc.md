...
-   [External Views for SAP HANA Views in SAP HANA Repository](javascript:call_link\('abenexternal_views.htm'\))
...
Continue
[External Views for SAP HANA Views in SAP HANA Repository](javascript:call_link\('abenexternal_views.htm'\))
[Database Procedure Proxies for SQLScript Procedures in the SAP HANA](javascript:call_link\('abensql_script.htm'\))