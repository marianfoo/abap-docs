...
description: |
  Like basic properties(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenshm_area_basic_properties.htm), fixed properties of an area can be only be changed by developers. When the fixed properties of an area are changed at runtime, all area instances of the area are set to the state(
version: "7.53"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenshm_area_fixed_properties.htm"
