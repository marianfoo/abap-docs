...
description: |
  Area instance versions can have the following states. 1.  'Building' An area instance version that has a change lock(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenshm_area_instance_locks.htm) is being built. Change locks create a building version automatically. 1.  'Active' The ar
version: "7.53"
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenshm_area_instance_state.htm"
