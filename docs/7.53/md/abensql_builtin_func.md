...
Calls a [built-in function](javascript:call_link\('abenopen_sql_builtin_functions.htm'\)) as an SQL expression in ABAP SQL. The result is the return value of the function with the associated dictionary type.
