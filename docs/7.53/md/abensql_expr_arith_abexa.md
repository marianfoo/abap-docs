...
-   To perform [floating point division](javascript:call_link\('abensql_arith.htm'\)) with integer columns, these columns are updated to the type FLTP using [cast](javascript:call_link\('abensql_cast.htm'\)).
