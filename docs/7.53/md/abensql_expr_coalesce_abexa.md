...
description: |
  This example demonstrates the coalesce function in SQL expressions(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapsql_expr.htm). Source Code REPORT demo_sql_expr_coalesce NO STANDARD PAGE HEADING. CLASS demo DEFINITION. PUBLIC SECTION. CLASS-METHODS: class_constructor, main. PR
version: "7.53"
category: "database"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abensql_expr_coalesce_abexa.htm"
...
This example demonstrates the coalesce function in [SQL expressions](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abapsql_expr.htm).
...
This executable example is an excerpt from the [joins](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenjoins_abexa.htm) example. Here, the function [COALESCE](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abensql_coalesce.htm) is used to replace null values produced by an outer join with a different value.