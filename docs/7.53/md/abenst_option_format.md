...
The following formats match the [XML schema data types](javascript:call_link\('abenabap_xslt_asxml_schema.htm'\)) specified under Mapping Further XML Schema Data Types or other data types and this is where more details about the formats can be found.
