...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenst_program_abexa.htm"
...
A single template, tmpl1, is defined as the [main template](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenst_tt_template_main.htm). Two [data roots](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenst_tt_root.htm), ROOT1 and ROOT2, are declared. The template contains two subelements, X1 and X2 of an element X0, which are given the values of the data roots in serializations (or whose values are given to the data roots in deserializations) using the command [tt:value](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenst_tt_value_elementary.htm). After the deserialization, result1 and result2 have the same content as source1 and source2.