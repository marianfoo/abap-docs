...
-   In serializations and deserializations, the XML data is processed in the form of writer streams and reader streams. When ABAP methods are called from simple transformations, you have the option of [editing these XML streams](javascript:call_link\('abenst_tt_call-method_writerreader.htm'\)).
