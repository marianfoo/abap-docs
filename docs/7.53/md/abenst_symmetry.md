...
This simple example illustrates a non-symmetrical transformation. Since the [tt.value](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenst_tt_value_elementary.htm) commands are not enclosed in separate elements, the serialized values of ROOT1 and ROOT2 are grouped in X.
