...
description: |
  The starting points of any addressing of ABAP data in an ST program are the data roots of the main template(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenst_tt_root.htm) declared with tt:ro(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenst_tt_root.htm) at transfo
version: "7.53"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenst_trees.htm"
...
Each template uses its own tree structures. Only the main template uses the data roots declared at transformation level that are bound directly to the ABAP data objects during transformation. When [subtemplates](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenst_tt_template_sub.htm) are called, local data roots are bound to current data nodes of the caller.