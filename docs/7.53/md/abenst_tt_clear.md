...
title: "Syntax"
description: |
  <tt:clear ref='node'var='variable' /> Effect The statement tt:clear can be used to initialize a data root(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenst_tt_root.htm), a variable(https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenst_tt_variable.htm), or a
version: "7.53"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenst_tt_clear.htm"
...
-   A node node specified in accordance with the [addressing rules](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenst_addressing.htm).
