...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenst_tt_extensible.htm"
...
-   "deep-dynamic" is effective across template calls using [tt:apply](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenst_tt_apply.htm) and [tt:call](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenst_tt_call.htm).

The deep extensibility that is configured using ″deep-static" and ″deep-dynamic" also takes effect in case distinctions with [tt:switch](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenst_tt_switch.htm) and groupings with [tt:group](https://help.sap.com/doc/abapdocu_753_index_htm/7.53/en-US/abenst_tt_group.htm) by skipping unexpected elements that are not covered by a case.
