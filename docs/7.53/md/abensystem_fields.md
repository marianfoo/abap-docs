...
[System ID](javascript:call_link\('abensystem_id_glosry.htm'\) "Glossary Entry") of [AS ABAP](javascript:call_link\('abensap_nw_abap_glosry.htm'\) "Glossary Entry"), for example "S01" or "K99".
