...
The data type of operand1 can be one of the [dictionary types](javascript:call_link\('abenddic_builtin_types.htm'\)) CHAR, NUMC, CLNT, LANG, DATS, TIMS, ACCP, CUKY, UNIT, or SSTRING.

The data type of operand2 must be [c](javascript:call_link\('abenbuiltin_types_character.htm'\)) or [string](javascript:call_link\('abenbuiltin_types_character.htm'\)) and the following applies to the content:
