...
This example demonstrates how associations are published using [WITH ASSOCIATIONS](javascript:call_link\('abapwith_associations.htm'\)) after a common [table expression](javascript:call_link\('abencommon_table_expression_glosry.htm'\) "Glossary Entry").
