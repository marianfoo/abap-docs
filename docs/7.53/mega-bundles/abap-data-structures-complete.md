# ABAP DATA-STRUCTURES - Complete Reference (7.53)

**Generated**: 2025-09-01T11:14:58.542Z
**Bundles Combined**: 34
...
## ABAP Keyword Documentation / ABAP − Reference / Calling and Exiting Program Units / Calling Programs / Calling Executable Programs / SUBMIT / SUBMIT - selscreen_options
...
## ABAP Keyword Documentation / ABAP − Reference / Calling and Exiting Program Units / Calling Programs / Calling Executable Programs / SUBMIT / SUBMIT - list_options
...
Uses the addition EXCEPT in the [basic form](javascript:call_link\('abenconstructor_expr_filter_basic.htm'\)) of the FILTER operator.
...
## ABAP Keyword Documentation / ABAP − Reference / SAP GUI User Dialogs / Dynpros / Statements in the Dynpro Flow Logic / Table Controls
