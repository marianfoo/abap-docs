...
description: |
  -   TYPE-POOLS(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abaptype-pools.htm) -   CLASS, INTERFACE - LOAD(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapclass_interface_load.htm) -   FIELDS(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapfields.ht
version: "7.54"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenaddress_obsolet.htm"
...
-   [CLASS, INTERFACE - LOAD](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapclass_interface_load.htm)
...
description: |
  Quick Reference(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapclass_deferred_load_shortref.htm) Obsolete Syntax CLASS class DEFINITION LOAD. INTERFACE intf LOAD. Effect The variants of the statements CLASS(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapclass.htm)
version: "7.54"
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapclass_interface_load.htm"
...
The variants of the statements [CLASS](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapclass.htm) and [INTERFACE](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapinterface.htm) with the addition LOAD are obsolete. ABAP Compiler ignores these statements.
...
These variants of the statements CLASS and INTERFACE can also be used in contexts other than the context described in [CLASS](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapclass.htm) and [INTERFACE](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapinterface.htm).
...
title: "FIELDS"
description: |
  Quick Reference(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapfields_shortref.htm) Obsolete Syntax FIELDS dobj. Effect This statement (forbidden in classes) addresses a data object dobj of the program. A warning from the extended program check can be avoided if the data object dob
version: "7.54"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapfields.htm"
...
[Quick Reference](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapfields_shortref.htm)
...
This statement (forbidden in classes) is replaced by the [pragma](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenpragma_glosry.htm "Glossary Entry") ##NEEDED.
