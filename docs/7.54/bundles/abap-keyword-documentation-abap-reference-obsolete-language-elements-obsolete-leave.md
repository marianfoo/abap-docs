...
description: |
  This section describes how to leave(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenabap_leave_program.htm) a program with the LEAVE(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapleave-.htm) statement and no further additions. LEAVE(https://help.sap.com/doc/abap
version: "7.54"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenobsolete_leave.htm"
...
This section describes how to [leave](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenabap_leave_program.htm) a program with the [LEAVE](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapleave-.htm) statement and no further additions.
...
title: "LEAVE"
description: |
  Quick Reference(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapleave_shortref.htm) Obsolete Syntax LEAVE. Effect The statement LEAVE without additions is context-specific: -   In list processing (when the list processor(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/a
version: "7.54"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapleave-.htm"
