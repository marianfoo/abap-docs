...
description: |
  -   SET LOCALE - obsolete_parameters(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapset_locale_obsolete.htm) -   GET LOCALE - obsolete_parameters(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapget_locale_obsolete.htm) SET LOCALE - obsolete_parameters(https://
version: "7.54"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abentext_environment_obsolete.htm"
abapFile: "abentext_environment_obsolete.htm"
keywords: ["do", "abentext", "environment", "obsolete"]
---
...
-   [SET LOCALE - obsolete\_parameters](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapset_locale_obsolete.htm)

-   [GET LOCALE - obsolete\_parameters](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapget_locale_obsolete.htm)
...
description: |
  ... COUNTRY cntry MODIFIER mod Extras: 1. ... COUNTRY cntry(#!ABAP_ADDITION_1@1@) 2. ... MODIFIER mod(#!ABAP_ADDITION_2@2@) Effect ABAP syntax allows you to specify the additions COUNTRY and MODIFIER for the statementSET LOCALE LANGUAGE(https://help.sap.com/doc/abapdocu_754_i
version: "7.54"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapset_locale_obsolete.htm"
...
ABAP syntax allows you to specify the additions COUNTRY and MODIFIER for the statement[SET LOCALE LANGUAGE](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapset_locale.htm). These additions should not be used.
...
The function of this addition was not implemented in full and is undefined. If the data object lang of the statement [SET LOCALE LANGUAGE](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapset_locale.htm) contains only blanks, the addition is ignored.

Note

Do not confuse the statement SET LOCALE LANGUAGE with the addition COUNTRY of the statement [SET COUNTRY](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapset_country.htm), which is used to configure the [formatting settings](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenformat_setting_glosry.htm "Glossary Entry").
...
title: "Obsolete Syntax"
description: |
  ... COUNTRY cntry MODIFIER mod Extras: 1. ... COUNTRY cntry(#!ABAP_ADDITION_1@1@) 2. ... MODIFIER mod(#!ABAP_ADDITION_2@2@) Effect Although ABAP syntax requires the additions COUNTRY and MODIFIER to be specified for the statement GET LOCALE(https://help.sap.com/doc/abapdocu_754_index_htm/7.5
version: "7.54"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapget_locale_obsolete.htm"
