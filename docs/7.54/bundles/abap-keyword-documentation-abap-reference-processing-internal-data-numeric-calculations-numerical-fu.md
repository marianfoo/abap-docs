...
Determines the lesser of two time stamps in packed numbers. Here, the initial value of the conditional operator [COND](javascript:call_link\('abenconditional_expression_cond.htm'\)) is not regarded as the least value.
