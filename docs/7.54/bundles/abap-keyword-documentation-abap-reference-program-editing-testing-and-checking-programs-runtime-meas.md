...
- [abenabap_runtime_measurements.htm](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenabap_runtime_measurements.htm)
- [abapget_run_time.htm](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapget_run_time.htm)
- [abenget_run_time_abexa.htm](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenget_run_time_abexa.htm)
- [abapset_run_time_clock_resolution.htm](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapset_run_time_clock_resolution.htm)
- [abapset_run_time_analyzer.htm](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapset_run_time_analyzer.htm)
- [abencl_abap_runtime.htm](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abencl_abap_runtime.htm)

**Bundle Contains**: 6 documentation pages
**Version**: ABAP 7.54
**Generated**: 2025-09-01T11:25:45.980Z
...
Alternatively, you can also use a [class for runtime measurements](javascript:call_link\('abencl_abap_runtime.htm'\)) (CL\_ABAP\_RUNTIME).
...
-   Runtime analysis was replaced by ABAP Profiler in the [ABAP Development Tools (ADT)](javascript:call_link\('abenadt_glosry.htm'\) "Glossary Entry").
