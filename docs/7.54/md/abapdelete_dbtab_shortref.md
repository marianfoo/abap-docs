...
[Reference](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapdelete_dbtab.htm)
...
           *\[*WHERE [sql\_cond](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abensql_cond_shortref.htm)*\]* *\[*ORDER BY ... *\[*OFFSET o*\]**\]* *\[*UP TO n ROWS*\]* *}*
...
[ABAP SQL](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenopen_sql_glosry.htm "Glossary Entry") statement. Deletes rows from a database table or a classic view.

Additions

-   [FROM dbtab*|*view*|*(target\_syntax)](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapiumd_target.htm)
...
-   [WHERE sql\_cond](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapdelete_where.htm)
...
-   [FROM *{* wa*|**{*TABLE itab*}* *}*](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapdelete_source.htm)
