...
title: "Syntax"
description: |
  ...  table_key(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapdelete_itab_key.htm)   index(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapdelete_itab_index.htm) . Effect In this variant, the statement DELETE deletes a row specified by a table key in tab
version: "7.54"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapdelete_itab_line.htm"
...
... *{* [table\_key](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapdelete_itab_key.htm)  *|* [index](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapdelete_itab_index.htm) *}*.

Effect

In this variant, the statement DELETE deletes a row specified by a table key in [table\_key](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapdelete_itab_key.htm) or a row specified by a row number [index](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapdelete_itab_index.htm).
...
Continue
[DELETE itab - table\_key](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapdelete_itab_key.htm)
[DELETE itab - index](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapdelete_itab_index.htm)