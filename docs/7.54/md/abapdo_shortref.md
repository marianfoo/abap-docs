...
description: |
  Reference(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapdo.htm) Syntax DO n TIMES VARYING dobj FROM dobj1 NEXT dobj2 RANGE range VARYING .... statement_block ENDDO. Effect Executes the statement block statement_block more than once in a si
version: "7.54"
category: "ui"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapdo_shortref.htm"
...
[Reference](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapdo.htm)
...
-   [VARYING dobj FROM dobj1 NEXT dobj2 *\[*RANGE range*\]*](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapdo_varying.htm)
