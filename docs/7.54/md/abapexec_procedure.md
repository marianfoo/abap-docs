...
description: |
  Syntax EXEC SQL. EXECUTE PROCEDURE proc ( IN    p_in1,    IN    p_in2, ... OUT   p_out1,   OUT   p_out2, ... INOUT p_inout1, INOUT p_inout2, ... ) ENDEXEC. Effect In database systems, procedures can be defined as stored procedures(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/ab
version: "7.54"
category: "database"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapexec_procedure.htm"
