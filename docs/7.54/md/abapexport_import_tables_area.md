...
-   In global classes, it is not possible to use table work areas. In local classes of programs other than [class pools](javascript:call_link\('abenclass_pool_glosry.htm'\) "Glossary Entry"), the implicit mechanism is applied to any table work areas of the master program.
