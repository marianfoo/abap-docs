...
[Reference](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapform_definition.htm)
...
-   [DEFINITION](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapform_definition.htm)
    Declaration part of the subroutine. The declaration of the parameter interface is the same as in [FORM](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapform_shortref.htm).
    
-   [IMPLEMENTATION](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapform_definition.htm)
