...
description: |
  Reference(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapget_pf.htm) Syntax GET PF-STATUS status PROGRAM prog EXCLUDINGfcode. Effect Returns the current GUI status(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abengui_status_glosry.htm 'Glossary Entry
version: "7.54"
category: "ui"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapget_pf-status_shortref.htm"
