...
description: |
  Reference(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapon.htm) Syntax ON CHANGE OF dobj OR dobj1 OR dobj2 .... statement_block ENDON. Effect Obsolete: Defines a control structure with a statement block statement_block. The statement block is executed if the data
version: "7.54"
category: "ui"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapon_change_of_shortref.htm"
