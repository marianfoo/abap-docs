...
description: |
  Quick Reference(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapreplace_shortref.htm) Syntax ... RESPECTINGIGNORING CASE REPLACEMENT COUNT rcnt  REPLACEMENT LINE rlin REPLACEMENT OFFSET roff REPLACEMENT LENGTH rlen  RE
version: "7.54"
category: "data-structures"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapreplace_itab_options.htm"
...
The addition REPLACEMENT LINE returns the last row number in which the search pattern was found using the statement [REPLACE IN TABLE](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapreplace_itab.htm) in rlin. The following can be specified for rlin:
...
The remaining additions used for making replacements in individual table rows have the same [meaning](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapreplace_options.htm) as pattern-based replacements made using [REPLACE](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapreplace_in_pattern.htm) in elementary character strings or byte strings.
...
This example performs the same replacement as the [replacement range](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapreplace_table_range.htm) example. Here, the positions of the replaced occurrences are returned.
