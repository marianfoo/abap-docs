...
description: |
  SORT(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapsort_itab.htm) itab BY <fs1> <fs2> ... Effect In internal tables with header lines(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenheader_line_glosry.htm 'Glossary Entry'), field symbols can also be specified as a
version: "7.54"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapsort_itab_obsolete.htm"
