...
description: |
  ... BY field1 ASCENDINGDESCENDING AS TEXT field2 ASCENDINGDESCENDING AS TEXT ... Extras: 1. ... ASCENDINGDESCENDING(#!ABAP_ADDITION_1@1@) 2. ... AS TEXT(#!ABAP_ADDITION_2@2@) Effect When a sort key is specified using the addition BY, sorting is not done
version: "7.54"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapsort_key.htm"
abapFile: "abapsort_key.htm"
keywords: ["do", "if", "case", "try", "data", "field-symbol", "abapsort", "key"]
---
