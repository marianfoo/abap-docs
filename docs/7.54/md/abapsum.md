...
title: "SUM"
description: |
  Quick Reference(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapsum_shortref.htm) Syntax SUM. Effect The statement SUM can only be specified within a loop starting with LOOP(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abaploop_at_itab.htm), and is only respected wit
version: "7.54"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapsum.htm"
abapFile: "abapsum.htm"
keywords: ["loop", "do", "if", "try", "data", "types", "internal-table", "abapsum"]
---
...
The statement SUM can only be specified within a loop starting with [LOOP](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abaploop_at_itab.htm), and is only respected within a [AT\-ENDAT](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapat_itab.htm) control structure. Prerequisites for using the statement SUM include using the addition INTO in the LOOP statement, and that the specified work area wa is [compatible](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abencompatible_glosry.htm "Glossary Entry") with the row type of the internal table. In addition, SUM cannot be used when the row type of the internal table itab contains components that are tables.
...
[Group Level Processing with Totals](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenint_table_sum_abexa.htm)
