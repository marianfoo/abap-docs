...
-   The [SELECT liste](javascript:call_link\('abapselect_list.htm'\)) must consist of a list of specified columns [col\_spec](javascript:call_link\('abapselect_clause_col_spec.htm'\)) as [SQL expressions](javascript:call_link\('abapsql_expr.htm'\)). \* and data\_source~\* cannot be specified.
