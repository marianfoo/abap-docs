...
description: |
  Self-written XSLT programs and simple transformations enable the following transformations: -   Serialization of ABAP data objects to JSON -   An XSL transformation(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenabap_xslt.htm) accesses the asXML(https://help.sap.com/doc/abapdocu_
version: "7.54"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenabap_json_trafos_self.htm"
