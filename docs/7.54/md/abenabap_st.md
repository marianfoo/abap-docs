...
description: |
  Simple Transformations (ST) is an SAP programming language for describing transformations between ABAP data and XML(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenxml_glosry.htm 'Glossary Entry') formats. ST is restricted to the two modes of serialization(https://help.sap.com/doc
version: "7.54"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenabap_st.htm"
...
Simple Transformations (ST) is an SAP programming language for describing transformations between ABAP data and [XML](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenxml_glosry.htm "Glossary Entry") formats. ST is restricted to the two modes of [serialization](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenserialization_glosry.htm "Glossary Entry") (ABAP to XML) and [deserialization](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abendeserialization_glosry.htm "Glossary Entry") (XML to ABAP) of ABAP data, which are most important for data integration. Transformations from ABAP to ABAP and XML to XML (like in the more general [XSLT](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenxslt_glosry.htm "Glossary Entry")) are not possible in ST.

Simple Transformations are created as [ST programs](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenst_programs_structure.htm). ST programs can be edited using [Transformation Editor](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abentransformation_editor_glosry.htm "Glossary Entry"). This is called up either with transaction STRANS or by choosing Edit Object → More → Transformation followed by Simple Transformation in Object Navigator in [ABAP Workbench](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenabap_workbench_glosry.htm "Glossary Entry"). Existing ST programs can be called using the statement [CALL TRANSFORMATION](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapcall_transformation.htm). The associated ST processor is integrated into the ABAP runtime environment.

In comparison with [XSLT](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenabap_xslt.htm), the main advantages of ST programs are as follows:
...
[ST - Access to ABAP Objects from ST](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenst_abap_objects.htm)
[ST - Overview of Commands](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenst_statements.htm)
