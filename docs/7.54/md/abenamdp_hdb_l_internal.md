...
description: |
  This function is only for internal use within SAP. Customers and partners are not allowed to use this function. L(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenllang_glosry.htm 'Glossary Entry') is a low-level programming language used for programming L procedures(https://help.s
version: "7.54"
category: "database"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenamdp_hdb_l_internal.htm"
