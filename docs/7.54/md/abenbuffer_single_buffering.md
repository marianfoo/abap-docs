...
-   When using single record buffering, any ABAP SQL statements must respect the full primary key to prevent them from [bypassing](javascript:call_link\('abenbuffer_restrictions.htm'\)) table buffering.
