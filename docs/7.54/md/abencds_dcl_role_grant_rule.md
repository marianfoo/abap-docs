...
-   The addition REDEFINITION is ignored by the authorization (a full access rule overwrites any [COMBINATION MODE AND](javascript:call_link\('abencds_dcl_role_cond_rule.htm'\)) rules too).
