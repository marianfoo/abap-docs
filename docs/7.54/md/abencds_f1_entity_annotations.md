...
Specifies an [annotation](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abencds_annotation_glosry.htm "Glossary Entry") [annotation](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abencds_annotations_syntax.htm) as an entity annotation in front of the statement in the definition of a [CDS entity](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abencds_entity_glosry.htm "Glossary Entry").
...
-   [EndUserText Annotations](#@@ITOC@@ABENCDS_F1_ENTITY_ANNOTATIONS_1)

-   [Metadata Annotations](#@@ITOC@@ABENCDS_F1_ENTITY_ANNOTATIONS_2)
...
Defines whether annotations can be extended from [metadata extensions](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abencds_meta_data_extensions.htm)
...
The [CDS table functions](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abencds_table_function_glosry.htm "Glossary Entry") cannot currently be extended. The annotation Metadata.allowExtensions can be specified for a table function but is currently ignored.
