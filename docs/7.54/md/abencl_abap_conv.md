...
-   The methods UTCLONG2TSTMP, UTCLONG2TSTMP\_SHORT, and TSTMP2UTCLONG of the class [CL\_ABAP\_TSTMP](javascript:call_link\('abencl_abap_tstmp.htm'\)) convert the content of [time stamp fields](javascript:call_link\('abentimestamp_field_glosry.htm'\) "Glossary Entry") to representation in packed numbers and back.