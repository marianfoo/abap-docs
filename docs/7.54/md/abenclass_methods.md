...
Any attempt to use an initial[object reference variable](javascript:call_link\('abenobject_refer_variable_glosry.htm'\) "Glossary Entry") to call an instance method raises a catchable exception.
