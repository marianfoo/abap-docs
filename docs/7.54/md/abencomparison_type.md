...
If the comparison type is the [time stamp type](javascript:call_link\('abenbuiltin_types_date_time.htm'\)), the times are compared, with a later time always being the greater value and the initial value always being less than every real time stamp.