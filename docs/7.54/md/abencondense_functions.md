...
title: "Syntax"
description: |
  ... condense( val = text(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenstring_functions_val.htm) del = del from = from to = to ) ... Effect This function returns the content of text(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenst
version: "7.54"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abencondense_functions.htm"
...
... condense( [*\[*val =*\]* text](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenstring_functions_val.htm) *\[*del = del*\]* *\[*from = from*\]* *\[*to = to*\]* ) ...

Effect

This function returns the content of [text](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenstring_functions_val.htm), condensed as follows:
...
del, from, and to are [character-like expression positions](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abencharlike_expr_position_glosry.htm "Glossary Entry"). If they have a fixed length, trailing blanks are ignored.

The return code has the type string.

Notes

-   When the standard values for del, from, and to are specified, the condense function works in the same way as the [CONDENSE](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapcondense.htm) statement without the NO-GAPS addition.
