...
In part, the [calculation type](javascript:call_link\('abenarith_type.htm'\)) decfloat34 is forced to calculate numbers using powers of two. This prevents overflows when assigning the results of the function [ipow](javascript:call_link\('abenipow_function_abexa.htm'\)) to subtotals of the calculation type i or int8.
