...
The method TSTMP2UTCLONG of class [CL\_ABAP\_TSTMP](javascript:call_link\('abencl_abap_tstmp.htm'\)) converts [time stamps in packed numbers](javascript:call_link\('abentime_stamps_packed.htm'\)) to [time stamp fields](javascript:call_link\('abentimestamp_field_glosry.htm'\) "Glossary Entry") of the type utclong.
