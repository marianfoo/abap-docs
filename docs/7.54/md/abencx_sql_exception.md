...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abencx_sql_exception.htm"
...
Any errors that occur when using dynamic SQL statements with ADBC raise exceptions of the class CX\_SQL\_EXCEPTION. Alongside its [exception texts](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenexception_text_glosry.htm "Glossary Entry"), this class has the following instance attributes, whose contents indicate the cause of the error:
