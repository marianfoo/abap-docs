...
-   Flat structures do not contain any [deep](javascript:call_link\('abendeep_glosry.htm'\) "Glossary Entry") components. They only contain components with flat data types, such as elementary types c, n, d, t, decfloat16, decfloat34, f, i, int8, p, x, utclong, plus b, s, or structures with these types.
