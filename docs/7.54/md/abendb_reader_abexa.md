...
description: |
  This example demonstrates how data can be read from a database table using a reader stream(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenreader_stream_glosry.htm 'Glossary Entry'). Source Code REPORT demo_db_reader. CLASS demo DEFINITION. PUBLIC SECTION. CLASS-METHODS main. PRIV
version: "7.54"
category: "database"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abendb_reader_abexa.htm"
...
This example demonstrates how data can be read from a database table using a [reader stream](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenreader_stream_glosry.htm "Glossary Entry").
...
In the method main, a reference variable reader is declared for a reader stream. This reader stream is then [created](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenselect_into_lob_handles.htm) in a SELECT statement.

The internal table pict is then filled iteratively with binary data from the row found. If data previously written in the executable [writer stream example](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abendb_writer_abexa.htm) is read, this is the data of a figure in the GIF format.
