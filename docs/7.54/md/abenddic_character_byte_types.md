...
[ABAP Keyword Documentation](javascript:call_link\('abenabap.htm'\)) →  [ABAP - Dictionary](javascript:call_link\('abenabap_dictionary.htm'\)) →  [Built-In Data Types in ABAP Dictionary](javascript:call_link\('abenddic_builtin_types_intro.htm'\)) →  [Attributes of the Predefined Dictionary Types](javascript:call_link\('abenddic_builtin_types_prop.htm'\)) →  [General Dictionary Types](javascript:call_link\('abenddic_builtin_types_general.htm'\)) → 
...
-   In the [SELECT](javascript:call_link\('abencds_f1_select_list.htm'\)) list if the addition [DISTINCT](javascript:call_link\('abencds_f1_select_statement.htm'\)) is specified

-   In [CAST](javascript:call_link\('abencds_f1_cast_expression.htm'\)) expressions

-   In comparison expressions [cond\_expr](javascript:call_link\('abencds_f1_conditional_expression.htm'\))

-   In [string functions](javascript:call_link\('abencds_f1_sql_functions_character.htm'\))

-   In [CASE](javascript:call_link\('abencds_f1_case_expression.htm'\)) expressions

-   In [aggregate expressions](javascript:call_link\('abencds_f1_aggregate_functions.htm'\))

-   For columns merged using [UNION](javascript:call_link\('abencds_f1_union.htm'\))

-   After [GROUP BY](javascript:call_link\('abencds_f1_group_by.htm'\))
