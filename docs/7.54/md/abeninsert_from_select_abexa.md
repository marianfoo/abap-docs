...
description: |
  This example demonstrates the statement INSERT(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapinsert_dbtab.htm) with the addition FROM SELECT(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapinsert_source.htm). Source Code REPORT demo_insert_from_select. CLASS de
version: "7.54"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abeninsert_from_select_abexa.htm"
