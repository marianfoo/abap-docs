...
description: |
  This example demonstrates chaining and compounding of multiple joins(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapselect_join.htm) in the SELECT statement. Source Code REPORT demo_join_joins. CLASS demo DEFINITION. PUBLIC SECTION. CLASS-METHODS: class_constructor, main. PRIVAT
version: "7.54"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenjoin_joins_abexa.htm"
...
This example demonstrates chaining and compounding of multiple [joins](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapselect_join.htm) in the SELECT statement.
