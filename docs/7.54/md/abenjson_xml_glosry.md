...
SAP-specific representation of [JSON](javascript:call_link\('abenjson_glosry.htm'\) "Glossary Entry") data in [XML](javascript:call_link\('abenxml_glosry.htm'\) "Glossary Entry") format. [JSON readers](javascript:call_link\('abenjson_reader_glosry.htm'\) "Glossary Entry") and [JSON writers](javascript:call_link\('abenjson_writer_glosry.htm'\) "Glossary Entry") both use JSON-XML to [parse](javascript:call_link\('abenabap_json_sxml.htm'\)) and [render](javascript:call_link\('abenabap_json_sxml.htm'\)) JSON data.
