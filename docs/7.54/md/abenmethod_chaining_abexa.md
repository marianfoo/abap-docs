...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenmethod_chaining_abexa.htm"
...
In the argument of the method DISPLAY\_TEXT statement, a [chained attribute access](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenchained_attribute_acc_glosry.htm "Glossary Entry") is performed on the attribute text of the class demo. The attribute is changed by three chained method calls.