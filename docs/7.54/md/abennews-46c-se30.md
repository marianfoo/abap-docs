...
that was created or edited most recently. The default variant is set to None in [AS ABAP](javascript:call_link\('abensap_nw_abap_glosry.htm'\) "Glossary Entry"). In all other systems, it is set to Full.
