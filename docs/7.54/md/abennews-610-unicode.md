...
Release 6.10 is the first SAP Release to support Unicode. Extensive changes were made here as part of modifications made to the ABAP programming language.