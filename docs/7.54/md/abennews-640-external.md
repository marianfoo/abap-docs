...
In [asynchronous RFC](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapcall_function_starting.htm), the addition CALLING addition was introduced to also specify methods as callback routines.
...
[CALL TRANSFORMATION](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapcall_transformation.htm) can now be used to call [Simple Transformations](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenxslt_glosry.htm "Glossary Entry"), as well as [XSLT](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abensimple_transformation_glosry.htm "Glossary Entry") programs.

Modification 3

Control Options for Transformations

In [CALL TRANSFORMATION](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapcall_transformation.htm), the addition OPTIONS can be used to specify control options for the called transformations.