...
From Release 7.31, the [chained method call](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenchained_method_call_glosry.htm "Glossary Entry") can not only be specified in functions but also executed in operations.