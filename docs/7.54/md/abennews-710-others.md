...
The [predefined time formats](javascript:call_link\('abenwrite_formats.htm'\)) of the statements WRITE TO and WRITE cannot be influenced automatically due to downward compatibility.
