...
The new statement [RAISE SHORTDUMP](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapraise_shortdump.htm) raises [runtime errors](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenruntime_error_glosry.htm "Glossary Entry") associated with an [exception object](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenexception_object_glosry.htm "Glossary Entry"). This means more information can now be passed to the [short dump](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenshort_dump_glosry.htm "Glossary Entry") than was previously possible in an [exit message](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenexit_message_glosry.htm "Glossary Entry").
...
The attribute IS\_RESUMABLE of an [exception object](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenexception_object_glosry.htm "Glossary Entry") is now set after exceptions raised by the statement [RAISE RESUMABLE EXCEPTION](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapraise_exception_class.htm) only if the [CATCH](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapcatch_try.htm) statement in question has the addition BEFORE UNWIND. Previously in catches, the attribute was set for every exception raised in this way.

After an exception is raised using the statement [RAISE RESUMABLE EXCEPTION](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapraise_exception_class.htm) and caught using the statement [CATCH BEFORE UNWIND](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapcatch_try.htm), the attribute IS\_RESUMABLE is set for all previous exception objects referenced in the attribute PREVIOUS and not just for the current exception object. Up until the first resumable exception in the chain IS\_RESUMABLE is set to the value of ABAP\_TRUE and is set to the value of ABAP\_FALSE otherwise.