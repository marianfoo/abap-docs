...
description: |
  Handleable Exceptions CX_SY_OPEN_SQL_DB -   Cause: A general database error occurred. Runtime error: DBIF_RSQL_SQL_ERROR -   Cause: Error in module RSQL of the database interface. Runtime error: DBIF_RSQL_INVALID_RSQL -   Cause: No data found for the specified key. Runtime error: DBIF_RSQ
version: "7.54"
category: "database"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenopensql_exceptions.htm"
abapFile: "abenopensql_exceptions.htm"
keywords: ["select", "update", "do", "while", "if", "try", "data", "abenopensql", "exceptions"]
---
...
-   Cause: An attempt was made to create an aggregate function using a [LOB column](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenlob_glosry.htm "Glossary Entry").
    Runtime error: SAPSQL\_AGGREGATE\_LOB

-   Cause: An attempt was made to sort the values of a [LOB column](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenlob_glosry.htm "Glossary Entry").
    Runtime error: SAPSQL\_ORDER\_BY\_LOB

-   Cause: An attempt was made to use the addition DISTINCT on a [LOB column](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenlob_glosry.htm "Glossary Entry").
...
-   Cause: An attempt was made to use a [LOB column](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenlob_glosry.htm "Glossary Entry") in a logical expression.
...
-   Cause: Syntax error when the addition [CREATING](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapselect_creating.htm) was specified dynamically.
...
The following exceptions can only occur when using the statement [UPDATE](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapupdate.htm):
...
-   Cause: CDS access control in [updates](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenauthority_during_update.htm).
