...
description: |
  This example demonstrates the predicate function matches(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenmatches_functions.htm). Source Code REPORT demo_matches. CLASS demo DEFINITION. PUBLIC SECTION. CLASS-METHODS main. ENDCLASS. CLASS demo IMPLEMENTATION. METHOD main. DATA email
version: "7.54"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenpred_function_matches_abexa.htm"
...
This example demonstrates the predicate function [matches](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenmatches_functions.htm).
