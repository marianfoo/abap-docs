...
description: |
  Every output to a spool list is assigned to exactly one spool request. For every spool request, spool parameters(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenprint_parameters.htm) have been specified that can no longer be changed. Spool lists can be stacked in spool list levels.
version: "7.54"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenprint_spool.htm"
