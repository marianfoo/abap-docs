...
description: |
  The following tables summarize the special characters in regular expressions(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenregular_expression_glosry.htm 'Glossary Entry'). -   Escape Character(#abenregex-syntax-specials-1--------special-characters-for-single-character-strings---
version: "7.54"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenregex_syntax_specials.htm"
...
The following tables summarize the special characters in [regular expressions](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenregular_expression_glosry.htm "Glossary Entry").
...
The character string function [escape](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenescape_functions.htm) can be used to prefix all special characters for regular expressions with their escape character.
...
[→ More](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenregex_syntax_signs.htm)
...
[→ More](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenregex_syntax_operators.htm)
...
[→ More](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenregex_search.htm)
...
[→ More](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenregex_replace.htm)