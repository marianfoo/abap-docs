...
-   one or more [handler classes](javascript:call_link\('abenrpm_handler_class.htm'\)) to implement the interaction phase of the business object behavior

-   and a [saver class](javascript:call_link\('abenrpm_saver_class.htm'\)) to implement the save phase of the business object behavior.
