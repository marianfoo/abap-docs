...
description: |
  This example demonstrates cast expressions(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abensql_cast.htm) in ABAP SQL. Source Code REPORT demo_sql_expr_cast. CLASS demo DEFINITION. PUBLIC SECTION. CLASS-METHODS main. ENDCLASS. CLASS demo IMPLEMENTATION. METHOD main. DELETE FROM de
version: "7.54"
category: "database"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abensql_expr_cast_abexa.htm"
...
This example demonstrates [cast expressions](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abensql_cast.htm) in ABAP SQL.
