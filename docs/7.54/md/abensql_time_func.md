...
title: "Syntax"
description: |
  ... TIMS_IS_VALID( time ) ... Variants: 1. ... TIMS_IS_VALID( time )(#!ABAP_VARIANT_1@1@) Effect These SQL functions perform operations with arguments of the built-in data type TIMS(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenddic_builtin_types.htm). The arguments of the
version: "7.54"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abensql_time_func.htm"
...
When used, this function requires the [strict mode from Release 7.53](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenopensql_strict_mode_753.htm).
