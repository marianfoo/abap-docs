...
description: |
  Syntax ... length='len' ... ... minLength='len' ... ... maxLength='len' ... Effect The attributes length, minLength, and maxLength can be used to specify a length len for tt:value(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenst_tt_value_elementary.htm), tt:write(https://help.sa
version: "7.54"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenst_length.htm"
...
The attributes length, minLength, and maxLength can be used to specify a length len for [tt:value](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenst_tt_value_elementary.htm), [tt:write](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenst_tt_write.htm), and [tt:read](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenst_tt_read.htm). This restricts the length of the data passed in serializations and deserializations.
