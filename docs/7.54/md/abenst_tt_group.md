...
title: "Syntax"
description: |
  <tt:group> <tt:s-d-cond frq='...' ... <tt:s-d-cond frq='...' ... ... </tt:group> Effect In deserializations, variable inbound XML streams containing groups of related elements in any order can be responded to using the statement tt:group. Hereby, a list of cases
version: "7.54"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenst_tt_group.htm"
...
In deserializations, variable inbound XML streams containing groups of related elements in any order can be responded to using the statement tt:group. Hereby, a list of cases is specified in tt:group, where the syntax of each case is formulated by a conditional transformation, namely a subelement [tt:*\[*s-*|*d-*\]*cond](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenst_tt_cond.htm). In this case, tt:*\[*s-*\]*cond defines a serialization-relevant case, and tt:*\[*d-*\]*cond a deserialization-relevant case. Other direct subelements are not possible in tt:group. The statement tt:group can be a subelement of tt:*\[*s-*|*d-*\]*cond.

In contrast to conditional transformations positioned outside of tt:group, there is no need to specify at least one attribute [using](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenst_using.htm), [data](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenst_data.htm) or [check](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenst_check.htm) for a case, provided that the content of tt:*\[*s-*|*d-*\]*cond is not a [pattern](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenst_pattern.htm).
...
-   Only one deserialization-relevant case that does not contain a [pattern](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenst_pattern.htm) can be specified. This case is called standard deserialization.
