...
This example demonstrates how a string chaining is optimized when the right side of an [assignment](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenequals_string_expr.htm) extends a string by appending content. In this case, the strings are processed in a loop effected by a [REDUCE expression](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenconstructor_expression_reduce.htm).
