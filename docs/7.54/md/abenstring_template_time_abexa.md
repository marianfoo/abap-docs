...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenstring_template_time_abexa.htm"
...
An internal table timetable is filled with various times, and these times are displayed in all possible [country-specific time formats](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abencountry_formats.htm) using the parameter [COUNTRY](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapcompute_string_format_options.htm). For this purpose, the utility methods setup and teardown insert temporary rows with the possible values of the column TIMEFM into the database table T005X and deletes them again once they have been used.