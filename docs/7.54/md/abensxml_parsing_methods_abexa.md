...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abensxml_parsing_methods_abexa.htm"
...
This example demonstrates how various methods are used in [token-based parsing](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenabap_sxml_lib_parse_iterative.htm).
...
-   Finally, the method NEXT\_ATTRIBUTE\_VALUE is used to read the value of each attribute as raw data saved in [Base64](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenbase64_glosry.htm "Glossary Entry") format. The data is displayed only if this is successful.
