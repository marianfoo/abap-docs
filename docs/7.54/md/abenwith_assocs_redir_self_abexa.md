...
description: |
  This example demonstrates the addition REDIRECT of WITH ASSOCIATIONS(https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapwith_associations.htm) where the redirect is made to the current CTE. Source Code REPORT demo_with_assocs_redir_self. CLASS demo DEFINITION. PUBLIC SECTION. CLASS
version: "7.54"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenwith_assocs_redir_self_abexa.htm"
...
This example demonstrates the addition REDIRECT of [WITH ASSOCIATIONS](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abapwith_associations.htm) where the redirect is made to the current CTE.
...
As in the example [Publishing Association with a Redirect](https://help.sap.com/doc/abapdocu_754_index_htm/7.54/en-US/abenwith_assocs_redirect_abexa.htm), a common table expression +cte accesses the CDS view DEMO\_CDS\_PUBLISH\_ASSOC\_1 and publishes its CDS association \_demo\_join2. Here, however, the redirect is made to the current common table expression and not to a preceding common table expression. This expression specifies the target data source demo\_join2 of the published CDS association twice as an additional data source under the names src1 and src2.
