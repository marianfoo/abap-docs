...
Internal tables enable variable datasets (a variable number of lines) with a fixed structure (the line type) to be processed in the working memory of the [internal session](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abeninternal_session_glosry.htm "Glossary Entry") of a program. The content of an internal table can either be accessed sequentially in a LOOP or by accessing individual lines (for example, by using READ TABLE or a table expression).
...
-   [Selecting the Table Category](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenselect_table_type_guidl.htm "Guideline")

-   [Secondary Keys](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abensecondary_key_guidl.htm "Guideline")

-   [Initial Memory Requirements](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abeninitial_memory_requ_guidl.htm "Guideline")

-   [Sorted Filling](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abensort_guidl.htm "Guideline")

-   [Compressed Filling](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abencollect_guidl.htm "Guideline")

-   [Target Area](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abentable_output_guidl.htm "Guideline")

-   [Loop Processing](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenloop_guidl.htm "Guideline")

Continue
[Selecting the Table Category](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenselect_table_type_guidl.htm)
[Secondary Key](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abensecondary_key_guidl.htm)
[Initial Memory Requirements](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abeninitial_memory_requ_guidl.htm)
[Sorted Filling](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abensort_guidl.htm)
[Collected Filling](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abencollect_guidl.htm)
[Target Area](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abentable_output_guidl.htm)
[Loop Processing](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenloop_guidl.htm)
...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abensecondary_key_guidl.htm"
...
category: "ui"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abeninitial_memory_requ_guidl.htm"
...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abensort_guidl.htm"
...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abencollect_guidl.htm"
...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenloop_guidl.htm"
