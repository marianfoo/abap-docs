...
- [abenbc_authority_check.htm](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenbc_authority_check.htm)
- [abapauthority-check.htm](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapauthority-check.htm)
...
> **📖 Official SAP Documentation**: [abenbc_authority_check.htm](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenbc_authority_check.htm)
...
Authorizations are a method used to protect functions or objects in [AS ABAP](javascript:call_link\('abenas_abap_glosry.htm'\) "Glossary Entry"). The programmer of a function determines where authorizations are checked and how. The user administrator determines which users can execute a function or access an object.
...
A check to determine whether the current user of a program has a certain authorization. The check compares a value with the corresponding entries in each authorization field in an authorization object in the user master record. [Check indicators](javascript:call_link\('abencheck_indicator_glosry.htm'\) "Glossary Entry") control whether an authorization check is performed.
...
**📖 Source**: [abenbc_authority_check.htm](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenbc_authority_check.htm)

### abapauthority-check.htm

> **📖 Official SAP Documentation**: [abapauthority-check.htm](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapauthority-check.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.


**📖 Source**: [abapauthority-check.htm](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapauthority-check.htm)
...
During [update](javascript:call_link\('abenauthority_during_update.htm'\)) the statement AUTHORITY-CHECK always sets the value sy-subrc to 0 and does not make an authorization check.
