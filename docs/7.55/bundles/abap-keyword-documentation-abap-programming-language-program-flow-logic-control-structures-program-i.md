...
- [abenwait.htm](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenwait.htm)
- [abapwait_up_to.htm](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapwait_up_to.htm)
...
> **📖 Official SAP Documentation**: [abenwait.htm](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenwait.htm)
...
This section describes how programs are usually interrupted using the statement [WAIT](javascript:call_link\('abapwait_up_to.htm'\)). A special [variant](javascript:call_link\('abapwait_arfc.htm'\)) is explained in the context of [asynchronous RFC](javascript:call_link\('abenasynchronous_rfc_glosry.htm'\) "Glossary Entry").
...
**📖 Source**: [abenwait.htm](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenwait.htm)

### abapwait_up_to.htm

> **📖 Official SAP Documentation**: [abapwait_up_to.htm](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapwait_up_to.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.


**📖 Source**: [abapwait_up_to.htm](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapwait_up_to.htm)
