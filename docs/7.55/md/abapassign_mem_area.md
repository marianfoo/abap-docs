...
-   In dynamic variants and when a [table expression](javascript:call_link\('abapassign_mem_area_writable_exp.htm'\)) is specified, the statement ASSIGN sets the return value sy-subrc.
