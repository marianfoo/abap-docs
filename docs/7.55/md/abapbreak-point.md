...
-   Session breakpoints
    are set in ABAP Editor. Session breakpoints are valid in all [ABAP sessions](javascript:call_link\('abenabap_session_glosry.htm'\) "Glossary Entry") of the current user session.
