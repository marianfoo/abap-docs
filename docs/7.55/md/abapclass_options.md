...
Definition of the properties of a class. A test class for [ABAP Unit](javascript:call_link\('abenabap_unit_glosry.htm'\) "Glossary Entry") is created using the addition [FOR TESTING](javascript:call_link\('abapclass_for_testing.htm'\)).
