...
description: |
  This statement is no longer supported. Syntax IMPORT NAMETAB ... Effect This statement was used internally to import a DDIC structure description in an internal format from the name table(https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenname_table_glosry.htm 'Glossary Entry') of the
version: "7.55"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapimport_nametab.htm"
