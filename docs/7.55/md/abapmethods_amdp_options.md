...
Whether the input parameter is used explicitly in self-programmed conditions or implicitly in CDS-managed DDIC views, this ensures that the data of the same [client](javascript:call_link\('abenclient_glosry.htm'\) "Glossary Entry") is accessed.
