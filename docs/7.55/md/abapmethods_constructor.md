...
-   The instance constructor does not have access to the instance components of its class. The self-reference [me->](javascript:call_link\('abenme.htm'\)) must not be used. The static components of its class can only be accessed directly.
