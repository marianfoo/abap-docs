...
description: |
  Short Reference(https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapmodify_dbtab_shortref.htm) Obsolete Syntax MODIFY  dbtab  dbtab  VERSION vers. Effect This variant of the statement MODIFY works essentially like the short form(https://help.sap.com/doc/abapdocu_755_index_h
version: "7.55"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapmodify_dbtab_obsolete.htm"
...
This variant of the statement MODIFY works essentially like the [short form](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapmodify_obsolete.htm) of the ABAP SQL statement, but belongs, along with the addition VERSION, to the number of [obsolete access statements](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abendb_access_obsolete.htm), for which for dbtab, the name of a database table or a [DDIC table view](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abentable_view_glosry.htm "Glossary Entry") must be specified, beginning with "T" and comprising no more than five characters.
