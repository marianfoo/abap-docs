...
MODIFY *{* [itab\_line](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapmodify_itab_single.htm) *|* [itab\_lines](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapmodify_itab_multiple.htm) *}*.

Effect

This statement changes the content either of a single line [itab\_line](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapmodify_itab_single.htm) or multiple lines [itab\_lines](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapmodify_itab_multiple.htm), which can be specified using a table key or a table index.
...
-   Using a special variant [MODIFY mesh\_path](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenmesh_modify.htm), lines from the last path node of a [mesh path](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenmesh_path_glosry.htm "Glossary Entry") can be changed.
    

Example

Modification of a line in an internal table using a key access. A line with a specific key value is read to a work area wa and a structure with a different value is then constructed in a non-key component after the addition [FROM](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapmodify_itab_single.htm) of the statement MODIFY. The table line with the appropriate key value is then modified.
...
Continue
[MODIFY itab, itab\_line](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapmodify_itab_single.htm)
[MODIFY itab, itab\_lines](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapmodify_itab_multiple.htm)