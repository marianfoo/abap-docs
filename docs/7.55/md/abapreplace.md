...
title: "REPLACE"
description: |
  Short Reference(https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapreplace_shortref.htm) Syntax Forms Pattern-Based Replacement(https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapreplace_in_pattern.htm) 1. REPLACE FIRST OCCURRENCEALL OCCURRENCES OF
version: "7.55"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapreplace.htm"
...
[Pattern-Based Replacement](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapreplace_in_pattern.htm)
1\. REPLACE *\[**{*FIRST OCCURRENCE*}**|**{*ALL OCCURRENCES*}* OF*\]* [pattern](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapreplace_pattern.htm)
...
[Position-Based Replacement](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapreplace_in_position.htm)
...
-   These forms of the statement REPLACE replace the following obsolete form:
    [REPLACE substring WITH new INTO dobj ...](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapreplace_obsolete.htm)

-   To replace parts of a character string in an operand position, a [replace function](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenreplace_functions.htm) can be used that includes some of the functions of the statement REPLACE.
    

Continue
[REPLACE pattern IN](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapreplace_in_pattern.htm)
[REPLACE SECTION OF](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapreplace_in_position.htm)