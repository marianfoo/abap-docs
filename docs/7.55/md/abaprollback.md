...
3.  Raises an internal event in the [Object Services](javascript:call_link\('abenobject_services_glosry.htm'\) "Glossary Entry") that makes sure that the attributes of persistent objects are initialized.
