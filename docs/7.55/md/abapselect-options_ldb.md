...
The subroutines can be used in the same way as a [PARAMETERS](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapparameters.htm) statement to program a field help.
