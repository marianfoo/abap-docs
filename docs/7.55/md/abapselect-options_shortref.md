...
-   [MEMORY ID pid](javascript:call_link\('abapselect-options_value.htm'\))
    Associates the first input field with the [SPA/GPA parameter](javascript:call_link\('abenspa_gpa_parameter_glosry.htm'\) "Glossary Entry") pid in the [user memory](javascript:call_link\('abenuser_memory_glosry.htm'\) "Glossary Entry").
