...
The addition NO INTERVALS of TABBED BLOCK has no affect on the [selection criteria](javascript:call_link\('abenselection_criterion_glosry.htm'\) "Glossary Entry") of selection screens, which are integrated as subscreen dynpros in the tab area.
