...
-   To prevent an entire line from being horizontally movable, use the [NEW-LINE](javascript:call_link\('abapnew-line.htm'\)) NO-SCROLLING statement.
