...
as defined in the respective [DEFINE](javascript:call_link\('abencds_f1_ddl_syntax.htm'\)) statement of the [CDS DDL](javascript:call_link\('abencds_ddl_glosry.htm'\) "Glossary Entry").
