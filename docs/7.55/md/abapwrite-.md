...
For dobj, those data types are allowed that are grouped under the generic type [simple](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenbuilt_in_types_generic.htm):
