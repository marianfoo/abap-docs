...
B
[
bit\_exp - Set Operations](javascript:call_link\('abendata_bit_abexa.htm'\))[
...
CDS DDL - projection\_view, calculating a virtual element](javascript:call_link\('abencds_proj_view_virtel_abexa.htm'\))[
CDS DDL - projection\_view, expose associations](javascript:call_link\('abencds_proj_view_assoc_abexa.htm'\))[
...
dynpro - Input Helps in ABAP Dictionary](javascript:call_link\('abendynpro_f4_help_dic_abexa.htm'\))[
...
itab - Introduction to LOOP AT GROUP BY](javascript:call_link\('abenloop_group_by_abexa.htm'\))[
...
L
[
LDB - Association with a Program](javascript:call_link\('abenreport_abexa.htm'\))[
...
regex - Demonstration Program](javascript:call_link\('abenregex_abexa.htm'\))[
