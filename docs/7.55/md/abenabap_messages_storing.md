...
description: |
  Messages(https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenmessage_glosry.htm 'Glossary Entry') are created in the message maintenance (transaction SE91). The message short texts are saved as language-specific texts to the database table T100, which offers an interface to the translat
version: "7.55"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenabap_messages_storing.htm"
...
[Messages](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenmessage_glosry.htm "Glossary Entry") are created in the message maintenance (transaction SE91).
...
Placeholders can be used in both short and long texts, which are replaced by the content of data objects using the statement [MESSAGE](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapmessage.htm) and the addition [WITH](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapmessage.htm). The placeholders in a short text can have the form "&i" or "&" and the placeholders in a long text can have the form "", where i is a digit between 1 and 4. If the actual character "&" is to be used literally, "&&" must be entered in the short text and "&" in the long text.
