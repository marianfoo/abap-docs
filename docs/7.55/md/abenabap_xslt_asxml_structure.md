...
description: |
  -   asXML, Mapping of Structures(https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenasxml_structure_abexa.htm) -   Deserializing Structure Components(https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenabap_asxml_asjson_empty_abexa.htm)
version: "7.55"
category: "data-structures"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenabap_xslt_asxml_structure.htm"
...
The asXML representation of structures is significant mainly for XSL transformations. In simple transformations, this representation is important only when using the statement [tt:copy](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenst_tt_copy.htm).
