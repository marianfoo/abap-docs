...
title: "ADBC - Query"
description: |
  This example demonstrates the execution of a query(https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenadbc_query.htm) with ADBC. Source Code REPORT demo_adbc_query. 'This program uses platform dependent Native SQL. 'It may not work for every database system. CLASS demo DEFINITION. PU
version: "7.55"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenadbc_query_abexa.htm"
...
This example demonstrates the execution of a [query](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenadbc_query.htm) with ADBC.
...
Quotation marks are escaped in the user input. This prevents [SQL injections](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abensql_injection_glosry.htm "Glossary Entry").