...
This example demonstrates the implementation of a procedure in the programming language [L](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenllang_glosry.htm "Glossary Entry") using AMDP.
...
The following [L procedure](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenl_procedure_glosry.htm "Glossary Entry") is implemented in the AMDP method HELLO\_WORLD of the AMDP class CL\_DEMO\_AMDP\_L\_HELLO\_WORLD:
