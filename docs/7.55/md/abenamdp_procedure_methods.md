...
-   The typing of the parameters cannot be [generic](javascript:call_link\('abengeneric_typing_glosry.htm'\) "Glossary Entry"). Only [elementary data types](javascript:call_link\('abenelementary_data_type_glosry.htm'\) "Glossary Entry") and [table types](javascript:call_link\('abentable_type_glosry.htm'\) "Glossary Entry") with a structured line type can be used. The line type of a tabular type can only contain elementary data types as components
