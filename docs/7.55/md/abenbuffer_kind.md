...
There are three buffering types that can be [configured](javascript:call_link\('abenddic_database_tables_buffer.htm'\)) for a DDIC database table or DDIC database view in the ABAP Dictionary:
