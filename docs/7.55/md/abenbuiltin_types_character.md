...
-   The content of the data objects of character-like data types is stored in the memory in according to the current [system code page](javascript:call_link\('abensystem_codepage_glosry.htm'\) "Glossary Entry")
