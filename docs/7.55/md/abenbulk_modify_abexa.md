...
description: |
  This example demonstrates the statement MODIFY(https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapmodify_dbtab.htm) ... FROM TABLE(https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapmodify_source.htm). Source Code REPORT demo_bulk_modify. CLASS demo DEFINITION. PUBLIC S
version: "7.55"
category: "data-structures"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenbulk_modify_abexa.htm"
...
This example demonstrates the statement [MODIFY](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapmodify_dbtab.htm) ... [FROM TABLE](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapmodify_source.htm).
