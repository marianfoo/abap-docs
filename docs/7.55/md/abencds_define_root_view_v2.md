...
-   A root entity can specify [CDS compositions](javascript:call_link\('abencds_composition_glosry.htm'\) "Glossary Entry") that define [child entities](javascript:call_link\('abenchild_entity_glosry.htm'\) "Glossary Entry") of the business object using the keyword [COMPOSITION](javascript:call_link\('abencds_composition_v2.htm'\)).
