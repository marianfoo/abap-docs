...
description: |
  The system classes listed below enable the conversion of text data between different code pages(https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abencodepage_glosry.htm 'Glossary Entry') and of numeric data between different number representations. Data that is not in ABAP format, that i
version: "7.55"
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abencl_abap_conv.htm"
