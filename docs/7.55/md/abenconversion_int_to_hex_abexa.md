...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenconversion_int_to_hex_abexa.htm"
...
To calculate the numbers with powers of two, the [calculation type](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenarith_type.htm) decfloat34 is sometimes forced, to avoid overflows when assigning the results of the function [ipow](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenipow_function_abexa.htm) to interim results of the calculation type i or int8.
