...
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abencreate_structured_data_abexa.htm"
abapFile: "abencreate_structured_data_abexa.htm"
keywords: ["select", "loop", "do", "try", "catch", "method", "class", "data", "field-symbol", "abencreate", "structured", "abexa"]
---
...
Creation of a work area that matches any database table and reads the first few rows (rows) of the database table into this work area using a [SELECT](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapselect.htm) loop. Since the data reference dref is typed dynamically, the work area can only be accessed using the field symbol <wa>.
...
See also the [executable example](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenselect_into_new_wa_abexa.htm) for SELECT INTO NEW, where the structure is created implicitly in the INTO clause.