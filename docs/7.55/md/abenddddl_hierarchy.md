...
[Hierarchy columns](javascript:call_link\('abenhierarchy_column_glosry.htm'\) "Glossary Entry") are additional components of the result set when the following data sources are accessed in a ABAP SQL query:
