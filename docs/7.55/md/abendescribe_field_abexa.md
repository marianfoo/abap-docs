...
The [RTTS](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenrtti.htm) methods can be used to check complex data types and object types at runtime.