...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenextract_at_abexa.htm"
...
This example continues the example given under [EXTRACT](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abapextract.htm). After the extract dataset is filled, it is sorted by field group header and, afterwards, group level processing is executed in a LOOP. Here, structured output is created.