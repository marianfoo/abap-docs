...
As in the executable example [Creating Nodes](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenixml_crea_elem_abexa.htm), but using the method CREATE\_SIMPLE\_ELEMENT\_NS to create elements with content and insert them.