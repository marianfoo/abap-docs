...
-   For internal tables, such an exception is uncatchable and always results in a [runtime error](javascript:call_link\('abenruntime_error_glosry.htm'\) "Glossary Entry"). There are different runtime errors for different situations.
