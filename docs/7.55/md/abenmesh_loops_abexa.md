...
The result set consists of all lines of the node sairport that match the column airpfrom in the result set of the source node spfli. Duplicate lines are removed automatically.
