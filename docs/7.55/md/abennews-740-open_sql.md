...
-   Columns of the types LCHR and LRAW cannot be used in [relational expressions](javascript:call_link\('abenosql_stmt_logexp.htm'\)) of the [SQL conditions](javascript:call_link\('abenosql_stmt_logexp.htm'\)). Before Release 7.40 SP02, this produced a runtime error. From Release 7.40 SP02, this also produces a syntax error if known statically.
    Example
    From Release 7.40 SP02, syntax errors for:
    SELECT SINGLE \*
           FROM  indx
