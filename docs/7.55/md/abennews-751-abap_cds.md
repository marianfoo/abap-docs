...
-   In a [path expression](javascript:call_link\('abencds_path_expression_v1.htm'\)), [\*:](javascript:call_link\('abencds_path_expr_card_v1.htm'\)) can be used to declared an association as a polyvalent association explicitly.
