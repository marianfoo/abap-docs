...
The following new [built-in data types](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenddic_builtin_types_intro.htm) were introduced in ABAP Dictionary:
...
-   [Date fields, time fields, and time stamp fields](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenddic_date_time_types.htm)
