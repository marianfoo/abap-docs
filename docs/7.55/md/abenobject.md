...
In addition to the regular references, there are [weak references](javascript:call_link\('abencl_abap_weak_reference.htm'\)) represented by objects exist that do not keep an object alive.
