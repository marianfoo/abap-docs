...
description: |
  Functions(https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenfunction_glosry.htm 'Glossary Entry') and expressions(https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenexpression_glosry.htm 'Glossary Entry') can be listed in certain read positions(https://help.sap.com/doc
version: "7.55"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenoperands_expressions.htm"
