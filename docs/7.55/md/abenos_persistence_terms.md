...
description: |
  Transient and Persistent Data ABAP programs work with local program data, which resides in the internal session(https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abeninternal_session_glosry.htm 'Glossary Entry') of the program. Such data only survives as long as its context(https://help
version: "7.55"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenos_persistence_terms.htm"
