...
The first regular expression has valid [POSIX syntax](javascript:call_link\('abenregex_posix_syntax.htm'\)) but not valid [PCRE syntax](javascript:call_link\('abenregex_pcre_syntax.htm'\)).