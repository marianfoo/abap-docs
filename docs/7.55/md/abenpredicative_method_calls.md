...
-   For other expressions or data objects, the full predicate expression [IS INITIAL](javascript:call_link\('abenlogexp_initial.htm'\)) or a comparison must be used to check the initial value but this is no recommended for many expressions anyway.
