...
category: "ui"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abensel_screen_button_abexa.htm"
...
"CLI1", "CLI2", "CLI3", and "CLI4" are used for fcode. If the user chooses a pushbutton, the runtime environment raises the AT SELECTION-SCREEN event. The program is resumed after CALL SELECTION-SCREEN only if the user chooses Execute.