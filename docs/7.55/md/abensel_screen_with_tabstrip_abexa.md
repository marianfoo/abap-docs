...
category: "ui"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abensel_screen_with_tabstrip_abexa.htm"
...
Before the subscreen screen is displayed, the PBO module init\_0100 is executed. User actions on the subscreen screen raise the PAI module. This includes when the user chooses a tab title. After that, the AT SELECTION-SCREEN event is raised.
