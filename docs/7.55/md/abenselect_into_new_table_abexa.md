...
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenselect_into_new_table_abexa.htm"
...
See also the [executable example](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abencreate_tabular_data_abexa.htm) for CREATE DATA with explicit creation of the internal table.