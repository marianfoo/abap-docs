...
description: |
  Area instance versions can have the following states. 1.  'Under Construction' An area instance version that has a change lock(https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenshm_area_instance_locks.htm) is being built. Change locks automatically create a version under construction.
version: "7.55"
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenshm_area_instance_state.htm"
