...
DATN\_DAYS\_BETWEEN enforces [strict mode from Release 7.55](javascript:call_link\('abenopensql_strict_mode_755.htm'\)).
...
DATN\_ADD\_DAYS enforces [strict mode from Release 7.55](javascript:call_link\('abenopensql_strict_mode_755.htm'\)).
...
DATN\_ADD\_MONTHS enforces [strict mode from Release 7.55](javascript:call_link\('abenopensql_strict_mode_755.htm'\)).
