...
-   Use of the functions described in Variants 1 to 4 enforces the [strict mode from Release 7.53](javascript:call_link\('abenopensql_strict_mode_753.htm'\)).

-   Use of the functions described in Variants 5 to 10 enforces the [strict mode from Release 7.55](javascript:call_link\('abenopensql_strict_mode_755.htm'\)).
