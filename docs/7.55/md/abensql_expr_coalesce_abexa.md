...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abensql_expr_coalesce_abexa.htm"
...
This example is an excerpt from the executable example for [joins](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenjoins_abexa.htm). Here, the function [COALESCE](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abensql_coalesce.htm) is used to replace null values produced by an outer join with a different value.