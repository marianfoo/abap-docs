...
title: "SQL injection"
description: |
  Injection of malicious SQL(https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abensql_glosry.htm 'Glossary Entry') statements by an attacker. SQL injections are possible whenever programs use external statements or parts of statements that are then are transferred to the database system(
version: "7.55"
category: "database"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abensql_injection_glosry.htm"
