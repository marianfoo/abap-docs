...
description: |
  In all ST statements in which the name of a node can be specified, the current node(https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenst_tt_ref.htm) can be addressed explicitly with $ref. An alias name can be also be defined for $ref in tt:loop loops(https://help.sap.com/doc/abapdoc
version: "7.55"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenst_addressing_current_node.htm"
...
In all ST statements in which the name of a node can be specified, the [current node](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenst_tt_ref.htm) can be addressed explicitly with $ref. An alias name can be also be defined for $ref in [tt:loop loops](https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenst_tt_loop.htm) where internal tables are transformed. If specification of the node is optional, ST statements use the current node by default.
