...
title: "Syntax"
description: |
  <tt:namespace name='prefix'/> Effect The ST statement tt.namespace declares an explicit namespace. By default in serializations, namespace declarations are written to the resulting XML data only if the relevant namespace prefix is used as part of the name in a literal XML element or attribute or in
version: "7.55"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenst_tt_namespace.htm"
