...
title: "Syntax"
description: |
  <tt:serialize> ... </tt:serialize> <tt:deserialize> ... </tt:deserialize> Effect These ST statements can be used to limit parts of templates for execution in serializations or deserializations: All the template elements specified within the tt:serialize element are only respected in serializations.
version: "7.55"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenst_tt_serialize_deserialize.htm"
