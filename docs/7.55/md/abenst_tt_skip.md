...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenst_tt_skip.htm"
...
-   Without additions, the following XML content of the inbound stream is consumed up to the end of the current element or non-literal attribute, but no other ST statements are executed.
