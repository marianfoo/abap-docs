...
description: |
  Attributes are the data objects of a class. It is also possible to declare data types that are specific to the class. Attributes and data types are declared using one of the following: -   General statements that are also possible in other contexts -   TYPES(https://help.sap.com/doc/abapdocu_755_i
version: "7.55"
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abentypes_attributes.htm"
