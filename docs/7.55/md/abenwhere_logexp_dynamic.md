...
title: "Syntax"
description: |
  ... (cond_syntax) ... Effect A relational expression can be specified dynamically as a parenthesized data object cond_syntax that contains the syntax of a logical expression sql_cond(https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenasql_cond.htm) valid here or is initial when the
version: "7.55"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_755_index_htm/7.55/en-US/abenwhere_logexp_dynamic.htm"
