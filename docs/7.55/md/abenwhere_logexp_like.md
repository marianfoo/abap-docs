...
-   [Literals](javascript:call_link\('abenabap_sql_literals.htm'\)) and [host variables](javascript:call_link\('abenopen_sql_host_variables.htm'\)) can be specified.
