...
Possible [clauses and additions](javascript:call_link\('abenselect_clauses.htm'\)) of a [subquery](javascript:call_link\('abensubquery_glosry.htm'\) "Glossary Entry") in a condition [sql\_cond](javascript:call_link\('abenosql_stmt_logexp.htm'\)) in ABAP SQL.
