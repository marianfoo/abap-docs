...
description: |
  -   Class for Trailing Blanks(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenstring_util.htm) -   Class for Compressing Character Strings and Byte Strings(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abencl_abap_gzip.htm) -   Class with Utilities for String Process
version: "7.56"
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abencl_abap_string_utilities.htm"
...
-   [Class for Trailing Blanks](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenstring_util.htm)
-   [Class for Compressing Character Strings and Byte Strings](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abencl_abap_gzip.htm)
-   [Class with Utilities for String Processing](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abencl_abap_char_utilities.htm)
-   [Methods for Handling Code Pages](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abencl_abap_conv_codepage.htm)
...
description: |
  The class CL_ABAP_STRING_UTILITIES contains methods for processing text strings(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abentext_string_glosry.htm 'Glossary Entry'). -   C2STR_PRESERVING_BLANKS assigns text fields while preserving the trailing blanks. -   DEL_TRAILING_BLA
version: "7.56"
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenstring_util.htm"
...
The class CL\_ABAP\_STRING\_UTILITIES contains methods for processing [text strings](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abentext_string_glosry.htm "Glossary Entry").
...
The program compares the method C2STR\_PRESERVING\_BLANKS with the built-in function [shift\_right](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenshift_functions.htm). The implementation of the method now consists of nothing more than this function.
...
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abencl_abap_gzip.htm"
...
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abencl_abap_char_utilities.htm"
...
The following lines demonstrate that attributes of the class CL\_ABAP\_CHAR\_UTILITIES containing control characters can be replaced by a representation of the [control characters](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenstring_templates_separators.htm) in a [string template](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenstring_template_glosry.htm "Glossary Entry") .
...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abencl_abap_conv_codepage.htm"
