...
description: |
  The ABAP program directives(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenprogram_directive_glosry.htm 'Glossary Entry') allow source-code-based development objects to be documented or affect the check results of various check tools. -   ABAP Doc(https://help.sap.com/doc/abapdoc
version: "7.56"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenprogram_directives.htm"
abapFile: "abenprogram_directives.htm"
keywords: ["do", "try", "abenprogram", "directives"]
---
...
The ABAP [program directives](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenprogram_directive_glosry.htm "Glossary Entry") allow source-code-based development objects to be documented or affect the check results of various check tools.

-   [ABAP Doc](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abendoccomment.htm)
-   [Pragmas](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenpragma.htm)
-   [Pseudo Comments](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenpseudo_comment.htm)
...
title: "Pragmas"
description: |
  Pragmas are program directives(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenprogram_directive_glosry.htm 'Glossary Entry') that can be used to hide warnings from various check tools. The following are supported: -   Warnings from the ABAP Compiler syntax check(https://help.sap.
version: "7.56"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenpragma.htm"
...
Pragmas are [program directives](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenprogram_directive_glosry.htm "Glossary Entry") that can be used to hide warnings from various check tools. The following are supported:

-   Warnings from the ABAP Compiler [syntax check](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abensyntax_check_glosry.htm "Glossary Entry")
-   Warnings from the [extended program check](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenextended_program_check_glosry.htm "Glossary Entry")

For more information, see:

-   [Positioning of Pragmas in ABAP Source Code](#@@ITOC@@ABENPRAGMA_1)
...
-   The existence of a pragma for a system check warning can be checked using the long text of the message, which in this case always exists. The description of a message in the extended program check is also specified the pragma that can be used to hide it.
-   Pragmas replace the previously used [pseudo comments](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenpseudo_comment_slin.htm) to hide warnings from the extended program check. These pseudo comments are therefore obsolete and should no longer be used. The program ABAP\_SLIN\_PRAGMAS shows which pragmas are to be used instead of the obsolete pseudo comments.
-   In a program that uses pragmas to deactivate warnings, the statement [SET EXTENDED CHECK](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapset_extended_check.htm) and the [pseudo comment](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenpseudo_comment_slin.htm) #EC \* can no longer be used and produce an extended program check warning that cannot be deactivated.
-   A pragma in a type definition made using [TYPES](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abaptypes.htm),for example, to hide the warning for redundant secondary keys of table types, can also be applied to data declarations using [DATA](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapdata.htm) in the case of non-generic types and related statements that reference the data type using [TYPE](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapdata_referring.htm). If a reference is made to a generic data type defined using TYPES, that is, a table type for which no primary table key is defined, a pragma specified there is not applied to the data declaration, since it uses a full table type implicitly and the pragma must potentially be specified again.
...
In some executable examples for key accesses to internal tables ([read](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenread_itab_using_key_abexa.htm), [delete](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abendelete_itab_using_key_abexa.htm)), syntax warnings are hidden by the associated pragma. The pragmas were found in the long text of the syntax warnings.
...
description: |
  Pseudo comments are program directives(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenprogram_directive_glosry.htm 'Glossary Entry') for managing checks and test runs. Pseudo comments have mostly become obsolete(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenpseud
version: "7.56"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenpseudo_comment.htm"
...
Pseudo comments are [program directives](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenprogram_directive_glosry.htm "Glossary Entry") for managing checks and test runs. Pseudo comments have mostly become [obsolete](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenpseudo_comments_obsolete.htm) and have been replaced by [pragmas](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenpragma.htm) or real additions.

Non-Obsolete Pseudo Comments

-   [Pseudo Comments for Code Inspector](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenpseudo_comment_ci.htm)
