...
The names are compared, as in the statement [MOVE-CORRESPONDING](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapmove-corresponding.htm). For each identically named component pair comp, the statement

-   [ADD](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapadd.htm) struc1-comp TO struc2-comp.
-   [SUBTRACT](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapadd.htm) struc1-comp FROM struc2-comp.
-   [MULTIPLY](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapadd.htm) struc1-comp BY struc2-comp.
-   [DIVIDE](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapadd.htm) struc1-comp BY struc2-comp.
