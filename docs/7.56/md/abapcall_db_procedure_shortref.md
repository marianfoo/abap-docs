...
[Reference](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapcall_database_procedure.htm)
...
Calls a database procedure of [SAP HANA database](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenhana_database_glosry.htm "Glossary Entry") written in [SQLScript](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abensql_script_glosry.htm "Glossary Entry") using a database proxy proxy.

Additions

-   [CONNECTION con*|*(con\_syntax)](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapcall_database_procedure.htm)
...
-   [EXPORTING p1 FROM a1 p2 FROM a2 ...](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapcall_db_proc_parameters.htm)
    Passes actual parameters a1, a2, ... to input parameters p1, p2, ...
-   [IMPORTING p1 TO a1 p2 TO a2 ...](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapcall_db_proc_parameters.htm)
    Inherits output parameters p1, p2, ... in actual parameters a1, a2, ...
-   [PARAMETER-TABLE ptab](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapcall_db_proc_parameter_tables.htm)
