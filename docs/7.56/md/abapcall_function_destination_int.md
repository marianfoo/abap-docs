...
description: |
  This addition is for internal use only. It must not be used in application programs. Addition: ... KEEPING LOGICAL UNIT OF WORK Effect This addition has the effect that the work process(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenwork_process_glosry.htm 'Glossary Entry') of the
version: "7.56"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapcall_function_destination_int.htm"
