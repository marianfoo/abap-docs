...
To delete multiple lines, at least one of the additions FROM, TO, or WHERE must be specified. USING KEY [keyname](javascript:call_link\('abenkeyname.htm'\)) is used to determine the table key to which the additions refer.
