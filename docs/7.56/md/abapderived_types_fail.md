...
%fail is a component of [BDEF derived types](javascript:call_link\('abenrap_derived_type_glosry.htm'\) "Glossary Entry"). It is used as a component of the [failed](javascript:call_link\('abaptype_response_for.htm'\)) response parameter.
