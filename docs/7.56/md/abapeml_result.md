...
-   A [MODIFY](javascript:call_link\('abapmodify_entity_entities.htm'\)) operation executing an action
...
[READ](javascript:call_link\('abapread_entity_entities.htm'\)) operations (excluding functions)
