...
title: "END-TEST-SEAM"
description: |
  Short Reference(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abaptest-seam_shortref.htm) Syntax END-TEST-SEAM. Effect The statement END-TEST-SEAM closes a test seam introduced using TEST-SEAM(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abaptest-seam.htm).
version: "7.56"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapend-test-seam.htm"
...
The statement END-TEST-SEAM closes a test seam introduced using [TEST-SEAM](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abaptest-seam.htm).