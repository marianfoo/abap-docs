...
description: |
  Short Reference(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapfind_shortref.htm) Syntax ... RESPECTINGIGNORING CASE MATCH COUNT  mcnt  MATCH LINE   mlin MATCH OFFSET moff MATCH LENGTH mlen  RESULTS result_tabresu
version: "7.56"
category: "data-structures"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapfind_itab_options.htm"
...
The addition MATCH LINE returns the number of the line in which the last substring was found using [FIND IN TABLE](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapfind_itab.htm) in data object mlin. The following can be specified for mlin:
...
The remaining additions used for searching in the individual table lines have the same [meaning](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapfind_options.htm) as in the statement [FIND](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapfind.htm) for elementary character strings and byte strings.
