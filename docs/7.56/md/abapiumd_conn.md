...
description: |
  Syntax ... CONNECTION con(con_syntax) ... Effect The ABAP SQL statement is executed on the specified database connection(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abendatabase_connection_glosry.htm 'Glossary Entry'). The database connection can be specified as follows: -   con
version: "7.56"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapiumd_conn.htm"
