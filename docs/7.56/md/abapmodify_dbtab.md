...
MODIFY [target](javascript:call_link\('abapiumd_target.htm'\)) *\[* [connection](javascript:call_link\('abapiumd_conn.htm'\))*\]* FROM [source](javascript:call_link\('abapmodify_source.htm'\)).
