...
The short form of the MODIFY statement is used to perform transactional modify [operations](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapmodify_entity_entities_op.htm) for a single RAP BO node.
