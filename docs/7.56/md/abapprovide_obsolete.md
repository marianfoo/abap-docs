...
The columns for interval limits to be specified in the [long form](javascript:call_link\('abapprovide.htm'\)) as intlim1 and intlim2 using the addition BOUNDS are attributes of the relevant tables in the short form and must be specified when they are declared.
