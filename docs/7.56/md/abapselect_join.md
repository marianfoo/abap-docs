...
-   The syntax check is performed in [strict mode for Release 7.40, SP05](javascript:call_link\('abenabap_sql_strictmode_740_sp05.htm'\)) in the following cases:
...
-   The syntax check is performed in [strict mode for Release 7.40, SP08](javascript:call_link\('abenabap_sql_strictmode_740_sp08.htm'\)) in the following cases:
...
-   For more information, see the documentation of the current database system. The [SAP HANA database](javascript:call_link\('abenhana_database_glosry.htm'\) "Glossary Entry"), for example, supports the addition MANY TO ONE and its description is part of the documentation of [HANA-specific SQL](https://help.sap.com/viewer/4fe29514fd584807ac9f2a04f6754767/2.0.04/en-US/b4b0eec1968f41a099c828a4a6c8ca0f.html).
