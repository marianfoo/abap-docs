...
title: "SUM"
description: |
  Short Reference(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapsum_shortref.htm) Syntax SUM. Effect The statement SUM can only be specified within a loop LOOP(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abaploop_at_itab.htm) and is only respected within a AT-ENDA
version: "7.56"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapsum.htm"
...
The statement SUM can only be specified within a loop [LOOP](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abaploop_at_itab.htm) and is only respected within a [AT\-ENDAT](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapat_itab.htm) control structure. Prerequisites for using the statement SUM are that the addition INTO is used in the LOOP statement, and that the specified work area wa is [compatible](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abencompatible_glosry.htm "Glossary Entry") with the line type of the internal table. Furthermore, SUM cannot be used when the line type of the internal table itab contains components that are tables themselves.
...
[Group Level Processing with Totals](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenint_table_sum_abexa.htm)
