...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapsystem-call.htm"
...
[kernel methods](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenkernel_methods.htm) should be used instead of SYSTEM-CALL whenever possible.

Syntax Forms

[Saves addresses and sets field symbols](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapsystem-call_pointer.htm)
\- SYSTEM-CALL POINTER <f> TO   ptr.
\- SYSTEM-CALL POINTER <f> FROM ptr.

[Edits internal tables](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapsystem-call_itab.htm)
...
[Method management for the ABAP class library](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapsystem-call_class_admin.htm)
...
[Object manager calls](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapsystem-call_oo.htm)
...
[RTTI calls](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapsystem-call_rtti.htm)
...
[CHECK calls](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapsystem-call_check.htm)
...
[Nametab management](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapsystem-call_nametab.htm)
\- EXPORT NAMETAB h f ID id.
\- IMPORT NAMETAB h f ID id.

[Conversions](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapsystem-call_convert.htm)
...
[Memory use of complex data structures](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapsystem-call_memory.htm)
...
\- GET\_STRING\_BY\_ [GUID](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenguid_glosry.htm "Glossary Entry") LANGUAGE l ID id TEXT t
