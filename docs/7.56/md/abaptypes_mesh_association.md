...
The mesh associations are type-only attributes and also affect the compatibility of mesh types. Mesh associations are evaluated in [mesh paths](javascript:call_link\('abenmesh_pathes.htm'\)) in expressions and in statements for meshes.
