...
title: "Hints"
description: |
  -   Writes to the DOM must be avoided during sequential parsing(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenabap_ixml_lib_parse_event.htm), since this can produce undefined behavior. -   iXML documents can also be specified as an XML target for XSL transformations called using
version: "7.56"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenabap_ixml_lib_dom_access_write.htm"
