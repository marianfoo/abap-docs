...
description: |
  Simple Transformations (ST) is an SAP programming language for describing transformations between ABAP data and XML(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenxml_glosry.htm 'Glossary Entry') formats. ST is restricted to the two modes of serialization(https://help.sap.com/doc
version: "7.56"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenabap_st.htm"
abapFile: "abenabap_st.htm"
keywords: ["do", "case", "try", "method", "data", "internal-table", "abenabap"]
---
