...
description: |
  This example demonstrates the suppression of AMC(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenamc_glosry.htm 'Glossary Entry') messages to the current ABAP session. Source Code REPORT demo_amc_suppress_echo. CLASS message_receiver DEFINITION. PUBLIC SECTION. INTERFACES: if_a
version: "7.56"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenamc_suppress_echo_abexa.htm"
