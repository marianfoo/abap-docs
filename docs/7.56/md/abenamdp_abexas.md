...
![Example](exa.gif "Example") [AMDP - SQLScript with Tabular CHANGING Parameter](javascript:call_link\('abenamdp_changing_abexa.htm'\))
...
![Example](exa.gif "Example") [AMDP - Comparison of SQLScript with ABAP SQL](javascript:call_link\('abenamdp_vs_abap_sql_abexa.htm'\))
