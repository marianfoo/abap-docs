...
-   An error message can be written into the [reported](javascript:call_link\('abapeml_response.htm'\)) structure of the [MODIFY ENTITIES](javascript:call_link\('abapmodify_entity_entities.htm'\)) statement.
