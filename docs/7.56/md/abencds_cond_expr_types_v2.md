...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abencds_cond_expr_types_v2.htm"
...
The following table shows the possible combinations of data source fields on the left side (lhs) with literals on the right side (rhs) of comparisons. The literals can be [typed](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abencds_typed_literal_v2.htm) or [untyped](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abencds_untyped_literal_v2.htm). It is recommended to only use typed literals, because they offer more data types. With typed literals, the data types shown in the table are possible.
