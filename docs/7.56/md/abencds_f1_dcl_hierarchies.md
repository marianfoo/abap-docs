...
description: |
  CDS hierarchies(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abencds_hierarchy_glosry.htm 'Glossary Entry') can be protected using access control. It must be guaranteed, however, that individual rows are not filtered out if they are part of a logical block in the hierarchy constructi
version: "7.56"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abencds_f1_dcl_hierarchies.htm"
...
-   Conditions under exclusive use of [left side host expressions](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abencds_dcl_cond_left_side.htm). This enables protection for a CDS hierarchy using the hierarchy directory specified by a parameter.
