...
description: |
  This example demonstrates how to read fields via exposed associations in a CDS projection view(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abencds_projection_view_glosry.htm 'Glossary Entry'). CDS projection view @AccessControl.authorizationCheck: #NOT_REQUIRED @EndUserText.label:
version: "7.56"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abencds_proj_view_assoc_abexa.htm"
