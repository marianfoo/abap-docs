...
description: |
  This example demonstrates how a virtual element(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abencds_virtual_element_glosry.htm 'Glossary Entry') is calculated at runtime. Source Code REPORT demo_consume_bs_proj_view_virt. CLASS demo DEFINITION. PUBLIC SECTION. CLASS-METHODS mai
version: "7.56"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abencds_proj_view_virtel_abexa.htm"
