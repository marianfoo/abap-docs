...
-   [reuse\_exp](javascript:call_link\('abencds_reusable_expression_v2.htm'\)) allows to reuse an expression defined in the SELECT list in another operand position of the same CDS view entity. An alternative element name specified using AS is required.
