...
Transportable extension of a [CDS DDIC-based view](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abencds_v1_view_glosry.htm "Glossary Entry"). A CDS view extension can be used to add elements and/or clauses to a view without making any modifications to the original view. It is defined using the statement EXTEND VIEW.
...
[→ More about](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abencds_extend_view.htm)