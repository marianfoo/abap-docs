...
description: |
  Events are declared using the following statements: -   EVENTS(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapevents.htm) -   CLASS-EVENTS(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapclass-events.htm) These statements are only possible in the declaration part o
version: "7.56"
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenevents.htm"
