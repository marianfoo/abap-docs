...
This example demonstrates simple group level processing using [GROUP BY](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenfor_groups_of.htm) in a FOR expression.
