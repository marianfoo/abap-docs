...
description: |
  The data aging concept makes it possible to distinguish between current ('HOT') data and outdated ('COLD') data within SAP HANA database(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenhana_database_glosry.htm 'Glossary Entry') tables. Application programming defines which data is c
version: "7.56"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenhana_data_aging.htm"
