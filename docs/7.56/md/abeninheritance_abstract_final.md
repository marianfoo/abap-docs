...
description: |
  Abstract and final methods or classes can be defined using the additions ABSTRACT and FINAL of the statements METHODS(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapmethods.htm) and CLASS(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapclass.htm). Abstract methods
version: "7.56"
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abeninheritance_abstract_final.htm"
