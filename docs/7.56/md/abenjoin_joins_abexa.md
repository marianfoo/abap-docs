...
description: |
  This example demonstrates chaining and parenthesizing of multiple joins(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapselect_join.htm) in the SELECT statement. Source Code REPORT demo_join_joins. CLASS demo DEFINITION. PUBLIC SECTION. CLASS-METHODS: class_constructor, main. PRI
version: "7.56"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenjoin_joins_abexa.htm"
