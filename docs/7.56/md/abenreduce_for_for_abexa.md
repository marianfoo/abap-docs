...
This example demonstrates a [reduction](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenconstructor_expression_reduce.htm) of the columns of a nested internal table to a text string.
