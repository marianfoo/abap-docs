...
description: |
  The following tables summarize the special characters in PCRE regular expressions(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenpcre_regex_glosry.htm 'Glossary Entry'). -   Pattern Syntax(#abenregex-pcre-syntax-specials-1-----------quoting---@ITOC@@ABENREGEX_PCRE_SYNTAX_SPECIALS
version: "7.56"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenregex_pcre_syntax_specials.htm"
