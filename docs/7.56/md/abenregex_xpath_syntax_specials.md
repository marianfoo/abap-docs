...
description: |
  The following tables summarize the special characters in XPath regular expressions(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenxpath_regex_glosry.htm 'Glossary Entry'). -   Pattern Syntax(#abenregex-xpath-syntax-specials-1-----------single-character-escapes---@ITOC@@ABENREGEX_
version: "7.56"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenregex_xpath_syntax_specials.htm"
...
When enabling the RELAXED\_ESCAPES option while constructing an XPath regular expression using [CL\_ABAP\_REGEX=>CREATE\_XPATH2](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenregex_system_classes.htm), a character sequence \\x that does not appear in the table above or has no other special meaning will match a literal x. Otherwise, if the RELAXED\_ESCAPES option was disabled, a character sequence \\x will raise an exception.
...
The syntax of replacement patterns for XPath regular expressions is the same as for [PCRE regular expressions](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenregex_pcre_syntax_specials.htm).