...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenrfc_intro.htm"
...
-   [Synchronous RFC (sRFC)](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abensynchronous_rfc_glosry.htm "Glossary Entry")
-   [Asynchronous RFC (aRFC)](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenasynchronous_rfc_glosry.htm "Glossary Entry")
-   [Parallel RFC (pRFC)](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenparalel_remote_function_glosry.htm "Glossary Entry")
-   [Background RFC (bgRFC)](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenbg_remote_function_glosry.htm "Glossary Entry")
-   [Transactional RFC (tRFC), obsolete](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abentrfc_1_glosry.htm "Glossary Entry")
-   [Queued RFC (qRFC), obsolete](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenqueued_remote_function_glosry.htm "Glossary Entry")
