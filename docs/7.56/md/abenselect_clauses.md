...
This section describes the clauses and additions possible for the SELECT statements of [main queries](javascript:call_link\('abenmainquery_glosry.htm'\) "Glossary Entry") and [subqueries](javascript:call_link\('abensubquery_glosry.htm'\) "Glossary Entry"). Information on which clauses are possible in which queries can be found in the relevant statements and clauses.
...
-   [FOR ALL ENTRIES](javascript:call_link\('abenwhere_all_entries.htm'\))
...
[SELECT, FOR ALL ENTRIES](javascript:call_link\('abenwhere_all_entries.htm'\))
