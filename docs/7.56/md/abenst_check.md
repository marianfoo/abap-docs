...
description: |
  Syntax ... s-d-check ='...' ... Effect The following conditions can be specified for the content of the attribute s-d-check of an element tt:cond(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenst_tt_cond.htm) or tt:cond-var(https://help.sap.com/doc/abapdocu_
version: "7.56"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenst_check.htm"
...
The following conditions can be specified for the content of the attribute *\[*s-*|*d-*\]*check of an element [tt:cond](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenst_tt_cond.htm) or [tt:cond-var](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenst_tt_cond-var.htm):
...
Data nodes cannot be specified as operands if check is specified as an attribute of [tt:cond-var](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenst_tt_cond-var.htm).
...
Negation, Combination, Parentheses
