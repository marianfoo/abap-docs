...
description: |
  In ST programs, data can be declared using the following statements: -   tt:root(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenst_tt_root.htm) defines data roots for binding ABAP data interfaces. -   tt:parameter(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenst_
version: "7.56"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenst_data_declarations.htm"
