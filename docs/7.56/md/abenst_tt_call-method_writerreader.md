...
title: "Syntax"
description: |
  <tt:call-method class='class'var='oref' s-d-name='meth' ... writer='p_writer' reader='p_reader'> ... </tt:call-method> Effect In the statistic method(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenst_tt_call-method_static.htm) or instance method(https://help.sap.c
version: "7.56"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenst_tt_call-method_writerreader.htm"
...
In the [statistic method](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenst_tt_call-method_static.htm) or [instance method](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenst_tt_call-method_instance.htm) called from an ST program, the attributes writer and reader can be used to access the current XML stream where the serialization or deserialization is currently taking place.
