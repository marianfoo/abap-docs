...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenst_xml_literals.htm"
...
Here, element is the name of the element and attr is a set of optional literal attributes with any name. The optional ST-specific attribute [tt:ref](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenst_tt_ref.htm) sets the current node node for the context of the literal element.

The optional ST-specific attributes [tt:lax](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenst_tt_lax.htm) and [tt:extensible](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenst_tt_extensible.htm) only have an effect during deserialization. tt:lax determines whether the element name element may differ during deserialization. tt:extensible specifies whether the content of the element can be extended by unspecified elements.
...
For information about handling namespaces, see [tt.namespace, Namespaces](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenst_tt_namespace.htm).
...
A special form of literal XML attributes combines the [tt:value statement](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenst_tt_value_elementary.htm) with the above syntax.
...
Continue
[ST - tt:lax, Name Comparisons of Literal XML Elements](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenst_tt_lax.htm)
[ST - tt:extensible, Extensibility of Literal XML Elements](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenst_tt_extensible.htm)