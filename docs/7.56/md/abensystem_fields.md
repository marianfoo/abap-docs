...
description: |
  System fields are filled by the ABAP runtime framework(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenabap_runtime_frmwk_glosry.htm 'Glossary Entry') and can be used in an ABAP program to query system states. With one exception (sy-repid), the system fields are variables, but they
version: "7.56"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abensystem_fields.htm"
...
X during daylight saving time in the system time zone; otherwise initial. See [System Fields for Date and Time](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abentime_system_fields.htm).
