...
description: |
  Storage where the data that is used during one RAP LUW(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenrap_luw_glosry.htm 'Glossary Entry') is kept. It includes the RAP BO instance(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenrap_bo_instance_glosry.htm 'Glossary
version: "7.56"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abentransactional_buffer_glosry.htm"
abapFile: "abentransactional_buffer_glosry.htm"
keywords: ["do", "try", "data", "abentransactional", "buffer", "glosry"]
---
