...
description: |
  The example demonstrates how the addition SET INDICATORS(https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapupdate_set_indicator.htm) of the statement UPDATE is used. Source Code REPORT demo_update_set_indicator. CLASS demo DEFINITION. PUBLIC SECTION. CLASS-METHODS main. ENDCLASS. C
version: "7.56"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenupdate_set_indicators_abexa.htm"
