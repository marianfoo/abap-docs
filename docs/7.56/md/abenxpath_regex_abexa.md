...
title: "Source Code"
description: |
  REPORT demo_xpath_regex. CLASS demo DEFINITION. PUBLIC SECTION. CLASS-METHODS main. ENDCLASS. CLASS demo IMPLEMENTATION. METHOD main. DATA(xml) = `<xml><Hello type='cheerful' lang='EN'></Hello>` && `<World text='world'><Ocean color='blue' /></World></xml>`. DATA(matcher) = cl_abap_regex=>cre
version: "7.56"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenxpath_regex_abexa.htm"
