# ABAP ERROR-HANDLING - Complete Reference (7.56)

**Generated**: 2025-09-01T11:14:57.820Z
**Bundles Combined**: 4
...
> **📖 Official SAP Documentation**: [abenabap_language_exceptions.htm](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenabap_language_exceptions.htm)
...
Error situations that occur during the execution of an ABAP statement raise exceptions. These exceptions are fully integrated into the [exception concept](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenabap_exceptions.htm) and are raised by the runtime framework. Two types of exception exist:

-   Catchable exceptions, which are based on [predefined](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenabap_exception_classes.htm) [exception classes](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenexception_class_glosry.htm "Glossary Entry").
-   Uncatchable exceptions, which directly produce [runtime errors](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenruntime_error_glosry.htm "Glossary Entry").
...
-   [TRY ... CATCH ...  ENDTRY](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abaptry.htm)
    
    This is the recommended way.
    
-   [CATCH SYSTEM-EXCEPTIONS ... ENDCATCH](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapcatch_sys.htm).
    
    This statement is obsolete. To use it, the runtime error assigned to the exception class must be [catchable](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abencatchable_runtime_error_glosry.htm "Glossary Entry") itself.
...
Since the runtime error COMPUTE\_INT\_ZERODIVIDE is catchable and assigned to the [exception group](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenexception_group_glosry.htm "Glossary Entry") ARITHMETIC\_ERRORS, it can also be handled using the obsolete statement [CATCH SYSTEM-EXCEPTIONS](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapcatch_sys.htm).
...
Continue
[Exception Classes for ABAP Statements](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenabap_exception_classes.htm)



**📖 Source**: [abenabap_language_exceptions.htm](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenabap_language_exceptions.htm)

### abenabap_exception_classes.htm

> **📖 Official SAP Documentation**: [abenabap_exception_classes.htm](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenabap_exception_classes.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
[ABAP - Keyword Documentation](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenabap.htm) →  [ABAP - Programming Language](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenabap_reference.htm) →  [Program Flow Logic](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenabap_flow_logic.htm) →  [Exception Handling](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenabap_exceptions.htm) →  [Exceptions in ABAP Statements](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenabap_language_exceptions.htm) → 

Exception Classes for ABAP Statements

The catchable [exceptions in ABAP statements](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenabap_language_exceptions.htm) can be caught using the predefined exception classes listed below, which are subclasses of the classes CX\_DYNAMIC\_CHECK and CX\_NO\_CHECK. These exception classes replace the obsolete [catchable runtime errors](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abencatchable_runtime_error_glosry.htm "Glossary Entry"). The keyword documentation lists the type of exceptions that can be raised for each statement.

When catching a superclass exception with [CATCH](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapcatch_try.htm), all of its subclass exceptions are also caught. To improve the structure, intermediate abstract classes were introduced so that groups of exceptions can be caught simultaneously.

Each exception class includes message texts, which can be found in the Texts tab in the [Class Builder](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenclass_builder_glosry.htm "Glossary Entry").
...
**📖 Source**: [abenabap_exception_classes.htm](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenabap_exception_classes.htm)

### abennoncat_exceptions.htm

> **📖 Official SAP Documentation**: [abennoncat_exceptions.htm](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abennoncat_exceptions.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abennoncat_exceptions.htm](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abennoncat_exceptions.htm)

### abapraise_shortdump.htm

> **📖 Official SAP Documentation**: [abapraise_shortdump.htm](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapraise_shortdump.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abapraise_shortdump.htm](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapraise_shortdump.htm)

### abapraise_shortdump_message.htm

> **📖 Official SAP Documentation**: [abapraise_shortdump_message.htm](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapraise_shortdump_message.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abapraise_shortdump_message.htm](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapraise_shortdump_message.htm)
...
The following is an alphabetical list of the obsolete catchable runtime errors. For each catchable runtime error, the associated [predefined exception class](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenabap_exception_classes.htm) used to handle the corresponding runtime error is specified. If an exception class is assigned to multiple catchable runtime errors, it may contain as many message texts as required, which can be found in the [Class Builder](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenclass_builder_glosry.htm "Glossary Entry") on the Texts tab.

Almost all the runtime errors listed here are grouped together in [exception groups](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenexception_group_glosry.htm "Glossary Entry"). These exception groups are also assigned those ABAP keywords for which the runtime errors can be caught.
...
Import error; a component of a structured type in the data set has incorrect [decimal places](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenfract_digit_glosry.htm "Glossary Entry")
...
Import error; a field type in the data set has incorrect [decimal places](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenfract_digit_glosry.htm "Glossary Entry")
...
Conversion of texts from [code page](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abencodepage_glosry.htm "Glossary Entry") to code page not supported
...
An attempt was made to call a [protected](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenprotected_glosry.htm "Glossary Entry") method externally.
...
The EXPORT [data cluster](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abendata_cluster_glosry.htm "Glossary Entry") is too big for the application buffer.
...
No further temporary [subroutine pools](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abensubroutine_pool_glosry.htm "Glossary Entry") can be generated.
...
Error in the configuration of the [text environment](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abentext_environment_glosry.htm "Glossary Entry") (SET LOCALE...)
...
[ABAP - Keyword Documentation](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenabap.htm) →  [ABAP - Programming Language](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenabap_reference.htm) →  [Obsolete Language Elements](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenabap_obsolete.htm) →  [Obsolete Program Flow](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenobsolete_program_flow.htm) →  [Obsolete Catchable Runtime Errors](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abensystem-exceptions.htm) →  [CATCH SYSTEM-EXCEPTIONS](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapcatch_sys.htm) → 
...
The statement ENDCATCH closes a control structure introduced by [CATCH SYSTEM-EXCEPTIONS](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abapcatch_sys.htm).
...
> **📖 Official SAP Documentation**: [abenerror_handling_gdl.htm](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenerror_handling_gdl.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abenerror_handling_gdl.htm](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenerror_handling_gdl.htm)

### abenreaction_error_guidl.htm

> **📖 Official SAP Documentation**: [abenreaction_error_guidl.htm](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenreaction_error_guidl.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abenreaction_error_guidl.htm](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenreaction_error_guidl.htm)

### abenclass_exception_guidl.htm

> **📖 Official SAP Documentation**: [abenclass_exception_guidl.htm](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenclass_exception_guidl.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abenclass_exception_guidl.htm](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenclass_exception_guidl.htm)

### abenexception_category_guidl.htm

> **📖 Official SAP Documentation**: [abenexception_category_guidl.htm](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenexception_category_guidl.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abenexception_category_guidl.htm](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenexception_category_guidl.htm)

### abenexception_texts_guidl.htm

> **📖 Official SAP Documentation**: [abenexception_texts_guidl.htm](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenexception_texts_guidl.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abenexception_texts_guidl.htm](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenexception_texts_guidl.htm)

### abenuse_exception_class_guidl.htm

> **📖 Official SAP Documentation**: [abenuse_exception_class_guidl.htm](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenuse_exception_class_guidl.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abenuse_exception_class_guidl.htm](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenuse_exception_class_guidl.htm)

### abenhandl_prop_except_guidl.htm

> **📖 Official SAP Documentation**: [abenhandl_prop_except_guidl.htm](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenhandl_prop_except_guidl.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abenhandl_prop_except_guidl.htm](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenhandl_prop_except_guidl.htm)

### abencleanup_guidl.htm

> **📖 Official SAP Documentation**: [abencleanup_guidl.htm](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abencleanup_guidl.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abencleanup_guidl.htm](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abencleanup_guidl.htm)

### abenassertions_guidl.htm

> **📖 Official SAP Documentation**: [abenassertions_guidl.htm](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenassertions_guidl.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abenassertions_guidl.htm](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenassertions_guidl.htm)

### abenmessages_guidl.htm

> **📖 Official SAP Documentation**: [abenmessages_guidl.htm](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenmessages_guidl.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.


**📖 Source**: [abenmessages_guidl.htm](https://help.sap.com/doc/abapdocu_756_index_htm/7.56/en-US/abenmessages_guidl.htm)
