...
- [abeninternationalization_gdl.htm](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abeninternationalization_gdl.htm)
- [abensystem_text_guidl.htm](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abensystem_text_guidl.htm)
- [abentrans_relevant_text_guidl.htm](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abentrans_relevant_text_guidl.htm)
- [abentext_environm_guidl.htm](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abentext_environm_guidl.htm)
- [abencharacter_set_guidl.htm](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abencharacter_set_guidl.htm)
- [abensplit_text_guidl.htm](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abensplit_text_guidl.htm)
- [abencodepage_file_guidl.htm](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abencodepage_file_guidl.htm)
...
> **📖 Official SAP Documentation**: [abeninternationalization_gdl.htm](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abeninternationalization_gdl.htm)
...
**📖 Source**: [abeninternationalization_gdl.htm](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abeninternationalization_gdl.htm)

### abensystem_text_guidl.htm

> **📖 Official SAP Documentation**: [abensystem_text_guidl.htm](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abensystem_text_guidl.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abensystem_text_guidl.htm](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abensystem_text_guidl.htm)

### abentrans_relevant_text_guidl.htm

> **📖 Official SAP Documentation**: [abentrans_relevant_text_guidl.htm](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abentrans_relevant_text_guidl.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abentrans_relevant_text_guidl.htm](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abentrans_relevant_text_guidl.htm)

### abentext_environm_guidl.htm

> **📖 Official SAP Documentation**: [abentext_environm_guidl.htm](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abentext_environm_guidl.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abentext_environm_guidl.htm](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abentext_environm_guidl.htm)

### abencharacter_set_guidl.htm

> **📖 Official SAP Documentation**: [abencharacter_set_guidl.htm](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abencharacter_set_guidl.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
Since the programs with the ABAP language version [Standard ABAP](javascript:call_link\('abenstandard_abap_glosry.htm'\) "Glossary Entry") are now the only possible programs, so names comply with the rule above automatically. Comments are supposed to be [written in English](javascript:call_link\('abencomment_langu_guidl.htm'\) "Guideline") anyway, which removes the need for any country-specific special characters.
...
**📖 Source**: [abencharacter_set_guidl.htm](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abencharacter_set_guidl.htm)

### abensplit_text_guidl.htm

> **📖 Official SAP Documentation**: [abensplit_text_guidl.htm](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abensplit_text_guidl.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abensplit_text_guidl.htm](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abensplit_text_guidl.htm)

### abencodepage_file_guidl.htm

> **📖 Official SAP Documentation**: [abencodepage_file_guidl.htm](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abencodepage_file_guidl.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.


**📖 Source**: [abencodepage_file_guidl.htm](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abencodepage_file_guidl.htm)
