...
Appending of an initial line that simultaneously is linked to a field symbol using the addition [ASSIGNING](javascript:call_link\('abapappend_result.htm'\)). This means that initial lines can be processed directly.
