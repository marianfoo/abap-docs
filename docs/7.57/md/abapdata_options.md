...
A class attribute defined using READ-ONLY can be used outside of the class, its friends, and subclasses only in [reading](javascript:call_link\('abenread_position_glosry.htm'\) "Glossary Entry") positions in ABAP statements.
