...
title: "Type"
description: |
  The subcomponents of %foreign are internal tables of type TYPE TABLE FOR REPORTED LATE(https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abaptype_table_for.htm). Where used -   TYPE RESPONSE FOR REPORTED LATE(https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abaptype_response_f
version: "7.57"
category: "types"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abapderived_types_foreign.htm"
abapFile: "abapderived_types_foreign.htm"
keywords: ["insert", "loop", "do", "if", "try", "method", "class", "types", "internal-table", "abapderived", "foreign"]
---
...
%foreign is a [component group](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abencomponent_group_glosry.htm "Glossary Entry") in [BDEF derived types](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenrap_derived_type_glosry.htm "Glossary Entry"). The component group is contained in the [reported](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abaptype_response_for.htm) response parameter in the context of the [map\_messages](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abensaver_map_messages.htm) saver method and summarizes all available [foreign entities](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenrap_foreign_entity_glosry.htm "Glossary Entry") defined in the [BDEF](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abencds_behavior_definition_glosry.htm "Glossary Entry").

Type

The subcomponents of %foreign are internal tables of type [TYPE TABLE FOR REPORTED LATE](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abaptype_table_for.htm).

Where used

-   [TYPE RESPONSE FOR REPORTED LATE](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abaptype_response_for.htm)
...
The example [Example for RAP Saver Method map\_messages](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenabp_map_messages_abexa.htm) demonstrates the use of %foreign in the context of the implementation of a map\_messages saver method within a RAP saver class using unmanaged RAP BOs.