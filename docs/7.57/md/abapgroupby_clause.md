...
-   The expressions cannot contain any [host variables](javascript:call_link\('abenabap_sql_host_variables.htm'\)) or ABAP literals as operands, with the exception of statically known constants or literals with the data type i or with a flat character-like type.
