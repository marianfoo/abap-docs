...
The read operation considers input parameters specified in an internal table ([fields\_tab](javascript:call_link\('abapeml_fields_tab.htm'\))). It can be used for all operations.

The [%control](javascript:call_link\('abapderived_types_comp.htm'\)) structure must be filled explicitly in fields\_tab.
