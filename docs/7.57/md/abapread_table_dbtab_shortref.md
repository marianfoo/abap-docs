...
description: |
  Reference(https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abapread_table_dbtab.htm) Syntax READ TABLE dbtab WITH KEY key SEARCH FKEQFKGEGKEQGKGE VERSION vers. Effect Obsolete: Reads a single row from a database table or view dbtab. Additions -   WI
version: "7.57"
category: "data-structures"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abapread_table_dbtab_shortref.htm"
