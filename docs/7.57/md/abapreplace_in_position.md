...
In position-based replacements, the section in dobj is replaced starting at the offset specified in off for the length specified in len with the content of the operand new. The same applies to the additions OFFSET and LENGTH as to [FIND SECTION OF](javascript:call_link\('abapfind_section_of.htm'\)).
