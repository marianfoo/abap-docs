...
description: |
  Reference(https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abapreplace_obsolete.htm) Syntax REPLACE substring WITH new INTO dobj IN BYTECHARACTER MODE LENGTH len. Effect Obsolete: Searches for a character string or byte string substring in the variable dobj and r
version: "7.57"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abapreplace_pattern_shortref.htm"
