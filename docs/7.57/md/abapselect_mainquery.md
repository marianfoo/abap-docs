...
-   A [SELECT clause](javascript:call_link\('abapselect_clause.htm'\)) started with FIELDS after the [FROM clause](javascript:call_link\('abapfrom_clause.htm'\)) leads to the [strict mode as of Release 7.50](javascript:call_link\('abenabap_sql_strictmode_750.htm'\)).
