...
-   [INTERSECT DISTINCT SELECT ...](javascript:call_link\('abapunion_clause.htm'\))
    Creates an intersection of the rows of the result sets of two SELECT statements.
-   [EXCEPT DISTINCT SELECT ...](javascript:call_link\('abapunion_clause.htm'\))
...
-   [*\[*NEW*\]* @DATA(wa)](javascript:call_link\('abapinto_clause.htm'\)), [*\[*NEW*\]* @DATA*|*@FINAL(itab)](javascript:call_link\('abapinto_clause.htm'\))
