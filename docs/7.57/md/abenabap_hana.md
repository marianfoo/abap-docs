...
-   Modeling of [SAP HANA views](javascript:call_link\('abenhana_view_glosry.htm'\) "Glossary Entry") transformed internally to HANA-specific SQL or [SQLScript](javascript:call_link\('abensql_script_glosry.htm'\) "Glossary Entry").
