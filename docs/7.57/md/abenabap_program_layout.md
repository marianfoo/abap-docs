...
description: |
  !Figure(abdoc_program.gif) -   Each ABAP program starts with a program-initiating statement(https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenabap_program_statement.htm) that depends on the program type(https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenprogram_type_ov
version: "7.57"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenabap_program_layout.htm"
