...
The strict mode of the syntax check in Release 7.52 applies to all ABAP SQL statements that use one of the following properties introduced in [Release 7.52](javascript:call_link\('abennews-752-abap_sql.htm'\)):
