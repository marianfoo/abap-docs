...
description: |
  As in token-based rendering(https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenabap_sxml_lib_render_token.htm), the XML writer is created using the factory method CREATE of the required class, for example: DATA(writer) = CAST if_sxml_writer( cl_sxml_string_writer=>create( ... ) ).
version: "7.57"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenabap_sxml_lib_render_oo.htm"
