...
title: "ABAP and XML"
description: |
  This section describes how XML(https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenxml_glosry.htm 'Glossary Entry') data can be created and read in ABAP. The main topics are -   processing and creating XML data using parsers and renderers that are created and used using the APIs of clas
version: "7.57"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenabap_xml.htm"
