...
description: |
  The following libraries that are delivered as part of AS ABAP enable processing of XML data based on classes and interfaces: -   iXML Library(https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenabap_ixml_lib.htm) The 'integrated' XML Library provides methods for parsing XML data in XML
version: "7.57"
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenabap_xml_libs.htm"
