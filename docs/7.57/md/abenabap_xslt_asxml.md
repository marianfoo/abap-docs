...
description: |
  The canonical XML(https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenxml_glosry.htm 'Glossary Entry') representation asXML is the format of XML data that results from a serialization of ABAP data using XSLT programs(https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenxsl_t
version: "7.57"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenabap_xslt_asxml.htm"
