...
title: "Syntax"
description: |
  ... (authorization:none) ... Effect The RAP BO operation addition authorization:none excludes the operation in question from authorization checks(https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenbdl_authorization.htm). As a prerequisite, authorization control(https://help.sap.com/d
version: "7.57"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenbdl_actions_auth.htm"
abapFile: "abenbdl_actions_auth.htm"
keywords: ["delete", "do", "if", "case", "try", "data", "abenbdl", "actions", "auth"]
---
...
The RAP BO operation addition authorization:none excludes the operation in question from [authorization checks](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenbdl_authorization.htm). As a prerequisite, [authorization control](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenbdl_authorization.htm) must be defined and implemented.

authorization:none can be used for the following operations:

-   the [standard operations create and delete](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenbdl_standard_operations.htm)
...
For create, delete, operations for associations, and the draft action Edit, this addition can only be used in the [authorization master entity](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenrap_auth_ma_ent_glosry.htm "Glossary Entry").
