...
[Authorization Context](javascript:call_link\('abenbdl_def_auth_context.htm'\))
...
[Own Authorization Context](javascript:call_link\('abenbdl_def_own_auth_context.htm'\))
...
A [CDS behavior definition](javascript:call_link\('abencds_behavior_definition_glosry.htm'\) "Glossary Entry") can define [authorization contexts](javascript:call_link\('abencds_auth_context_glosry.htm'\) "Glossary Entry") that list multiple [authorization objects](javascript:call_link\('abenauthorization_object_glosry.htm'\) "Glossary Entry") that are used for the ABAP statement [AUTHORITY-CHECK OBJECT](javascript:call_link\('abapauthority-check.htm'\)). There are different types of authorization contexts:

-   Authorization context defined using the statement [define authorization context](javascript:call_link\('abenbdl_def_auth_context.htm'\)), optionally with the addition for disable.
...
-   [Own authorization context](javascript:call_link\('abencds_own_ac_glosry.htm'\) "Glossary Entry") defined using the statement [define own authorization context *\[*...*\]*](javascript:call_link\('abenbdl_def_own_auth_context.htm'\)).
...
Continue
[CDS BDL - define authorization context](javascript:call_link\('abenbdl_def_auth_context.htm'\))
[CDS BDL - define own authorization context](javascript:call_link\('abenbdl_def_own_auth_context.htm'\))