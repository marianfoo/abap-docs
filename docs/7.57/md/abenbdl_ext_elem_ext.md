...
Continue
[CDS BDL - extend determine action](javascript:call_link\('abenbdl_determine_action_ext.htm'\))
[CDS BDL - extend draft determine action Prepare](javascript:call_link\('abenbdl_draft_action_ext.htm'\))
[CDS BDL - extend mapping](javascript:call_link\('abenbdl_type_mapping_ext.htm'\))