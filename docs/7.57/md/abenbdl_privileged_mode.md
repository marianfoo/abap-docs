...
base context refers to the [authorization context](javascript:call_link\('abenbdl_def_auth_context.htm'\)) that is specified in the projected BDEF. It is compulsory to reuse the authorization context from the projected BDEF.
