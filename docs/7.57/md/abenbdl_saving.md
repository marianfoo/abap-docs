...
Prevents the BO's managed runtime from saving changes and allows implementing an own saving strategy instead. In case of an unmanaged save, a [persistent table](javascript:call_link\('abenbdl_persistent_table.htm'\)) cannot be specified.
