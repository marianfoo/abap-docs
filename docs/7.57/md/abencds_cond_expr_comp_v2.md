...
-   Context-dependent rules apply when specifying the operands lhs and rhs. For further details, see topic [CDS DDL - View Entity, cds\_cond, Operands](javascript:call_link\('abencds_cond_expr_operands_v2.htm'\))
-   The tables of [comparable types](javascript:call_link\('abencds_cond_expr_types_v2.htm'\)) show which data types can be compared with each other.

Continue
[CDS DDL - CDS View Entity, cds\_cond, Comparable Types](javascript:call_link\('abencds_cond_expr_types_v2.htm'\))