...
The program DEMO\_AMDP\_FUNCTION\_TYPE uses [RTTI](javascript:call_link\('abenrun_time_type_identific_glosry.htm'\) "Glossary Entry") to show the following for various CDS table functions:
