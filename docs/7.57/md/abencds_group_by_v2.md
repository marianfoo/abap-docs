...
The fields specified after GROUP BY can have any [built-in data type](javascript:call_link\('abenddic_builtin_types.htm'\)) except for LCHR, LRAW, STRING, RAWSTRING, or GEOM\_EWKB.
