...
description: |
  For CDS hierarchies, client handling cannot be defined using annotations. Instead client handling is defined in advance as follows: -   Client dependency is determined in the same way as when the annotation @ClientHandling.type : #INHERITED(https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-U
version: "7.57"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abencds_hiera_client_handling.htm"
