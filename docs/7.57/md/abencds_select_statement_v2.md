...
The program DEMO\_CDS\_DISTINCT first fills the underlying database table and then accesses the view using [SELECT](javascript:call_link\('abapselect.htm'\)). One duplicate entry is removed from the result set.
