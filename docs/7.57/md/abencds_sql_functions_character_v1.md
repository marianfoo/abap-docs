...
The following table shows the possible [SQL functions](javascript:call_link\('abencds_sql_functions_v1.htm'\)) for character strings in a [CDS DDIC-based view (obsolete)](javascript:call_link\('abencds_v1_view_glosry.htm'\) "Glossary Entry"), plus the requirements made on the arguments.
