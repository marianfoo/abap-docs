...
description: |
  Target Conversion i, int8, (b, s) The value of the decimal floating point number is rounded up to an integer. If this number is within the value range(https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenvalue_range_glosry.htm 'Glossary Entry') for the data type i, int8, (b, s), it is co
version: "7.57"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenconversion_type_decfloat.htm"
