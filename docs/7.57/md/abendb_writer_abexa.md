...
description: |
  The example demonstrates how data can be written to a DDIC database table using a writer stream(https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenwriter_stream_glosry.htm 'Glossary Entry'). Source Code REPORT demo_db_writer. CLASS demo DEFINITION. PUBLIC SECTION. CLASS-METHODS:  cla
version: "7.57"
category: "database"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abendb_writer_abexa.htm"
