...
description: |
  This example demonstrates how extracts are processed. Source Code REPORT demo_extract_at. DATA: spfli_wa   TYPE spfli, sflight_wa TYPE sflight. FIELD-GROUPS: header, flight_info, flight_date. CLASS demo DEFINITION. PUBLIC SECTION. CLASS-METHODS main. ENDCLASS. CLASS demo IMPLEMENTATION. METHOD
version: "7.57"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenextract_at_abexa.htm"
abapFile: "abenextract_at_abexa.htm"
keywords: ["select", "insert", "loop", "do", "if", "method", "class", "data", "abenextract", "abexa"]
---
...
This example continues the example given under [EXTRACT](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abapextract.htm). After the extract dataset is filled, it is sorted by field group header and, afterwards, group level processing is executed in a LOOP. Here, structured output is created.