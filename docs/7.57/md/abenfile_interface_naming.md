...
Logical file names and logical paths support both platform-independent programs and [secure programs](javascript:call_link\('abenabap_security.htm'\)). Logical file names and logical paths can be created as follows and linked with the actual physical file names for each platform:
