...
-   put\_node
    ...
    -   After returning from a subordinate subroutine put\_node, the PUT statement raises the event [GET node LATE](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abapget-.htm) in the runtime framework.
