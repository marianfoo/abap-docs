...
The executable example for [grouping with FOR](javascript:call_link\('abenfor_group_by_comparison_abexa.htm'\)) demonstrates how the entire group loop can be implemented using expressions.