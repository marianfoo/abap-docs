...
From Release 7.0, EhP2, the lifetime and visibility of area instances can be bound not only to the current [AS instance](javascript:call_link\('abenas_instance_glosry.htm'\) "Glossary Entry") but also to the following:
