...
[ABAP - Keyword Documentation](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenabap.htm) →  [ABAP - Programming Language](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenabap_reference.htm) →  [Data Interfaces and Communication Interfaces](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenabap_data_communication.htm) → 
 ...
 [![](Mail.gif?object=Mail.gif&sap-language=EN "Feedback mail for displayed topic") Mail Feedback](mailto:f1_help@sap.com?subject=Feedback on ABAP Documentation&body=Document: ABAP and OLE, ABENOLE2, 757%0D%0A%0D%0AError:%0D%0A%0D%0A%0D%0A%0D%0ASuggestion for i
mprovement:)
...
All automation applications that can be used from ABAP are contained in the database table TOLE, which is maintained using transaction SOLE. This table contains the names of the classes and components supported by the [ABAP runtime framework](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenabap_runtime_frmwk_glosry.htm "Glossary Entry"). It also contains type information for adapting different data formats. The automation command set consists of the following ABAP statements:
...
Continue
[CREATE OBJECT, OLE](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abapcreate_object_ole2.htm)
[CALL METHOD, OLE](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abapcall_method_ole2.htm)
[GET PROPERTY, OLE](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abapget_property.htm)
[SET PROPERTY, OLE](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abapset_property.htm)
[FREE OBJECT, OLE](https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abapfree_object.htm)