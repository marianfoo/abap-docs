...
description: |
  Every output to a spool list is assigned to exactly one spool request. For every spool request, spool parameters(https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenprint_parameters.htm) are specified that can no longer be changed. Spool lists can be stacked in spool list levels. A spoo
version: "7.57"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenprint_spool.htm"
