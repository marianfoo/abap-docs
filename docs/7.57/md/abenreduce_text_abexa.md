...
title: "Source Code"
description: |
  REPORT demo_reduce_text. CLASS demo DEFINITION. PUBLIC SECTION. CLASS-METHODS main. ENDCLASS. CLASS demo IMPLEMENTATION. METHOD main. TYPES strings TYPE STANDARD TABLE OF string WITH EMPTY KEY. FINAL(words) = VALUE strings( ( `All` ) ( `ABAP` ) ( `constructs` ) ( `are` ) ( `imperative` )
version: "7.57"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenreduce_text_abexa.htm"
