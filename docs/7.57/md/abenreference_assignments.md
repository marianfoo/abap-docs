...
Continue
[Assigning Reference Variables](javascript:call_link\('abenset_references.htm'\))
[Assigning Field Symbols](javascript:call_link\('abenset_field_symbols.htm'\))