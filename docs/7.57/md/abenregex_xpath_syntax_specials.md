...
description: |
  The following tables summarize the special characters in XPath regular expressions(https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenxpath_regex_glosry.htm 'Glossary Entry'). -   Pattern Syntax(#abenregex-xpath-syntax-specials-1-----------single-character-escapes---@ITOC@@ABENREGEX_
version: "7.57"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenregex_xpath_syntax_specials.htm"
