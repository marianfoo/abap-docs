...
description: |
  The following assignment rules apply to assignments of the result fields of the result set of a standalone SELECT(https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abapselect.htm), WITH(https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abapwith.htm), or FETCH(https://help.sap
version: "7.57"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenselect_into_conversion.htm"
