...
-   [UNION](javascript:call_link\('abapunion.htm'\)) is used to create the union of the result set of a SELECT statement on the table SFLIGHT and a SELECT statement on the GTT.
