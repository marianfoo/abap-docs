...
description: |
  Area instance versions can have the following states. -   'Under Construction' An area instance version that has a change lock(https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenshm_area_instance_locks.htm) is being built. Change locks automatically create a version under construction.
version: "7.57"
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abenshm_area_instance_state.htm"
