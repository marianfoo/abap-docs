...
This example demonstrates the string functions [to\_mixed](javascript:call_link\('abencase_functions.htm'\)) and [from\_mixed](javascript:call_link\('abencase_functions.htm'\)).
