...
title: "Source Code"
description: |
  REPORT demo_sxml_token_writer_nsuri. CLASS sxml_demo DEFINITION. PUBLIC SECTION. CLASS-METHODS main. ENDCLASS. CLASS sxml_demo IMPLEMENTATION. METHOD main. FINAL(writer) = CAST if_sxml_writer( cl_sxml_string_writer=>create(  ) ). FINAL(nsuri1) = `http://www.sap.com/abapdemos`. FINAL(nsu
version: "7.57"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_757_index_htm/7.57/en-US/abensxml_renderering_ns_abexa.htm"
