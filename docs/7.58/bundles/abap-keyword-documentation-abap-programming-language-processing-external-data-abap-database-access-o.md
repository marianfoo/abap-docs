...
description: |
  The query service makes it possible to search for and load persistent objects using logical expressions. -   Query Service Overview(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenos_query_terms.htm) -   Query Service Components(https://help.sap.com/doc/abapdocu_758_index_htm/7.58
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap_object_services_query.htm"
...
-   [Query Service Overview](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenos_query_terms.htm)
-   [Query Service Components](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenos_query_comps.htm)
-   [Query Conditions](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenos_query_filter_cond.htm)
-   [Sort Conditions](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenos_query_sort_cond.htm)

Continue
[OS - Query Service, Overview](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenos_query_terms.htm)
[OS - Components of the Query Service](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenos_query_comps.htm)
[OS - Query Conditions](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenos_query_filter_cond.htm)
[OS - Sort Conditions](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenos_query_sort_cond.htm)
![Example](exa.gif "Example") [OS - Query Service](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenos_query_abexa.htm)
...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenos_query_terms.htm"
...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenos_query_filter_cond.htm"
...
-   To avoid [SQL injections](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abensql_injection_glosry.htm "Glossary Entry"), the use of parameters from the parameter list of a concatenation is recommended, where dynamic values are represented as literals.
-   See also [SQL Injections Using Object Services](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abensql_inj_os_query_scrty.htm).
...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenos_query_sort_cond.htm"
...
Since the predefined parameters PAR1, PAR2 from a parameter list are used here, an [SQL injection](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abensql_injection_glosry.htm "Glossary Entry") is not possible in this example.
