...
title: "Streaming"
description: |
  Streaming describes how streams(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenstream_glosry.htm 'Glossary Entry') are passed. Streams are represented by instances of special classes. The transfer of streams takes place by calling the relevant methods of the object. Properties of S
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenstreaming.htm"
...
[ABAP - Keyword Documentation](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap.htm) →  [ABAP - Programming Language](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap_reference.htm) →  [Processing Internal Data](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap_data_working.htm) → 
 ...
 [![](Mail.gif?object=Mail.gif "Feedback mail for displayed topic") Mail Feedback](mailto:f1_help@sap.com?subject=Feedback%20on%20ABAP%20Documentation&body=Document:%20Streaming%2C%20ABENSTREAMING%2C%20758%0D%0A%0D%0AError:%0D%0A%0D%0A%0D%0A%0D%0ASuggestion%20for%20improvement:)

Streaming

Streaming describes how [streams](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenstream_glosry.htm "Glossary Entry") are passed. Streams are represented by instances of special classes. The transfer of streams takes place by calling the relevant methods of the object.
...
-   Stream kind
    ...
    [Data streams](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abendata_stream_glosry.htm "Glossary Entry") and [filter streams](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenfilter_stream_glosry.htm "Glossary Entry")
    
-   Stream direction
    
    [Reader streams](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenreader_stream_glosry.htm "Glossary Entry") and [writer streams](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenwriter_stream_glosry.htm "Glossary Entry")
    
-   Stream type
    
    [Binary streams](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenbinary_stream_glosry.htm "Glossary Entry") and [character streams](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencharacter_stream_glosry.htm "Glossary Entry")
    

More Information   

-   [Classes and interfaces for streams](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenstreaming_classes_interfaces.htm)
-   [Streaming for Data Objects](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abendata_objects_streams.htm)
-   [Streaming in ABAP SQL](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap_sql_streaming.htm)
...
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenstreaming_classes_interfaces.htm"
...
[ABAP - Keyword Documentation](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap.htm) →  [ABAP - Programming Language](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap_reference.htm) →  [Processing Internal Data](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap_data_working.htm) →  [Streaming](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenstreaming.htm) → 
...
1.  an ID resource for the resource that is used as a [streaming data source](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenstreaming_data_source_glosry.htm "Glossary Entry") or a [streaming data sink](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenstreaming_data_sink_glosry.htm "Glossary Entry"). Currently, data streams are supported for the following resources:
    -   [LOBs](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenlob_glosry.htm "Glossary Entry") in database tables; the associated resource ID is [DB](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap_sql_streaming.htm).
    -   [Strings](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenstring_glosry.htm "Glossary Entry"); the associated resource ID is [STRING](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenstring_streams.htm).
    -   [Internal tables](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abeninternal_table_glosry.htm "Glossary Entry"); the associated resource ID is [ITAB](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenitab_streams.htm).
...
In the case of data streams, the following methods are implemented as [kernel methods](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenkernel_method_glosry.htm "Glossary Entry"). The actual access to the [streaming data source](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenstreaming_data_source_glosry.htm "Glossary Entry") or [streaming data sink](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenstreaming_data_sink_glosry.htm "Glossary Entry") is completed by the ABAP runtime framework.
...
description: |
  The abstract superclasses for streaming(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenstreaming_glosry.htm 'Glossary Entry') for data objects are: -   CL_ABAP_MEMORY_C_READER -   CL_ABAP_MEMORY_C_WRITER -   CL_ABAP_MEMORY_X_READER -   CL_ABAP_MEMORY_X_WRITER Stream
version: "7.58"
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abendata_objects_streams.htm"
abapFile: "abendata_objects_streams.htm"
keywords: ["do", "if", "try", "class", "data", "internal-table", "abendata", "objects", "streams"]
---
...
[ABAP - Keyword Documentation](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap.htm) →  [ABAP - Programming Language](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap_reference.htm) →  [Processing Internal Data](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap_data_working.htm) →  [Streaming](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenstreaming.htm) → 
 ...
 [![](Mail.gif?object=Mail.gif "Feedback mail for displayed topic") Mail Feedback](mailto:f1_help@sap.com?subject=Feedback%20on%20ABAP%20Documentation&body=Document:%20Streaming%20for%20Data%20Objects%2C%20ABENDATA_OBJECTS_STREAMS%2C%20758%0D%0A%0D%0AError:%0D%0A%0D%0A%0D%0A%0D%0ASuggestion%20for%20improvement:)

Streaming for Data Objects

The abstract superclasses for [streaming](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenstreaming_glosry.htm "Glossary Entry") for data objects are:
...
-   [Streaming for Strings](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenstring_streams.htm)
-   [Streaming for Internal Tables](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenitab_streams.htm)

Hint

Another important application for streaming is when using [ABAP SQL](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap_sql_streaming.htm) to access [LOBs](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenlob_glosry.htm "Glossary Entry") in database tables.
