...
The [C2 contract](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenc2_contract_glosry.htm "Glossary Entry") is the [release contract](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenrelease_contract_glosry.htm "Glossary Entry") that is crucial for remote access to APIs from external consumers. The following topics list the most important rules that must be obeyed by API providers and API consumers.
...
[ABAP - Keyword Documentation](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap.htm) →  [ABAP - Rules for ABAP Cloud](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap_strict_rules.htm) →  [Contract Rules for ABAP Released APIs](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenrestricted_apis.htm) →  [C2 Contract Rules](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenc2_contract_rules.htm) → 
...
[ABAP - Keyword Documentation](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap.htm) →  [ABAP - Rules for ABAP Cloud](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap_strict_rules.htm) →  [Contract Rules for ABAP Released APIs](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenrestricted_apis.htm) →  [C2 Contract Rules](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenc2_contract_rules.htm) →  [C2 Contract Rules for API Providers](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenc2_provider_rules.htm) → 
...
The rules for releasing a [CDS user-defined type](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_user_defined_type_glosry.htm "Glossary Entry") with the C2 contract are the same as the C1 contract rules for providing types, see topic [C1 Contract Rules for Providing CDS Types](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenc1_provider_rules_cds_type.htm).
