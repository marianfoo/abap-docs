...
description: |
  Reference(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapassign.htm) Syntax ASSIGN  dobj+off(len)  TABLE FIELD (name)  dref->  dobj INCREMENT inc  COMPONENT comp OF STRUCTURE struc  oref->(attr_name)  class(class_na
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapassign_shortref.htm"
