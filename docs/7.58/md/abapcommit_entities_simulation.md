...
description: |
  Syntax COMMIT ENTITIES ... IN SIMULATION MODE ... Effect Optional addition of COMMIT ENTITIES(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapcommit_entities.htm) statements that allows a RAP transaction to be checked. It processes the RAP early save phase(https://help.sap.com/doc
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapcommit_entities_simulation.htm"
...
Optional addition of [COMMIT ENTITIES](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapcommit_entities.htm) statements that allows a RAP transaction to be checked. It processes the [RAP early save phase](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenearly_rap_save_phase_glosry.htm "Glossary Entry") only and without actually saving data. A final [COMMIT WORK](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapcommit.htm) is not implicitly included with this variant. The consistency of the transaction can be checked by evaluating the value of sy-subrc as a result of executing the commit in simulation mode.

Use Case

A use case of COMMIT ENTITIES statements with the addition IN SIMULATION MODE might be as follows:

-   A non-RAP application modifies data. It needs to persist the data and has its own save logic. Furthermore, it is responsible for the final saving of data from within an [SAP LUW](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenluw_glosry.htm "Glossary Entry"), i. e. once the SAP LUW is finalized with [COMMIT WORK](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapcommit.htm).
