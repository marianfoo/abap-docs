...
title: "DATA, BOXED"
description: |
  Short Reference(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapdata_shortref.htm) Syntax DATA struc TYPE struc_type BOXED. Effect This statement defines a structured attribute of a class or an interface as a static box(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/a
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapdata_boxed.htm"
...
This statement defines a structured attribute of a class or an interface as a [static box](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenstatic_boxes.htm). It can only be in the declaration section of a class or an interface and only at the highest level.
...
-   The addition BOXED can also be used in the statement [TYPES](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abaptypes_boxed.htm) to declare a substructure of a nested structured data type.
