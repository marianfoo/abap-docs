...
-   The example [ABAP EML - Responses](javascript:call_link\('abeneml_responses_abexa.htm'\)) demonstrates the RAP response parameters using modify operations to change a simple managed RAP BO.