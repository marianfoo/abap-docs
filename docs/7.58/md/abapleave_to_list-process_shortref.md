...
description: |
  Reference(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapleave_to_list-processing.htm) Syntax LEAVE TO LIST-PROCESSING AND RETURN TO SCREEN dynnr. Effect Calls list processing when the current dynpro(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abendynpro_gl
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapleave_to_list-process_shortref.htm"
...
[Reference](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapleave_to_list-processing.htm)
...
Calls list processing when the current [dynpro](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abendynpro_glosry.htm "Glossary Entry") is exited.
