...
title: "LOAD REPORT"
description: |
  This statement is for internal use only. It must not be used in application programs. Syntax LOAD REPORT prog PART part INTO itab. Effect The part specified in part of the generated form (load(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenload_glosry.htm 'Glossary Entry')) of the
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapload.htm"
