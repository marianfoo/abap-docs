...
title: "POSITION"
description: |
  Short Reference(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapposition_shortref.htm) Syntax POSITION pos. Effect This statement places the list cursor(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenlist_cursor_glosry.htm 'Glossary Entry') at the position of the c
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapposition.htm"
...
[Short Reference](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapposition_shortref.htm)
...
This statement places the [list cursor](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenlist_cursor_glosry.htm "Glossary Entry") at the position of the current line in the list buffer specified in pos. The program expects a data object of the type i for pos. If the value of pos is 0 or less than or equal to 0 or greater than the page length in sy-linsz defined with the addition [LINE-SIZE](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapnew-page_options.htm) of the program-initiating statement or [NEW-PAGE](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapnew-page.htm), none of the subsequent output statements create any output until the list cursor is positioned within a line again.
...
Definition and use of a [macro](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenmacro_glosry.htm "Glossary Entry") write\_frame to draw frames around [WRITE](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapwrite-.htm) output. The POSITION statement positions the list cursor for subsequent output.
