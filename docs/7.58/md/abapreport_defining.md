...
This addition of the statement [REPORT](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapreport.htm) shows that the current program is the [database program](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abendatabase_program_glosry.htm "Glossary Entry") of the logical database ldb. The name of this logical database has a maximum length of 20 characters. Logical databases are defined with the tool [Logical Database Builder](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenlogical_database_build_glosry.htm "Glossary Entry") of the [ABAP Workbench](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap_workbench_glosry.htm "Glossary Entry"), in which the [master program](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenmaster_program_glosry.htm "Glossary Entry") is generated automatically including the statement REPORT. The name of the master program is SAPDBldb.
