...
description: |
  Reference(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapscroll.htm) Syntax SCROLL LIST   TO COLUMN col    LEFTRIGHT BY n PLACES     TO  FIRST PAGE  LAST PAGE  PAGE pag  LINE lin    FOR
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapscroll_shortref.htm"
...
[Reference](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapscroll.htm)
...
-   [TO COLUMN col](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapscroll_list_horizontal.htm)
    Moves the area horizontally to the column col.
-   [*{*LEFT*|*RIGHT*}* *\[*BY n PLACES*\]*](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapscroll_list_horizontal.htm)
    Moves the display area left or right either by the line width or by n places.
-   [TO *{* *{*FIRST PAGE*}* *|* *{*LAST PAGE *}* *|* *{*PAGE pag*}* *\[*LINE lin*\]* *}*](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapscroll_list_vertical.htm)
...
-   [*{*FORWARD*|*BACKWARD*}* *\[*n PAGES*\]*](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapscroll_list_vertical.htm)
    Moves the display area up or down, either by one page or by pag pages.
-   [INDEX idx](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapscroll.htm)
