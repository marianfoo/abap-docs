...
[Short Reference](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapsupply_shortref.htm)
...
This statement fills the key fields key1 key2 ... of a [context](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencontext_glosry.htm "Glossary Entry") instance with the values of data objects f1 f2 ... context\_ref expects a data object that points to a context instance (see [CONTEXTS](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapcontexts.htm)). The names of key fields of the corresponding context can be specified for key1 key2 ... f1 f2 ... expects data objects whose data type matches the corresponding key field key1 key2 ...
