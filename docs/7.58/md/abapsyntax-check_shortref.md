...
description: |
  Reference(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapsyntax-check_for_itab.htm) Syntax SYNTAX-CHECK FOR itab MESSAGE mess LINE lin WORD wrd PROGRAM prog DIRECTORY ENTRY dir WITH CURRENT SWITCHSTATES INCLUDE incl OFFSET off MESSAGE-ID
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapsyntax-check_shortref.htm"
...
[Reference](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapsyntax-check_for_itab.htm)
...
-   [PROGRAM prog](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapsyntax-check_for_itab.htm)
    Defines the program properties with reference to a program prog.
-   [DIRECTORY ENTRY dir](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapsyntax-check_for_itab.htm)
    Defines the program properties by specifying a structure in dir of the type TRDIR.
-   [WITH CURRENT SWITCHSTATES](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapsyntax-check_for_itab.htm)
    Defines which key configuration is used for the syntax check.
-   [INCLUDE incl](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapsyntax-check_error_handling.htm)
    Returns the name of the include program in which the error occurs in incl.
-   [OFFSET off](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapsyntax-check_error_handling.htm)
    Returns the offset of the error in the line in off.
-   [MESSAGE-ID mid](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapsyntax-check_error_handling.htm)
