...
An authorization check must be specified in the BDEF using the property instance. See the details in the RAP BDL documentation for [authorization](javascript:call_link\('abenbdl_authorization.htm'\)).
...
An authorization check must be specified in the BDEF using the property global. See the details in the RAP BDL documentation for [authorization](javascript:call_link\('abenbdl_authorization.htm'\)).
...
Operations, actions, associations and fields must be specified in the BDEF so that the respective components are available in the structure. For details on the BDEF specifications, see the subtopics in [RAP - BDL for Behavior Definitions](javascript:call_link\('abenbdl.htm'\)).
