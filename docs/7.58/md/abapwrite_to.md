...
-   Although the statement WRITE TO does not send any data to an output medium, a [conversion exit](javascript:call_link\('abenconversion_exit_glosry.htm'\) "Glossary Entry") may be executed.
