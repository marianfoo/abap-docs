...
description: |
  If a warning or error message(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abendynp_field_messages.htm) is sent in a module mod whose call is combined with a FIELD(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/dynpfield.htm) statement FIELD f MODULE mod. the input fiel
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap_dynpros_checks_mod.htm"
