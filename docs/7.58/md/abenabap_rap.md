...
description: |
  This section of the ABAP keyword documentation describes the syntax and semantics of all language elements of ABAP RAP(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap_rap_glosry.htm 'Glossary Entry'). A RAP business object (RAP BO) is a business object (BO)(https://help.sap.c
version: "7.58"
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap_rap.htm"
