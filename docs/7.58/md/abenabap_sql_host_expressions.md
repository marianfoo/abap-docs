...
-   Right sides of [SQL conditions](javascript:call_link\('abenabap_sql_stmt_logexp.htm'\)) except for LIKE and IN.
...
Operands of host expressions can have a [CDS enumerated type](javascript:call_link\('abencds_enum_type_glosry.htm'\) "Glossary Entry") but not an [ABAP enumerated type](javascript:call_link\('abenenumerated_type_glosry.htm'\) "Glossary Entry").
