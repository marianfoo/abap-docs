...
description: |
  The strict mode of the syntax check in ABAP release 7.56 applies to all ABAP SQL statements that use one of the following features introduced in ABAP release 7.56(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abennews-756-abap_sql.htm): -   Use of the string function INITCAP(https:/
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap_sql_strictmode_756.htm"
