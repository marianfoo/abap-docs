...
description: |
  The following sections describe the syntax elements that can be used in an ABAP program: -   ABAP Statements(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap_statements.htm) -   Comments(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencomment.htm) -   Program D
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap_syntax.htm"
...
-   [Comments](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencomment.htm)
-   [Program Directives](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenprogram_directives.htm)
-   [Naming Conventions and Namespaces](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abennaming_conventions.htm)
