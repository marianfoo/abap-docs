...
description: |
  The example demonstrates how a prepared statement(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencl_sql_prepared_statement.htm) is created and executed using ADBC. Source Code  Public class definition CLASS cl_demo_adbc_prepared_stmnt DEFINITION INHERITING FROM cl_demo_clas
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenadbc_sql_prepared_abexa.htm"
...
The example demonstrates how a [prepared statement](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencl_sql_prepared_statement.htm) is created and executed using ADBC.
...
In this example, a [query](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenadbc_query.htm) is instantiated as a prepared statement and is executed with different parameters.
