...
-   In a fully buffered table or view, access to nonexistent data is very fast (see [Buffer Management](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenbuffer_memory.htm)).
-   For fully buffered tables or views, [restrictions](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abensql_engine_restr.htm) that cause [bypassing](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenbuffer_restrictions.htm) the buffer come from the [ABAP SQL engine](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap_sql_engine_glosry.htm "Glossary Entry") only.
