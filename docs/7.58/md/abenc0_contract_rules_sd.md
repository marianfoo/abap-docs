...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenc0_contract_rules_sd.htm"
...
-   [Example: C0 Released CDS Service Definition, Design and Consumption](#abenc0-contract-rules-sd-3---c0-contract-rules-for-providers-of-cds-service-definitions-----prerequisites-for-a-c0-release------a-provider-contract-must-be-set-using-the-syntax-statement--provider-contract--https---help-sap-com-doc-abapdocu-758-index-htm-7-58-en-us-abensrvd-provider-contract-htm-------the-annotation--AbapCatalog.extensibility.extensible: true](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_define_service_annos.htm) must be set.
