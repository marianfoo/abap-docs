...
description: |
  The ABAP Core Data Services (ABAP CDS) are the implementation of the general CDS(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_glosry.htm 'Glossary Entry') concept for AS ABAP. ABAP CDS makes it possible to define semantic data models on the standard database(https://help.sa
version: "7.58"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds.htm"
abapFile: "abencds.htm"
keywords: ["do", "if", "case", "try", "data", "types", "abencds"]
---
