...
[Conversion functions](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenddic_conversion_functions.htm) in a [CDS DDIC-based view (obsolete)](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_v1_view_glosry.htm "Glossary Entry"):

-   [Type conversion functions](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_conv_func_types_v1.htm)
-   [Unit and currency conversion functions](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_conv_func_unit_curr_v1.htm)

Hint

The conversion functions cover special cases that cannot be handled using a [CAST](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_cast_expression_v1.htm) expression.

Continue
[CDS DDL - DDIC-Based View, Type Conversion Functions](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_conv_func_types_v1.htm)
[CDS DDL - DDIC-Based View, Unit and Currency Conversion Functions](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_conv_func_unit_curr_v1.htm)