...
description: |
  Syntax ... EnumType.#EnumConstant ... Effect Specifies an enumerated constant(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenenumerated_constant_glosry.htm 'Glossary Entry') EnumConstant of a CDS enumerated type(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_e
version: "7.58"
category: "cds"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_enum_field_v2.htm"
...
Specifies an [enumerated constant](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenenumerated_constant_glosry.htm "Glossary Entry") EnumConstant of a [CDS enumerated type](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_enum_type_glosry.htm "Glossary Entry") EnumType in the SELECT list of a CDS view entity. An enumerated constant EnumConstant defines a value of the value set of an enumerated type. A CDS enumerated constant is specified using the name of the enumerated type EnumType, followed by a period (.), a hash character (#), and the name of an enumerated constant EnumConstant. An enumerated constant has the data type ENUM.
