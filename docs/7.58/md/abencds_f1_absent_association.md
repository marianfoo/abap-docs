...
... ASSOCIATION *\[* [cardinality](javascript:call_link\('abencds_cardinality_v2.htm'\))*\]* TO target ON [cds\_cond](javascript:call_link\('abencds_conditional_expression_v2.htm'\))
