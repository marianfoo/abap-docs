...
-   A CDS view can evaluate the CDS association in its path expressions ([CDS DDIC-based view (obsolete)](javascript:call_link\('abencds_path_expression_v1.htm'\)), [CDS view entity](javascript:call_link\('abencds_path_expression_v2.htm'\))).
