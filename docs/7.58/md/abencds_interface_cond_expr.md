...
Defines a WHERE condition for the result set of a [CDS transactional interface](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_trans_interface_glosry.htm "Glossary Entry"). When the transactional interface is accessed, the result set contains only the data from the projected entity [cds\_entity](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_define_view_as_interface.htm) that meets the condition cds\_cond specified after WHERE.
...
-   rhs can be a field of the projected entity, a [literal](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_literal_glosry.htm "Glossary Entry"), or a [session variable](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_session_variable_v2.htm). When using the operator LIKE, rhs must be a character literal.