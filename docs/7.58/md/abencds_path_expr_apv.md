...
A [path expression](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenpath_expression_glosry.htm "Glossary Entry") in the [CDS DDL](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_ddl_glosry.htm "Glossary Entry") is a sequence of CDS associations separated by periods (.) whose names are specified using assoc1, assoc2, and so on.
...
-   Temporal dependencies implemented in the following format:
    ...
    Note: key\_date can be a [parameter](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_f1_param.htm), a [session variable](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_session_variable_v2.htm), or a [literal](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_literal_v2.htm). It must be typed with [DATS](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenddic_builtin_types.htm) or [DATN](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenddic_builtin_types.htm). It must be annotated with @Semantics.businessDate.
    

Hint

Fields included via path expressions can be texts, display attributes, or texts belonging to display attributes. In an [analytical cube view](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_analytical_cube_glosry.htm "Glossary Entry"), such fields can be text or foreign key associations. In an [analytical dimension view](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_anal_dim_view_glosry.htm "Glossary Entry"), these fields can be text associations.
