...
title: "Syntax"
description: |
  ... element1(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_proj_view_element.htm), element2(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_proj_view_element.htm), ... Effect Defines the elements(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_proj_view_element_list.htm"
abapFile: "abencds_proj_view_element_list.htm"
keywords: ["do", "if", "data", "abencds", "proj", "view", "element", "list"]
---
...
... [element1](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_proj_view_element.htm), [element2](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_proj_view_element.htm), ...

Effect

Defines the [elements](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_proj_view_element.htm) of a CDS projection view of type transactional query. The elements are specified in a comma-separated list in curly brackets { }.
...
Continue
[CDS DDL - proj\_element, Transactional Query](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_proj_view_element.htm)