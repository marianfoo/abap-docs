...
-   Differences
    ...
    -   The [cardinality](javascript:call_link\('abencardinality_glosry.htm'\) "Glossary Entry") cannot be defined explicitly for to-parent associations and is generated as to-one.
