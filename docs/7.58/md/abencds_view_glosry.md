...
-   [CDS DDIC-based view (obsolete)](javascript:call_link\('abencds_v1_view_glosry.htm'\) "Glossary Entry") defined by [DEFINE VIEW](javascript:call_link\('abencds_define_view_v1.htm'\)).
