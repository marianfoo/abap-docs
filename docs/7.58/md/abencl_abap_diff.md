...
[ABAP - Keyword Documentation](javascript:call_link\('abenabap.htm'\)) →  [ABAP - Programming Language](javascript:call_link\('abenabap_reference.htm'\)) →  [Processing Internal Data](javascript:call_link\('abenabap_data_working.htm'\)) →  [Internal Tables (itab)](javascript:call_link\('abenitab.htm'\)) →  [itab - System Classes](javascript:call_link\('abenitab_system_classes.htm'\)) → 
...
The class CL\_ABAP\_DIFF compares the content of compatible [index tables](javascript:call_link\('abenindex_table_glosry.htm'\) "Glossary Entry") and returns information about any differences found.
...
Continue
![Example](exa.gif "Example") [itab - Using CL\_ABAP\_DIFF](javascript:call_link\('abencl_abap_diff_abexa.htm'\))