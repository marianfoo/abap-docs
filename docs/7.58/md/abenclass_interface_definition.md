...
description: |
  Classes and interfaces in ABAP Objects can be defined either globally or locally. -   Global classes and interfaces are stored centrally in the class library(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenclass_library_glosry.htm 'Glossary Entry') in the repository(https://help.s
version: "7.58"
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenclass_interface_definition.htm"
