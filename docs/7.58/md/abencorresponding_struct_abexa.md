...
description: |
  This example demonstrates the component operator(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenconstructor_expr_corresponding.htm) for structures. Source Code  Public class definition CLASS cl_demo_crrspndng_struct DEFINITION INHERITING FROM cl_demo_classrun PUBLIC CREATE P
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencorresponding_struct_abexa.htm"
