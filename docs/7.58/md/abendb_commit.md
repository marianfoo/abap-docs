...
description: |
  In AS ABAP(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenas_abap_glosry.htm 'Glossary Entry'), database commits are triggered either implicitly or explicitly. -   Implicit Database Commits(#abendb-commit-1-------explicit-database-commits---@ITOC@@ABENDB_COMMIT_2) -   Database C
version: "7.58"
category: "database"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abendb_commit.htm"
