...
title: "Database LUW"
description: |
  A database LUW(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenluw_glosry.htm 'Glossary Entry') (also referred to as a database transaction) is a non-separable sequence of database operations that is completed with a database commit(https://help.sap.com/doc/abapdocu_758_index_htm/
version: "7.58"
category: "database"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abendb_transaction.htm"
...
-   [Isolation levels](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abendb_isolation.htm)
...
-   At the end of a database LUW, all [reader streams](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenreader_stream_glosry.htm "Glossary Entry") and [locators](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenlocator_glosry.htm "Glossary Entry") created in it are closed implicitly. A writer stream that is still open is only closed as part of a database rollback and causes a runtime error during a a database commit.
-   Any database commits or database rollbacks that occur within the [update](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenupdate_glosry.htm "Glossary Entry") cancel the update with a runtime error. See [Forbidden Statements in Updates](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abendb_commit_during_update.htm).

Continue
[Database Commit](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abendb_commit.htm)
[Database Rollback](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abendb_rollback.htm)
[Isolation Levels](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abendb_isolation.htm)
[COMMIT, ROLLBACK CONNECTION](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapcommit_rollback_connection.htm)