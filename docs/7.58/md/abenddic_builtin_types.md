...
description: |
  The following tables show the built-in types in ABAP Dictionary(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap_dictionary_glosry.htm 'Glossary Entry') and their fundamental technical properties. For each built-in data type in ABAP Dictionary, the last column specifies the bui
version: "7.58"
category: "ui"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenddic_builtin_types.htm"
