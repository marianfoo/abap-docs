...
[ABAP - Keyword Documentation](javascript:call_link\('abenabap.htm'\)) →  [ABAP - Programming Language](javascript:call_link\('abenabap_reference.htm'\)) →  [SAP GUI User Dialogs](javascript:call_link\('abenabap_screens.htm'\)) →  [General Dynpros](javascript:call_link\('abenabap_dynpros.htm'\)) →  [dynpro - Processing Screens](javascript:call_link\('abenabap_dynpro_processing_screens.htm'\)) →  [dynpro - User Actions](javascript:call_link\('abenabap_dynpro_user_actions.htm'\)) →  [dynpro - Examples for User Actions](javascript:call_link\('abendynpro_field_abexas.htm'\)) → 

 [![](Mail.gif?object=Mail.gif "Feedback mail for displayed topic") Mail Feedback](mailto:f1_help@sap.com?subject=Feedback%20on%20ABAP%20Documentation&body=Document:%20dynpro%20-%20Fields%20with%20Dictionary%20Reference%2C%20ABENDYNPRO_DICT_ABEXA%2C%20758%0D%0A%0D%0AError:%0D%0A%0D%0A%0D%0A%0D%0ASuggestion%20for%20improveme
nt:)
