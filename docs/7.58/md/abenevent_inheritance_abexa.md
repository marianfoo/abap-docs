...
This example demonstrates the behavior of [events in inheritance](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abeninheritance_events.htm).
