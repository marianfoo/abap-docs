...
description: |
  This example demonstrates table filtering(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenconstructor_expression_filter.htm) using single values. Source Code  Public class definition CLASS cl_demo_filter_value_condition DEFINITION INHERITING FROM cl_demo_classrun PUBLIC CREA
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenfilter_value_condition_abexa.htm"
...
This example demonstrates [table filtering](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenconstructor_expression_filter.htm) using single values.
