...
title: "Examples"
description: |
  -   A standard table with a secondary hash key that is exclusively filled with APPEND(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapappend.htm) requires: -   No additional memory for the primary index since the logical and physical orders are the same -   18 bytes per line for the
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenitab_key_memory.htm"
