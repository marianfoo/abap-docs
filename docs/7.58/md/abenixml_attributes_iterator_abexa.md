...
title: "Source Code"
description: |
  Public class definition CLASS cl_demo_ixml_attribute_itrtr DEFINITION INHERITING FROM cl_demo_classrun PUBLIC CREATE PUBLIC. PUBLIC SECTION. METHODS main REDEFINITION. ENDCLASS.  Public class implementation CLASS cl_demo_ixml_attribute_itrtr IMPLEMENTATION. METHOD main. FINAL(ixml)
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenixml_attributes_iterator_abexa.htm"
