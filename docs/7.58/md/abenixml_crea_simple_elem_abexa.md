...
title: "Source Code"
description: |
  Public class definition CLASS cl_demo_ixml_create_simple_elm DEFINITION INHERITING FROM cl_demo_classrun PUBLIC CREATE PUBLIC. PUBLIC SECTION. METHODS main REDEFINITION. ENDCLASS.  Public class implementation CLASS cl_demo_ixml_create_simple_elm IMPLEMENTATION. METHOD main. FINAL(ix
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenixml_crea_simple_elem_abexa.htm"
...
As in the executable example [Creating Nodes](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenixml_crea_elem_abexa.htm), but using the method CREATE\_SIMPLE\_ELEMENT\_NS to create elements with content and insert them.