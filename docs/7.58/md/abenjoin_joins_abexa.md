...
This example demonstrates chaining and parenthesizing of multiple [joins](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapselect_join.htm) in the SELECT statement.
