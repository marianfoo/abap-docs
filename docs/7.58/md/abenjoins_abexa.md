...
description: |
  This example demonstrates inner and outer joins(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapselect_join.htm) as well as cross joins(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapselect_join.htm) in the SELECT statement. Source Code  Public class definition C
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenjoins_abexa.htm"
...
This example demonstrates inner and outer [joins](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapselect_join.htm) as well as [cross joins](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapselect_join.htm) in the SELECT statement.
...
See also the executable example [SQL Expressions, Coalesce Function](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abensql_expr_coalesce_abexa.htm), in which the default initial values set for the null values in the outer join are replaced by a different value.