...
category: "database"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenldb.htm"
...
Logical databases provide a hierarchical view of database tables or structures in the [ABAP Dictionary](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap_dictionary.htm) linked using foreign key dependencies. If parts of these dependencies form tree-like hierarchical structures, logical databases can read data from database tables that are components of these structures. In classic ABAP, logical databases are usually used in these hierarchical structures for the IPO principle (input, processing, output). The actual database accesses are then wrapped in the logical database. The logical database reads the data, stores it locally in the program, if necessary, and passes it row by row to an application program via an [interface work area](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenldb_interfaces.htm).
...
-   [Logical Databases - Components](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenldb_oview.htm)
-   [Logical Databases - Statements](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenldb_abap_statements.htm)
-   [Logical Databases - Use](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenldb_usage.htm)
-   [Logical Databases - Examples](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenldb_examples.htm)

Hints

-   Logical databases should no longer be used because they are based on cross-program usage of global data, implicit subroutine calls and [reporting event control](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap_processing_blocks.htm), and therefore do not comply with modern concepts. No new logical databases should be created. Instead a corresponding service should be provided using a global class.
...
Continue
[LDB - Components](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenldb_oview.htm)
[LDB - Statements](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenldb_abap_statements.htm)
[LDB - Use](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenldb_usage.htm)
[LDB - Examples](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenldb_examples.htm)