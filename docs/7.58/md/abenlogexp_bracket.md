...
title: "Syntax"
description: |
  ... ( log_exp ) ... Effect A complete logical expression log_exp(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenlogexp.htm) can be placed in parentheses in order to define the priority of processing. log_exp can be a combination of multiple expressions using AND(https://help.s
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenlogexp_bracket.htm"
...
A complete logical expression [log\_exp](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenlogexp.htm) can be placed in parentheses in order to define the priority of processing. log\_exp can be a combination of multiple expressions using [AND](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenlogexp_and.htm), [OR](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenlogexp_or.htm), or [EQUIV](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenlogexp_equiv.htm) or a logical expression negated using [NOT](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenlogexp_not.htm). A logical expression in parentheses is itself a logical expression.

Hint

The smallest unit of a logical expression that can be placed in parentheses is a [relational expression](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenrelational_expression_glosry.htm "Glossary Entry").
...
can be parenthesized explicitly as follows to stress the [implicit parentheses](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenlogexp_boole.htm):
