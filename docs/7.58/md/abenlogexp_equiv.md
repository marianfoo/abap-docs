...
title: "Syntax"
description: |
  ... log_exp1 EQUIV log_exp2 ... Effect Combining two logical expressions log_exp(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenlogexp.htm) with EQUIV creates a new logical expression that is true if both expressions are true or both expressions are false. If one of the expressi
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenlogexp_equiv.htm"
...
Combining two logical expressions [log\_exp](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenlogexp.htm) with EQUIV creates a new logical expression that is true if both expressions are true or both expressions are false. If one of the expressions is true and the other one is false, the combined expression is false.

Within a [parenthesis level](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenlogexp_bracket.htm), only two logical expressions can be combined using EQUIV.

Hints

-   The operator EQUIV binds weaker than NOT, AND, and OR.
-   The operator EQUIV implements an equivalence operation. Negating such an operation using [NOT](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenlogexp_not.htm) is the same as using an XOR operation (eXclusive OR). It is true if one of the expressions is true and the other one is false.
