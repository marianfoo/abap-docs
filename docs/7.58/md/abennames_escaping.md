...
title: "Syntax"
description: |
  ... !operand ... Effect The character ! can be written directly before a name operand of a single operand in order to distinguish it from an ABAP word(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap_words.htm) with the same notation in a statement. The escape character ! can be
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abennames_escaping.htm"
...
The character ! can be written directly before a name operand of a single operand in order to distinguish it from an [ABAP word](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap_words.htm) with the same notation in a statement. The escape character ! can be placed in front of a [chaining](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencomponent_chaining_selector.htm), but it cannot be used in front of components that are addressed by a [component selector](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencomponent_selector_glosry.htm "Glossary Entry").
...
-   The escape character ! may be required on rare occasions in which the compiler cannot tell the difference between an operand and a [reserved word](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap_words.htm) of the same name. Otherwise, it can be used for the documentation of operands in the source code.
-   The escape character ! must not be used in front of [operators](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenoperator_glosry.htm "Glossary Entry"). For example, != cannot be specified instead of \=.
