...
description: |
  The following ABAP statements are used to embed Native SQL(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abennative_sql_glosry.htm 'Glossary Entry') statically in ABAP programs: EXEC SQL(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapexec.htm) ... ENDEXEC(https://h
version: "7.58"
category: "database"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abennativesql.htm"
