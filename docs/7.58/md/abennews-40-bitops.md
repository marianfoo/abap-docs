...
[SET BIT n of f](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapset_bit.htm) sets the nth bit of the field f.

[GET BIT n OF f INTO g](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapget_bit.htm) passes the nth bit of the field f to the field g.

Modification 2   

New Bit Operations

In the [COMPUTE](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapcompute_bit.htm) statement, the new operators BIT-NOT, BIT-AND, BIT-XOR, and BIT-OR can be used for bit operations.

Complex conditions and sets can be managed efficiently using the new variants SET BIT and GET BIT and the new [bit operations](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenbit_operator_glosry.htm "Glossary Entry") applied to bit strings.

Modification 3   

Changes in Bit Comparisons

In the case of the [comparison operators](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenlogexp_bitmasks.htm) O, Z, and M, comparisons now take place in the length of the second operand, which must have the type X.
