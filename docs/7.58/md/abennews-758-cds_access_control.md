...
A new type of [access rule](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_dcl_role_rules.htm) is available for CDS projection views of type [CDS transactional query](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_transactional_pv_glosry.htm "Glossary Entry"): the [projection\_rule](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_dcl_role_proj_rule.htm) defined with the statement [GRANT SELECT ON ... AS PROJECTION ON ... FALLBACK ASSOCIATION ...](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencds_dcl_role_proj_rule.htm).
