...
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenos_transaction_terms.htm"
...
This concept allows interaction between classic and object-oriented transactions, controlled using a [transaction mode](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenos_transaction_mode.htm) that can be set for a given program.