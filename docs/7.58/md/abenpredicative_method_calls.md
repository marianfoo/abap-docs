...
-   In addition to the dedicated [predicate functions](javascript:call_link\('abenpredicate_functions.htm'\)), predicative method calls are the only way of creating a relational expression using a single operand.
