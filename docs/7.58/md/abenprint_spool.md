...
description: |
  Every output to a spool list is assigned to exactly one spool request(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenspool_request_glosry.htm 'Glossary Entry'). For every spool request, spool parameters(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenprint_paramete
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenprint_spool.htm"
