...
description: |
  The programs within an internal session(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abeninternal_session_glosry.htm 'Glossary Entry') form program groups(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abeninternal_session.htm) there. There is always one main program g
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenprogram_groups.htm"
