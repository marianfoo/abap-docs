...
title: "Hints"
description: |
  -   Regular expressions in POSIX syntax(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenregex_posix_syntax.htm) are obsolete. Using regular expressions in POSIX syntax leads to a warning from syntax check that can be hidden by the pragma ##regex_posix. It is recommended that regul
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenregex_syntax.htm"
...
The following topics describe the syntax of regular expressions that can be used in ABAP behind additions PCRE*|*REGEX in statements, for arguments pcre*|*regex*|*xpath of built-in functions and with the [system classes for regular expressions](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenregex_system_classes.htm).

-   [PCRE syntax](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenregex_pcre_syntax.htm)
-   [XPath syntax](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenregex_xpath_syntax.htm)
-   [XSD syntax](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenregex_xsd_syntax.htm)
-   [POSIX syntax](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenregex_posix_syntax.htm) (obsolete)
...
Continue
[regex - PCRE Syntax](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenregex_pcre_syntax.htm)
[regex - XPath Syntax](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenregex_xpath_syntax.htm)
[regex - XSD Syntax](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenregex_xsd_syntax.htm)