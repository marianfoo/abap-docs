...
title: "RFC - Calls"
description: |
  The following additions of the CALL FUNCTION(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapcall_function.htm) statement cause a remote function call: -   DESTINATION(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapcall_function_destination.htm) for a synchronous R
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenrfc_statements.htm"
...
The following additions of the [CALL FUNCTION](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapcall_function.htm) statement cause a remote function call:

-   [DESTINATION](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapcall_function_destination.htm) for a synchronous RFC (sRFC)
...
-   [STARTING NEW TASK](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapcall_function_starting.htm) for an asynchronous RFC (aRFC) and its parallel RFC variety (pRFC)
...
-   [CALL FUNCTION ... IN BACKGROUND UNIT](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapcall_function_background_unit.htm) for a background RFC (bgRFC).
-   [CALL FUNCTION ... IN BACKGROUND TASK](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapcall_function_background_task.htm) (obsolete) for a transactional RFC (tRFC) and its variant queued RFC (qRFC)
...
-   For a detailed description of RFC calls, see [CALL FUNCTION - RFC](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapcall_function_destination-.htm)
