...
-   Bundling is also possible using [transactional RFC (tRFC)](javascript:call_link\('abentrfc_2_glosry.htm'\) "Glossary Entry"). However, background RFC (bgRFC) is the enhanced successor technology of tRFC, which makes this technology obsolete.
...
[Controlled SAP LUW](javascript:call_link\('abencontrolling_sap_luw.htm'\))
