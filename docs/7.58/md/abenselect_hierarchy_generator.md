...
description: |
  Syntax ... HIERARCHY( SOURCE hierarchy_source WITH PRIVILEGED ACCESS CHILD TO PARENT ASSOCIATION _hierarchy_assoc PERIOD FROM field1 TO field2 VALID FROM from TO to START WHERE sql_cond(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap_sql_expr_logexp.htm)
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenselect_hierarchy_generator.htm"
