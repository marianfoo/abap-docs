...
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenselect_intersect_max_gtt_abexa.htm"
...
This example has the same result as the executable example for an [intersection with aggregate expression](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenselect_intersect_max_abexa.htm). Here, however, the SELECT statement is split into two ABAP SQL statements for demonstration purposes:
...
-   [INTERSECT](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapunion.htm) is used to create the intersection of the result set of a SELECT statement on the table SFLIGHT and a SELECT statement on the GTT.
