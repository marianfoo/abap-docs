...
This example demonstrates the coalesce function in [SQL expressions](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapsql_expr.htm).
...
This example is an excerpt from the executable example for [joins](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenjoins_abexa.htm). Here, the function [COALESCE](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abensql_coalesce.htm) is used to replace null values produced by an outer join with a different value.