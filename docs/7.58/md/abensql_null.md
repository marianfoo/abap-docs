...
Special null expression in ABAP SQL. The operand NULL represents the [null value](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abennull_value_glosry.htm "Glossary Entry"). Null expressions are context-dependent and the type of NULL is determined by the [context](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenobj_context_glosry.htm "Glossary Entry"). Generally, null expressions can be used in operand positions of [SQL expressions](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abapsql_expr.htm). Any exception is documented for the respective position.
...
-   The expression NULL must not be confused with the relational expression with the predicate syntax [IS *\[*NOT*\]* NULL](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenwhere_logexp_null.htm).
...
[SQL Expressions, Null Expression](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abensql_expr_null_abexa.htm)

Continue
![Example](exa.gif "Example") [sql\_exp - Null Expression](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abensql_expr_null_abexa.htm)