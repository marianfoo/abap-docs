...
  *|* FIRST\_VALUE*|*LAST\_VALUE( [col](javascript:call_link\('abenabap_sql_columns.htm'\))*|*[sql\_null](javascript:call_link\('abensql_null.htm'\)) ) ...
