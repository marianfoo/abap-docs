...
The simple example DEMO\_ST\_SYMMETRY illustrates a non-symmetrical transformation. Since the [tt.value](javascript:call_link\('abenst_tt_value_elementary.htm'\)) statements are not enclosed in separate elements, the serialized values of ROOT1 and ROOT2 are grouped in X.
