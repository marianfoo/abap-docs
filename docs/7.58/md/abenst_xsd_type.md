...
These attributes can be used with [tt:value](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenst_tt_value_elementary.htm), and [tt:write](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenst_tt_write.htm) and [tt:read](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenst_tt_read.htm) to validate the value.
