...
title: "Source Code"
description: |
  Public class definition CLASS cl_demo_escape_html DEFINITION INHERITING FROM cl_demo_classrun PUBLIC CREATE PUBLIC. PUBLIC SECTION. METHODS main REDEFINITION. ENDCLASS.  Public class implementation CLASS cl_demo_escape_html IMPLEMENTATION. METHOD main. DATA: body     TYPE string, esc_b
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenstring_function_escape_abexa.htm"
...
This example demonstrates the string function [escape](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenescape_functions.htm) for HTML.
