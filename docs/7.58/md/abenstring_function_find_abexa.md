...
title: "Source Code"
description: |
  Public class definition CLASS cl_demo_find_and_match DEFINITION INHERITING FROM cl_demo_classrun PUBLIC CREATE PUBLIC. PUBLIC SECTION. METHODS main REDEFINITION. ENDCLASS.  Public class implementation CLASS cl_demo_find_and_match IMPLEMENTATION. METHOD main. DATA: text TYPE c LENGTH 1
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenstring_function_find_abexa.htm"
...
The example demonstrates the string functions [count](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencount_functions.htm), [find](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abensearch_functions.htm), and [match](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenmatch_functions.htm).
