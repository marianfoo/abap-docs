...
title: "Source Code"
description: |
  Public class definition CLASS cl_demo_str_template_case DEFINITION INHERITING FROM cl_demo_classrun PUBLIC CREATE PUBLIC. PUBLIC SECTION. METHODS main REDEFINITION. ENDCLASS.  Public class implementation CLASS cl_demo_str_template_case IMPLEMENTATION. METHOD main. DATA: output  TYPE T
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenstring_template_case_abexa.htm"
abapFile: "abenstring_template_case_abexa.htm"
keywords: ["delete", "loop", "do", "if", "case", "method", "class", "data", "abenstring", "template", "abexa"]
---
