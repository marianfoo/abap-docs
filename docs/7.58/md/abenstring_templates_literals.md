...
title: "Syntax"
description: |
  c...c Effect Within a string template ..., a literal text c...c represents the exact character string it displays. Literal text consists of all characters in c that -   are not enclosed in curly brackets   -   are not control characters(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-U
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenstring_templates_literals.htm"
...
-   are not [control characters](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abencontrol_character_glosry.htm "Glossary Entry")
