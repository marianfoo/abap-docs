...
title: "Source Code"
description: |
  Public class definition CLASS cl_demo_sxml_token_wrtr_nsuri DEFINITION INHERITING FROM cl_demo_classrun PUBLIC CREATE PUBLIC. PUBLIC SECTION. METHODS main REDEFINITION. ENDCLASS.  Public class implementation CLASS cl_demo_sxml_token_wrtr_nsuri IMPLEMENTATION. METHOD main. FINAL(writ
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abensxml_renderering_ns_abexa.htm"
...
Namespace declarations in [token-based rendering](https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenabap_sxml_lib_render_token.htm).
