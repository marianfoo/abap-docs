...
description: |
  A system command injection(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abensyst_comm_injection_glosry.htm 'Glossary Entry') is a attack method that can result from insufficiently secure input from outside. A system command injection forwards malicious operating system statements(h
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abensys_comm_injections_scrty.htm"
