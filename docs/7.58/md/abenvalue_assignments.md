...
title: "Assignments"
description: |
  An assignment passes the content of a source to a target data object. The source can be one of the following: -   Data objects(https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abendata_object_glosry.htm 'Glossary Entry') -   Return values or results of functional methods(https://help.s
version: "7.58"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_758_index_htm/7.58/en-US/abenvalue_assignments.htm"
