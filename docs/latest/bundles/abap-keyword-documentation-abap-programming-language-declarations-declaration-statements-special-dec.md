...
- [abendeclarations_spcl.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abendeclarations_spcl.htm)
- [abapinfotypes.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapinfotypes.htm)
...
> **📖 Official SAP Documentation**: [abendeclarations_spcl.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abendeclarations_spcl.htm)
...
**📖 Source**: [abendeclarations_spcl.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abendeclarations_spcl.htm)

### abapinfotypes.htm

> **📖 Official SAP Documentation**: [abapinfotypes.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapinfotypes.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.


**📖 Source**: [abapinfotypes.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapinfotypes.htm)
