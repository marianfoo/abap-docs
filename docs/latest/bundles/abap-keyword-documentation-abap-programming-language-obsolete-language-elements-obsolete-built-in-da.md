...
description: |
  -   Obsolete System Fields(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abensystem_fields_obsolete.htm) -   The Built-In Structure screen(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenscreen_structure_obsolete.htm) Obsolete System Fields(https://help.sa
version: "latest"
category: "oop"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenbuilt_in_obsolete.htm"
...
-   [Obsolete System Fields](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abensystem_fields_obsolete.htm)
-   [The Built-In Structure screen](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenscreen_structure_obsolete.htm)
...
The following [system fields](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abensystem_field_glosry.htm "Glossary Entry") are obsolete and should no longer be used. Many originate from the R/2 era. The transition from R/2 to R/3 retained some system fields which are no longer provided with data.
...
[Spool parameters](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenprint_parameters.htm) are passed from the runtime framework to the spool system in a structure of type PRI\_PARAMS. Before this structure was introduced, [system fields](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abensystem_field_glosry.htm "Glossary Entry") were used. When spooling is activated today, a subset of the structure PRI\_PARAMS is still written to identically named system fields. This information is redundant and should not be used.
...
[Formatting](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenprint_parameters_overview.htm)
...
[Output device](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenprint_parameters_overview.htm)
...
[Retention period](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenprint_parameters_overview.htm)
...
[Name of spool request](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenprint_parameters_overview.htm)
...
[Department name](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenprint_parameters_overview.htm)
...
[Cover sheet](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenprint_parameters_overview.htm)
...
[Number of copies](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenprint_parameters_overview.htm)
...
[Name of the spool file](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenprint_parameters_overview.htm)
...
[Print now](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenprint_parameters_overview.htm)
...
[New spool request](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenprint_parameters_overview.htm)
...
[Recipient name](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenprint_parameters_overview.htm)
...
[Delete now](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenprint_parameters_overview.htm)
...
[Description text](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenprint_parameters_overview.htm)
...
[Title of the spooler program](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenprint_parameters_overview.htm)
