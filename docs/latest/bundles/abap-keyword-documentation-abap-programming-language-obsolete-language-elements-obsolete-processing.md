...
title: "LDB - Examples"
description: |
  -   Example of a logical database(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenldb_example.htm) -   Example of selection include(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenldb_selections_example.htm) -   Example of a database program(https://help
version: "latest"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenldb_examples.htm"
...
description: |
  A logical database TEST_LDB has the structure shown in Example of a Logical Database(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenldb_example.htm). All nodes are database tables. Selections are defined in the selection include: SELECT-OPTIONS SLIFNR  FOR LFA1-LIFNR. SELECT-
version: "latest"
category: "database"
type: "abap-reference"
