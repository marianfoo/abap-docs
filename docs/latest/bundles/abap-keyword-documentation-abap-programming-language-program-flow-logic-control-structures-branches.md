...
- [abenabap_branches.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenabap_branches.htm)
- [abapif.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapif.htm)
- [abapelseif.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapelseif.htm)
- [abapelse.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapelse.htm)
- [abapendif.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapendif.htm)
- [abapcase.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapcase.htm)
- [abapwhen.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapwhen.htm)
- [abapendcase.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapendcase.htm)
- [abapcase_type.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapcase_type.htm)
- [abapwhen_type.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapwhen_type.htm)
- [abencase_type_of_exception_abexa.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencase_type_of_exception_abexa.htm)
- [abencase_type_of_rtti_abexa.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencase_type_of_rtti_abexa.htm)
...
> **📖 Official SAP Documentation**: [abenabap_branches.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenabap_branches.htm)
...
**📖 Source**: [abenabap_branches.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenabap_branches.htm)

### abapif.htm

> **📖 Official SAP Documentation**: [abapif.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapif.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abapif.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapif.htm)

### abapelseif.htm

> **📖 Official SAP Documentation**: [abapelseif.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapelseif.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abapelseif.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapelseif.htm)

### abapelse.htm

> **📖 Official SAP Documentation**: [abapelse.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapelse.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abapelse.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapelse.htm)

### abapendif.htm

> **📖 Official SAP Documentation**: [abapendif.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapendif.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abapendif.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapendif.htm)
...
> **📖 Official SAP Documentation**: [abapcase.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapcase.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abapcase.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapcase.htm)

### abapwhen.htm

> **📖 Official SAP Documentation**: [abapwhen.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapwhen.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abapwhen.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapwhen.htm)

### abapendcase.htm

> **📖 Official SAP Documentation**: [abapendcase.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapendcase.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abapendcase.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapendcase.htm)
...
> **📖 Official SAP Documentation**: [abapcase_type.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapcase_type.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abapcase_type.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapcase_type.htm)

### abapwhen_type.htm

> **📖 Official SAP Documentation**: [abapwhen_type.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapwhen_type.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abapwhen_type.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapwhen_type.htm)

### abencase_type_of_exception_abexa.htm

> **📖 Official SAP Documentation**: [abencase_type_of_exception_abexa.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencase_type_of_exception_abexa.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abencase_type_of_exception_abexa.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencase_type_of_exception_abexa.htm)

### abencase_type_of_rtti_abexa.htm

> **📖 Official SAP Documentation**: [abencase_type_of_rtti_abexa.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencase_type_of_rtti_abexa.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abencase_type_of_rtti_abexa.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencase_type_of_rtti_abexa.htm)
