...
- [abenc1_contract_rules.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_contract_rules.htm)
- [abenc1_provider_rules.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_provider_rules.htm)
- [abenc1_provider_rules_elem.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_provider_rules_elem.htm)
- [abenc1_provider_rules_ddic.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_provider_rules_ddic.htm)
- [abenc1_provider_rules_cds_type.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_provider_rules_cds_type.htm)
- [abenc1_provider_rules_cds_func.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_provider_rules_cds_func.htm)
- [abenc1_provider_rules_cds.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_provider_rules_cds.htm)
- [abenc1_provider_rules_rap.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_provider_rules_rap.htm)
- [abenc1_provider_rules_abap.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_provider_rules_abap.htm)
- [abenc1_consumer_rules.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_consumer_rules.htm)
- [abenc1_consumer_rules_elem.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_consumer_rules_elem.htm)
- [abenc1_consumer_rules_struct.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_consumer_rules_struct.htm)
- [abenc1_demo_1.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_demo_1.htm)
...
> **📖 Official SAP Documentation**: [abenc1_contract_rules.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_contract_rules.htm)
...
**📖 Source**: [abenc1_contract_rules.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_contract_rules.htm)

### abenc1_provider_rules.htm

> **📖 Official SAP Documentation**: [abenc1_provider_rules.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_provider_rules.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abenc1_provider_rules.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_provider_rules.htm)

### abenc1_provider_rules_elem.htm

> **📖 Official SAP Documentation**: [abenc1_provider_rules_elem.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_provider_rules_elem.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abenc1_provider_rules_elem.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_provider_rules_elem.htm)

### abenc1_provider_rules_ddic.htm

> **📖 Official SAP Documentation**: [abenc1_provider_rules_ddic.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_provider_rules_ddic.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abenc1_provider_rules_ddic.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_provider_rules_ddic.htm)

### abenc1_provider_rules_cds_type.htm

> **📖 Official SAP Documentation**: [abenc1_provider_rules_cds_type.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_provider_rules_cds_type.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abenc1_provider_rules_cds_type.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_provider_rules_cds_type.htm)

### abenc1_provider_rules_cds_func.htm

> **📖 Official SAP Documentation**: [abenc1_provider_rules_cds_func.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_provider_rules_cds_func.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abenc1_provider_rules_cds_func.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_provider_rules_cds_func.htm)

### abenc1_provider_rules_cds.htm

> **📖 Official SAP Documentation**: [abenc1_provider_rules_cds.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_provider_rules_cds.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abenc1_provider_rules_cds.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_provider_rules_cds.htm)

### abenc1_provider_rules_rap.htm

> **📖 Official SAP Documentation**: [abenc1_provider_rules_rap.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_provider_rules_rap.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abenc1_provider_rules_rap.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_provider_rules_rap.htm)

### abenc1_provider_rules_abap.htm

> **📖 Official SAP Documentation**: [abenc1_provider_rules_abap.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_provider_rules_abap.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abenc1_provider_rules_abap.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_provider_rules_abap.htm)
...
> **📖 Official SAP Documentation**: [abenc1_consumer_rules.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_consumer_rules.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abenc1_consumer_rules.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_consumer_rules.htm)

### abenc1_consumer_rules_elem.htm

> **📖 Official SAP Documentation**: [abenc1_consumer_rules_elem.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_consumer_rules_elem.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abenc1_consumer_rules_elem.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_consumer_rules_elem.htm)

### abenc1_consumer_rules_struct.htm

> **📖 Official SAP Documentation**: [abenc1_consumer_rules_struct.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_consumer_rules_struct.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abenc1_consumer_rules_struct.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_consumer_rules_struct.htm)

### abenc1_demo_1.htm

> **📖 Official SAP Documentation**: [abenc1_demo_1.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_demo_1.htm)
> **🔍 Direct Link**: This section contains the complete content from the official SAP ABAP documentation page.
...
**📖 Source**: [abenc1_demo_1.htm](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenc1_demo_1.htm)
