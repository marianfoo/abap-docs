...
description: |
  When AMDP(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenamdp_glosry.htm 'Glossary Entry') is used, database procedures are created and called that are currently usually implemented in SQLScript(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abensql_script_g
version: "latest"
category: "database"
type: "abap-reference"
...
description: |
  Generic programming is the most unsafe of all dynamic programming techniques. In principle, the ABAP statement injections(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abengeneric_prog_scrty.htm) cover all individual security risks that can occur in dynamic programming, and most
version: "latest"
category: "database"
type: "abap-reference"
