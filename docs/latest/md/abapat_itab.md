...
-   The addition [STEP](abaploop_at_itab_cond.htm#!ABAP_ADDITION_3@3@) cannot be specified. Also other restricting conditions [cond](javascript:call_link\('abaploop_at_itab_cond.htm'\)) should not be specified. If a condition is specified, it should select consecutive line groups, including the first line in the group where the group break takes place.
