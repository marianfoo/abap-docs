...
keywords: ["do", "if", "try", "method", "class", "data", "internal-table", "abapcall", "proc", "parameter", "tables"]
---
...
The internal table ptab must have the type abap\_parmbind\_tab from the [type pool](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abentype_pool_glosry.htm "Glossary Entry") ABAP and the same applies to passing parameters as in [dynamic method calls](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapcall_method_parameter_tables.htm).
