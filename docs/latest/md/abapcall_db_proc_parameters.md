...
The proxy parameters p1, p2, ... to which the actual procedure parameters are assigned in the mapping of the [database procedure proxies](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abendatabase_proc_proxy_glosry.htm "Glossary Entry") are specified after the additions. The data types of the actual parameters can be determined by referencing the type declarations of the associated [database procedure interfaces](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abendatabase_proc_intf_glosry.htm "Glossary Entry"). The read positions are [general expression positions](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abengeneral_expr_position_glosry.htm "Glossary Entry").