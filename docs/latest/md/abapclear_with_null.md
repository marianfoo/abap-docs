...
description: |
  Short Reference(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapclear_shortref.htm) Obsolete Syntax CLEAR dobj WITH NULL. Effect This variant of the statement CLEAR(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapclear.htm), which is not allowed in ABAP Ob
version: "latest"
category: "general"
type: "abap-reference"
