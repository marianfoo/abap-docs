...
-   The formatting option ALPHA has the same function as the [conversion routines](javascript:call_link\('abenconversion_routine_glosry.htm'\) "Glossary Entry") CONVERSION\_EXIT\_ALPHA\_INPUT or CONVERSION\_EXIT\_ALPHA\_OUTPUT implementing conversion exit [conversion exit](javascript:call_link\('abenconversion_exit_glosry.htm'\) "Glossary Entry") ALPHA.
