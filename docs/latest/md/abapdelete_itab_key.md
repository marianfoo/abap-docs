...
title: "Syntax"
description: |
  ... TABLE itab  FROM wa USING KEY keyname(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenkeyname.htm)    WITH TABLE KEY  keyname(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenkeyname.htm) COMPONENTS comp_name1(name1)
version: "latest"
category: "general"
type: "abap-reference"
