...
title: "Syntax"
description: |
  ...  table_key(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapdelete_itab_key.htm)   index(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapdelete_itab_index.htm) . Effect In this variant, the statement DELETE deletes a line specified by a table
version: "latest"
category: "general"
type: "abap-reference"
...
... *{* [table\_key](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapdelete_itab_key.htm)  *|* [index](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapdelete_itab_index.htm) *}*.

Effect

In this variant, the statement DELETE deletes a line specified by a table key in [table\_key](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapdelete_itab_key.htm) or a line specified by a line number [index](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapdelete_itab_index.htm).
...
Continue
[DELETE itab, table\_key](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapdelete_itab_key.htm)
[DELETE itab, index](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapdelete_itab_index.htm)