...
title: "Use"
description: |
  %msg is a component of BDEF derived types(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenrap_derived_type_glosry.htm 'Glossary Entry'). It is used as a component of the REPORTED RAP response parameter(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenrap_re
version: "latest"
category: "general"
type: "abap-reference"
