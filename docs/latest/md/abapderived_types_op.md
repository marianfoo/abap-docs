...
It is used to summarize derived type components for [standard operations](javascript:call_link\('abenbdl_standard_operations.htm'\)) ([%create](javascript:call_link\('abapderived_types_create.htm'\)), for example), [nonstandard operations](javascript:call_link\('abenbdl_nonstandard.htm'\)) and associations defined in the BDEF in the context of [RAP messages](javascript:call_link\('abenrap_message_glosry.htm'\) "Glossary Entry") and [authorization control](javascript:call_link\('abenrap_auth_control_glosry.htm'\) "Glossary Entry").

For example, if %op-%create is marked in a [RAP response parameter](javascript:call_link\('abenrap_response_param_glosry.htm'\) "Glossary Entry"), it indicates that the message relates to a [RAP create operation](javascript:call_link\('abenrap_create_operation_glosry.htm'\) "Glossary Entry").
