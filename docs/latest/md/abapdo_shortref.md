...
[Reference](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapdo.htm)
...
-   [VARYING dobj FROM dobj1 NEXT dobj2 *\[*RANGE range*\]*](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapdo_varying.htm)
