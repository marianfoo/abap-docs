...
The statement ENDINTERFACE closes an interface definition introduced using [INTERFACE](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapinterface.htm).