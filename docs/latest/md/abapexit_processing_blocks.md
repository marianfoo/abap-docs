...
title: "Syntax"
description: |
  EXIT. Effect If the statement EXIT is outside a loop(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenloop_glosry.htm 'Glossary Entry'), it immediately terminates the current processing block(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenprocessing_block_
version: "latest"
category: "general"
type: "abap-reference"
