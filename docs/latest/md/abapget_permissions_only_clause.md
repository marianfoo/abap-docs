...
Note: For consolidating and interpreting the permission results, see the topic [GET PERMISSIONS, Guidelines](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapget_permissions_rules.htm).
...
Specifies any of above variants dynamically using an [enumeration value](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenenumerated_value_glosry.htm "Glossary Entry") of type T\_PERMISSIONS\_ONLY of interface IF\_ABAP\_BEHV.
