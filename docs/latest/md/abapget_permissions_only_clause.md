...
Note: For consolidating and interpreting the permission results, see the topic [GET PERMISSIONS, Guidelines](javascript:call_link\('abapget_permissions_rules.htm'\)).
...
Specifies any of above variants dynamically using an [enumeration value](javascript:call_link\('abenenumerated_value_glosry.htm'\) "Glossary Entry") of type T\_PERMISSIONS\_ONLY of interface IF\_ABAP\_BEHV.
