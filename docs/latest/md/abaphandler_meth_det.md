...
See the required BDEF notations for both variants in the topic [RAP BDL - determinations](javascript:call_link\('abenbdl_determinations.htm'\)).
...
-   [RAP BDL - determination](javascript:call_link\('abenbdl_determination_abexa.htm'\))