...
-   Method declarations using this syntax are not to be confused with method declarations in the context of [RAP business events](javascript:call_link\('abenrap_entity_event_glosry.htm'\) "Glossary Entry"): [METHODS, FOR ENTITY EVENT](javascript:call_link\('abenmethod_for_entity_event.htm'\))
