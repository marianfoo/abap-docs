...
title: "MINIMUM"
description: |
  Short Reference(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapminimum_shortref.htm) Obsolete Syntax MINIMUM dobj. Effect For each WRITE(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapwrite-.htm) statement that writes the content of the data object dobj
version: "latest"
category: "general"
type: "abap-reference"
...
[Short Reference](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapminimum_shortref.htm)
...
This statement is not allowed in classes because it works with implicitly created global variables. The built-in function [nmin](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abennmax_nmin_functions.htm) can, for example, be used instead.
