...
description: |
  Reference(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapmodify_line.htm) Syntax MODIFY  LINE line OF PAGE pageCURRENT PAGE INDEX idx  CURRENT LINE  LINE VALUE FROM wa FIELD VALUE dobj1 FROM wa1 dobj2
version: "latest"
category: "general"
type: "abap-reference"
