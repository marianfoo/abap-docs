...
[Reference](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapmove-corresponding.htm)
...
-   [EXACT](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapmove_exact.htm)
    The assignment is lossless.
-   [EXPANDING NESTED TABLES](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapmove-corresponding.htm)
    Planned: Tabular components are expanded.
-   [KEEPING TARGET LINES](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapmove-corresponding.htm)
