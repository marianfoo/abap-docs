...
description: |
  Short Reference(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapraise_exception_shortref.htm) Syntax ...  MESSAGE tn(id)   ID mid TYPE mtype NUMBER num  WITH dobj1 ... dobj4    USING MESSAGE  ... Variants: 1. ... MESSAGE msg ...(#!ABAP_VARIANT
version: "latest"
