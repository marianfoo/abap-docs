...
         ENTITY entity1 [operations](javascript:call_link\('abapread_entity_entities_op.htm'\))
        *\[*ENTITY entity2 [operations](javascript:call_link\('abapread_entity_entities_op.htm'\))*\]*
        *\[*...*\]*
