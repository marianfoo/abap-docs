...
description: |
  Short Reference(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapreplace_pattern_shortref.htm) Obsolete Syntax REPLACE substring WITH new INTO dobj IN BYTECHARACTER MODE LENGTH len. Additions: 1. ... IN CHARACTERBYTE MODE(#!ABAP_ADDITION_1@1@
version: "latest"
category: "general"
type: "abap-reference"
...
[Short Reference](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapreplace_pattern_shortref.htm)
...
This variant of the REPLACE statement has been replaced by the variant [REPLACE](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapreplace_in_pattern.htm).
