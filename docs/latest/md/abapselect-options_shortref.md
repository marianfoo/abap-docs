...
description: |
  Reference(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapselect-options.htm) Syntax SELECT-OPTIONS selcrit FOR dobj(name) OBLIGATORYNO-DISPLAY VISIBLE LENGTH vlen NO-EXTENSION NO INTERVALS MODIF ID modid DEFAULT val1
version: "latest"
category: "general"
type: "abap-reference"
