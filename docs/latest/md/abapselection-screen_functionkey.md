...
description: |
  Short Reference(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapselection-screen_shortref.htm) Syntax SELECTION-SCREEN FUNCTION KEY n ldb_additions(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapselection-screen_ldb_additions.htm). Effect In the
version: "latest"
category: "ui"
type: "abap-reference"
...
SELECTION-SCREEN FUNCTION KEY n *\[*[ldb\_additions](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapselection-screen_ldb_additions.htm)*\]*.

Effect

In the GUI status of the [selection screen](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenselection_screen_glosry.htm "Glossary Entry") set by the system, the [application toolbar](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenapplication_toolbar_glosry.htm "Glossary Entry") contains five inactive [pushbuttons](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenpushbutton_glosry.htm "Glossary Entry"), to which the function codes FC01 to FC05 are assigned. This statement activates the pushbutton of the function code FC0n, where a value between 1 and 5 must be specified for n.

To enable use of the pushbuttons, the statement [TABLES](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abaptables.htm) can be used to declare an [interface work area](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abeninterface_work_area_glosry.htm "Glossary Entry") of the structure SSCRFIELDS from the ABAP Dictionary.
...
When the user chooses a pushbutton in the application toolbar, the runtime framework raises the event [AT SELECTION-SCREEN](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapat_selection-screen.htm) and the associated function code is passed to the component ucomm of the interface work area sscrfields.
...
-   If the content of the component ucomm is set to a function code used in the GUI status during selection screen processing, the [selection screen processing](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenselscreen_processing_glosry.htm "Glossary Entry") is modified accordingly.
...
[Selection Screens, Pushbuttons in the Application Toolbar](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenselscreen_pb_bar_abexa.htm)

Continue
![Example](exa.gif "Example") [Selection Screens -Pushbuttons in the Toolbar](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenselscreen_pb_bar_abexa.htm)