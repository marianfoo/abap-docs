...
description: |
  Short Reference(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapselection-screen_shortref.htm) Syntax SELECTION-SCREEN SKIP n ldb_additions(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapselection-screen_ldb_additions.htm). Effect This st
version: "latest"
category: "ui"
type: "abap-reference"
