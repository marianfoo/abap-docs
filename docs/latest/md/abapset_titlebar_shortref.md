...
[Reference](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapset_titlebar_dynpro.htm)
...
-   [OF PROGRAM prog](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapset_titlebar_dynpro.htm)
    Specifies the program prog in which the GUI title is defined.
-   [WITH text1 ... text9](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapset_titlebar_dynpro.htm)
