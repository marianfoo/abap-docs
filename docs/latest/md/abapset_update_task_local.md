...
-   The example [Demonstrating the SAP LUW](javascript:call_link\('abensap_luw_bundl_tech_abexa.htm'\)) demonstrates the SAP LUW, covering the SET UPDATE TASK LOCAL statement.