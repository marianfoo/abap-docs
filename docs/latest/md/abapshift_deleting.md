...
description: |
  Short Reference(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapshift_shortref.htm) Syntax ...  LEFT DELETING LEADING  RIGHT DELETING TRAILING  mask ... Effect If these additions are used, the statement SHIFT shifts the content of dobj by one place to the l
version: "latest"
category: "general"
type: "abap-reference"
