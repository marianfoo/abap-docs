...
description: |
  Short Reference(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapshift_shortref.htm) Syntax ... LEFTRIGHT CIRCULAR ... Additions: 1. ... LEFTRIGHT(#!ABAP_ADDITION_1@1@) 2. ... CIRCULAR(#!ABAP_ADDITION_2@2@) Addition 1 ... LEFTRIGHT Effect The shift
version: "latest"
category: "general"
type: "abap-reference"
...
This example is a variant of the second example under [places](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapshift_places.htm). Using the addition CIRCULAR makes the result you know I know.
