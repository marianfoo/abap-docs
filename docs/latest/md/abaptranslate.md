...
title: "TRANSLATE"
description: |
  Short Reference(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abaptranslate_shortref.htm) Syntax TRANSLATE text TO UPPERLOWER CASE  USING mask. Additions: 1. ... TO UPPERLOWER CASE(#!ABAP_ADDITION_1@1@) 2. ... USING mask(#!ABAP_ADDITION_2@2@
version: "latest"
category: "general"
type: "abap-reference"
...
[Short Reference](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abaptranslate_shortref.htm)
...
To change the case of the letters in a character string in an operand position, a [case function](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencase_functions.htm) can be used that includes the functions of the statement TRANSLATE.
...
To translate a character string in an operand position, a [translate function](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abentranslate_functions.htm) that includes the functions of the statement TRANSLATE can also be used.
