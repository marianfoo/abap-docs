...
title: "TYPES, REF TO"
description: |
  Short Reference(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abaptypes_shortref.htm) Syntax TYPES ref_type  TYPE REF TO type  LIKE REF TO dobj . Effect The addition REF TO defines a data type for a reference variable(https://help.sap.com/doc/abapdocu_late
version: "latest"
category: "types"
type: "abap-reference"
