...
-   Unlike in the [asXML representation](javascript:call_link\('abenabap_xslt_asxml_table.htm'\)) of internal tables, asJSON does not require a name like item for the table lines.
