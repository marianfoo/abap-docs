...
description: |
  This section describes the ABAP language elements for providing and consuming RAP business objects (RAP BOs)(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenrap_bo_glosry.htm 'Glossary Entry'). A RAP BO is mainly defined by a RAP behavior definition (BDEF)(https://help.sap.co
version: "latest"
category: "oop"
type: "abap-reference"
