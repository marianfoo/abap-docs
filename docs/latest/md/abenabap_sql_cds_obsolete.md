...
description: |
  Obsolete Syntax SELECT ... FROM cds_db_view ... Effect Specifies a CDS DDIC-based view (obsolete)(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencds_v1_view_glosry.htm 'Glossary Entry') that is associated with a CDS-managed DDIC view(https://help.sap.com/doc/abapdocu_lates
version: "latest"
category: "database"
type: "abap-reference"
