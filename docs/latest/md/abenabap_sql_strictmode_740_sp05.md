...
description: |
  The strict mode of the syntax check in ABAP release 7.40, SP05 applies to all ABAP SQL statements that use one of the following features introduced in ABAP release 7.40 SP05(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abennews-740_sp05-abap_sql.htm): -   Lists of operands as co
version: "latest"
category: "general"
type: "abap-reference"
