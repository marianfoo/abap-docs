...
The strict mode of the syntax check in ABAP release 7.40, SP05 applies to all ABAP SQL statements that use one of the following features introduced in [ABAP release 7.40 SP05](javascript:call_link\('abennews-740_sp05-abap_sql.htm'\)):
