...
The following lines show the general format of the [canonical XML](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencanonical_xml_represent_glosry.htm "Glossary Entry") representation without the XML header, whereby line breaks and indents were inserted for clarification purposes only.
...
[Example of an Identity Transformation](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenxslt_abexa.htm)