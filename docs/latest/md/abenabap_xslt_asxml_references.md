...
-   The asXML representation of reference variables and referenced objects is only of relevance for [XSL](javascript:call_link\('abenid_trafo_glosry.htm'\) "Glossary Entry") transformations and the identity transformation ID. You cannot currently use Simple Transformations to transform reference variables.
