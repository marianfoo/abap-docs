...
title: "Syntax"
description: |
  Syntax for unmanaged(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenbdl_impl_type.htm) scenarios. The adjust_numbers method is only available for late numbering(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenbdl_late_numbering.htm) scenarios. See more m
version: "latest"
category: "general"
type: "abap-reference"
