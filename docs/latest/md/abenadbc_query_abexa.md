...
title: "ADBC - Query"
description: |
  This example demonstrates the execution of a query(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenadbc_query.htm) with ADBC. Source Code  Public class definition CLASS cl_demo_adbc_query DEFINITION PUBLIC INHERITING FROM cl_demo_classrun CREATE PUBLIC . PUBLIC SECTION.
version: "latest"
category: "general"
type: "abap-reference"
...
This example demonstrates the execution of a [query](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenadbc_query.htm) with ADBC.
...
Quotation marks are escaped in the user input to prevent [SQL injections](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abensql_injection_glosry.htm "Glossary Entry").