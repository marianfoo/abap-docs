...
description: |
  ABAP daemon processing(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenabap_daemon_processing_glosry.htm 'Glossary Entry') is event-driven. To prevent an ABAP daemon session(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenabap_daemon_session_glosry.htm 'Gl
version: "latest"
category: "general"
type: "abap-reference"
