...
description: |
  This example demonstrates how messages are sent using AMC(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenamc_glosry.htm 'Glossary Entry'). Source Code  Public class definition CLASS cl_demo_send_amc DEFINITION INHERITING FROM cl_demo_classrun PUBLIC CREATE PUBLIC. PUBLI
version: "latest"
category: "general"
type: "abap-reference"
