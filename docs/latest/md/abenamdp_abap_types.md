...
-   All elementary types that are defined with [TYPES](javascript:call_link\('abaptypes.htm'\)) and that are visible at this place. These can be types of the own class, a different class or an interface.
