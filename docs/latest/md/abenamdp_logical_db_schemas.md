...
description: |
  Syntax ... '$ABAP.schema( name = schema_name quote = SINGLEDOUBLE )' ... Effect Specifies the predefined AMDP macro(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenamdp_macro_glosry.htm 'Glossary Entry') $ABAP.schema(https://help.sap.com/doc/abapdocu_latest_
version: "latest"
category: "general"
type: "abap-reference"
