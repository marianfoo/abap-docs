...
description: |
  AMHC for short. Special HDI container(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenhdi_container_glosry.htm 'Glossary Entry') managed by AS ABAP(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenas_abap_glosry.htm 'Glossary Entry'). An AMHC is created and
version: "latest"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenamhc_glosry.htm"
