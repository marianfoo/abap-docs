...
description: |
  No authorization checks can be performed during an update(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenupdate_glosry.htm 'Glossary Entry'), that is, when processing an update function module(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenupdate_functio
version: "latest"
category: "general"
type: "abap-reference"
