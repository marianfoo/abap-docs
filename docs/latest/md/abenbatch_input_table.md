...
description: |
  A batch input table(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenbatch_input_table_glosry.htm 'Glossary Entry') of the line type(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenrow_type_glosry.htm 'Glossary Entry') BDCDATA, which is specified after the
version: "latest"
