...
description: |
  Syntax define behavior for ProjectedEntity alias AliasName external ExternalName implementation in class ClassName unique(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenbdl_in_class_unique.htm) entity behavior characteristics(https://hel
version: "latest"
category: "general"
type: "abap-reference"
