...
Continue
[RAP - Entity Behavior Characteristics, Projection BDEF](javascript:call_link\('abenbdl_character_projection.htm'\))
[RAP - Entity Behavior Body, Projection BDEF](javascript:call_link\('abenbdl_body_projection.htm'\))