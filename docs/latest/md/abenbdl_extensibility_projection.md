...
description: |
  A BDEF projection extension(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenrap_projec_bdef_ext_glosry.htm 'Glossary Entry') is a repository object that extends a RAP projection behavior definition(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencds_proj_b
version: "latest"
category: "general"
type: "abap-reference"
