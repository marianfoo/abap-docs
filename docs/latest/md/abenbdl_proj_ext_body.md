...
title: "Syntax"
description: |
  ... field characteristics; use; actions and functions; mapping for; extend mapping for; Effect Defines the behavior extension body(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenrap_behavior_ext_body_glosry.htm 'Glossary Entry') to exten
version: "latest"
category: "general"
type: "abap-reference"
