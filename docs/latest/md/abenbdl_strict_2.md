...
title: "Effect"
description: |
  The addition strict(2) enables BDEF strict mode(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenrap_strict_mode_glosry.htm 'Glossary Entry'), version 2. When strict mode is switched on, outdated syntax which normally produces a syntax check warning leads to a syntax check error
version: "latest"
category: "general"
type: "abap-reference"
