...
[Byte field type](javascript:call_link\('abenbyte_field_type_glosry.htm'\) "Glossary Entry")
...
[Byte string type](javascript:call_link\('abenbyte_string_type_glosry.htm'\) "Glossary Entry")
