...
The [C0 contract](javascript:call_link\('abenc0_contract_glosry.htm'\) "Glossary Entry") is the [release contract](javascript:call_link\('abenrelease_contract_glosry.htm'\) "Glossary Entry") that is crucial for [C0 developer extensibility](javascript:call_link\('abendev_extensibility_glosry.htm'\) "Glossary Entry"). It ensures stability at dedicated extension points to allow for a certain extensibility of repository objects. The following sections describe the C0 rules for different kinds of development objects.
...
-   A list of all transportable [released APIs](javascript:call_link\('abenreleased_api_glosry.htm'\) "Glossary Entry") can be found in the topic [Released APIs](javascript:call_link\('abenreleased_apis.htm'\)).
