...
The following [append structure](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenappend_structure_glosry.htm "Glossary Entry") DEMO\_STRUCTURE\_EXTEND extends the DDIC structure DEMO\_RELEASED\_API displayed above. It complies with the naming rules, using a namespace prefix and the mandatory field suffix EMO.
