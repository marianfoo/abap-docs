...
The following [append structure](javascript:call_link\('abenappend_structure_glosry.htm'\) "Glossary Entry") DEMO\_STRUCTURE\_EXTEND extends the DDIC structure DEMO\_RELEASED\_API displayed above. It complies with the naming rules, using a namespace prefix and the mandatory field suffix EMO.
