...
description: |
  This example demonstrates the possible XML targets of the statement CALL TRANSFORMATION(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapcall_transformation.htm). Source Code  Public class definition CLASS cl_demo_call_trafo_xml_results DEFINITION INHERITING FROM cl_demo
version: "latest"
category: "general"
type: "abap-reference"
