...
-   Context-dependent rules apply when specifying the operands lhs and rhs. For further details, see topic [CDS DDL - CDS View Entity, cds\_cond, Operands](javascript:call_link\('abencds_cond_expr_operands_v2.htm'\)).
