...
title: "Hint"
description: |
  For comparisons(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencds_cond_expr_comp_v1.htm), the tables of comparable types(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencds_cond_expr_types_v1.htm) show which data types can be compared with each other.
version: "latest"
category: "general"
type: "abap-reference"
...
The following rules apply to the operands lhs and rhs in relational expressions of the SELECT statement in a [CDS DDIC-based view (obsolete)](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencds_v1_view_glosry.htm "Glossary Entry"):
...
-   Special Context-Specific Rules:
    -   [Rules](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencds_cond_expr_where_v1.htm) for use in a WHERE condition
    -   [Rules](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencds_cond_expr_having_v1.htm) for use in a HAVING condition
    -   [Rules](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencds_joined_data_source_v1.htm) for use in an ON condition of a join expression
    -   [Rules](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencds_cond_expr_on_assoc_v1.htm) for use in an ON condition of a CDS association
    -   [Rules](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencds_cond_expr_filter_v1.htm) for use in a filter condition of a path expression
    -   [Rules](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencds_cond_expr_case_v1.htm) for use in a complex case distinction.
