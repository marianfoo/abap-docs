...
Defines the CDS view demo\_business\_partner\_1 for the DDIC database table snwd\_bpa, for which an alternative name partner is specified. This name is used in the [SELECT list](javascript:call_link\('abencds_select_list_v1.htm'\)).
