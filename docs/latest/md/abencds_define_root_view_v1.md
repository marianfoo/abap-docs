...
-   The definition of a root entity can use [COMPOSITION](javascript:call_link\('abencds_composition_v1.htm'\)) to specify [to-child associations](javascript:call_link\('abento_child_association_glosry.htm'\) "Glossary Entry") to [child entities](javascript:call_link\('abenchild_entity_glosry.htm'\) "Glossary Entry") of the business object.
