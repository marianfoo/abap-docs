...
description: |
  Syntax ... ROOT ... Effect The addition ROOT defines the CDS view entity(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencds_v2_view_glosry.htm 'Glossary Entry') view_entity as the root entity of a RAP business object(https://help.sap.com/doc/abapdocu_latest_index_htm/latest
version: "latest"
category: "cds"
type: "abap-reference"
