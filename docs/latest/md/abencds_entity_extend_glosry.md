...
A transportable extension of a [CDS entity](javascript:call_link\('abencds_entity_glosry.htm'\) "Glossary Entry"). A CDS entity extension can be used to add elements and/or clauses to a CDS entity without making any modifications to the original entity.
...
-   [EXTEND VIEW](javascript:call_link\('abencds_extend_view.htm'\)) [CDS DDIC-based view extension](javascript:call_link\('abencds_view_extend_glosry.htm'\) "Glossary Entry") for a [CDS DDIC-based view (obsolete)](javascript:call_link\('abencds_v1_view_glosry.htm'\) "Glossary Entry").
