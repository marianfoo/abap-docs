...
description: |
  Elements of CDS entities are linked with an authorization object(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenauthorization_object_glosry.htm 'Glossary Entry') in PFCG conditions(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencds_f1_cond_pfcg.htm) in t
version: "latest"
category: "cds"
type: "abap-reference"
