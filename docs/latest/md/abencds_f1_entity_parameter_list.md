...
The class CL\_DEMO\_CDS\_ABSTRCT\_ENTTY\_PARA shows that the parameter annotations of the CDS abstract entity can be [evaluated](javascript:call_link\('abencds_annotations_analysis.htm'\)) using the class CL\_DD\_DDL\_ANNOTATION\_SERVICE.