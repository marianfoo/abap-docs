...
... [element1](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencds_proj_view_element.htm), [element2](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencds_proj_view_element.htm), ...

Effect

Defines the [elements](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencds_proj_view_element.htm) of a CDS projection view of type transactional query. The elements are specified in a comma-separated list in curly brackets { }.
...
Continue
[CDS DDL - proj\_element, Transactional Query](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencds_proj_view_element.htm)