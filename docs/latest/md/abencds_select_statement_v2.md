...
description: |
  Syntax SELECT DISTINCT FROM data_source(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencds_data_source_v2.htm)  association1(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencds_simple_association_v2.htm) association2(https://help.sap.com/do
version: "latest"
category: "cds"
type: "abap-reference"
