...
description: |
  Syntax ... dtype(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencds_typing.htm)'...' Effect Typed literal(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abentyped_literal_glosry.htm 'Glossary Entry') in a SELECT statement(https://help.sap.com/doc/abapdocu_
version: "latest"
category: "cds"
type: "abap-reference"
...
keywords: ["select", "do", "if", "case", "try", "class", "data", "types", "abencds", "typed", "literal"]
---
...
... [dtype](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencds_typing.htm)'...'

Effect

[Typed literal](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abentyped_literal_glosry.htm "Glossary Entry") in a [SELECT statement](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencds_select_statement_v2.htm) of a [CDS view entity](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencds_v2_view_glosry.htm "Glossary Entry"). Typed literals can be created for all [built-in ABAP Dictionary types](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenddic_builtin_types.htm) with the exception of LCHR, LRAW, GEOM\_EWKB, PREC, ACCP, DF16\_SCL, DF34\_SCL, and VARC. A typed literal can be used in all operand positions where this is documented.

[dtype](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencds_typing.htm) is the name of a [built-in dictionary type](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencds_typing.htm) with the type namespace abap. and it is followed by the character-like representation of the value in single quotes ('). Only those values can be specified that are accepted by the data type of the literal. Length and decimal places are derived from the literal value, they must not be explicitly specified.
...
-   Currently, typed literals are available in CDS view entities and in CDS hierarchies in all operand positions where untyped literals are possible with one exception: typed literals are not supported in the [ON condition of a CDS association](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencds_simple_association_v2.htm).
...
-   A literal prefixed with a sign is never interpreted as an [arithmetic expression](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencds_arithmetic_expression_v2.htm).
...
The class CL\_DEMO\_CDS\_CHAR\_TYPED\_LIT accesses the view and demonstrates the following:
