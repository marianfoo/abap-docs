...
The class CL\_ABAP\_DIFF compares the content of compatible [index tables](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenindex_table_glosry.htm "Glossary Entry") and returns information about any differences found.
...
Continue
![Example](exa.gif "Example") [itab - Using CL\_ABAP\_DIFF](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencl_abap_diff_abexa.htm)