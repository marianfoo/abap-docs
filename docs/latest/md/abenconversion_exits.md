...
description: |
  A conversion exit(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenconversion_exit_glosry.htm 'Glossary Entry') overrides standard conversions that take place when values are passed from an ABAP data object to a dynpro field or from a dynpro field to an ABAP data object and in t
version: "latest"
category: "general"
type: "abap-reference"
