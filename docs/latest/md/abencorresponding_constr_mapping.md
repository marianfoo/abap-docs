...
... *\[* MAPPING *{*t1 = s1 *\[* [duplicates](javascript:call_link\('abencorresponding_constr_dupl.htm'\))*\]**}* *|*
                 ( t1 = s1 *\[* [duplicates](javascript:call_link\('abencorresponding_constr_dupl.htm'\))*\]* *\[*MAPPING ...*\]* *\[*EXCEPT ...*\]* ) *|*
                 *{*t1 = *\[*s1*\]* DEFAULT expr*}*
              *{*t2 = s2 *\[* [duplicates](javascript:call_link\('abencorresponding_constr_dupl.htm'\))*\]**}* *|*
                 ( t2 = s2 *\[* [duplicates](javascript:call_link\('abencorresponding_constr_dupl.htm'\))*\]* *\[*MAPPING ...*\]* *\[*EXCEPT ...*\]* ) *|*
                 *{*t2 = *\[*s2*\]* DEFAULT expr*}*
              ...  *\]*
    *\[* EXCEPT *{*ti tj ...*}**|*\* *\]* ...
...
-   It is best to use the component operator for mapping tasks that can be solved using either the component operator or [table comprehensions](javascript:call_link\('abentable_comprehension_glosry.htm'\) "Glossary Entry").
-   For the latter, see the [executable example](javascript:call_link\('abencorresponding_vs_for_abexa.htm'\)).
...
The addition DEFAULT allows the assignment of values for a target component based on an [expression](javascript:call_link\('abenexpression_glosry.htm'\) "Glossary Entry") expr. The expression is evaluated before the CORRESPONDING expression.
