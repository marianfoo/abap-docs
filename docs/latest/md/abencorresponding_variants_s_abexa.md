...
description: |
  This example demonstrates variants of statements with MOVE-CORRESPONDING(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapmove-corresponding.htm) and the CORRESPONDING(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenconstructor_expr_corresponding.htm) opera
version: "latest"
category: "general"
type: "abap-reference"
