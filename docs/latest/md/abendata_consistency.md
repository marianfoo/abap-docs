...
For an [AS ABAP](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenas_abap_glosry.htm "Glossary Entry") two types of LUWs play a role:

-   [Database LUWs](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abendb_transaction.htm) realized by the database system
-   [SAP LUWs](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abensap_luw.htm) realized using special ABAP programming techniques

Accordingly, there are two lock types that are of significance:

-   [Database locks](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abendb_lock.htm) set by the system
-   [SAP locks](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abensap_lock.htm) set using special ABAP programming techniques

Hint

The [authorizations](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenbc_authority_check.htm) of a user when accessing data are also relevant for data consistency. The statement [AUTHORITY-CHECK](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapauthority-check.htm) is used for explicit authorization checks in ABAP programs. [ABAP CDS](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenabap_cds_glosry.htm "Glossary Entry") also offers its own [access control](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencds_access_control_glosry.htm "Glossary Entry") based on implicit evaluations of [access conditions](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenaccess_condition_glosry.htm "Glossary Entry").
...
[Database Locks](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abendb_lock.htm)
[SAP Locks](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abensap_lock.htm)