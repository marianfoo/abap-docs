...
description: |
  The following dictionary data types are available to describe numeric types, except for decimal floating point numbers: -   INT1(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenddic_builtin_types.htm), INT2(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abend
version: "latest"
category: "types"
type: "abap-reference"
