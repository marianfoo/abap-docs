...
description: |
  The content of a data object pointed to by a data reference(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abendata_reference_type.htm) is accessed using the dereferencing operator: dref-> The dereferencing operator -> can be specified after a data reference variable(https:
version: "latest"
category: "general"
type: "abap-reference"
