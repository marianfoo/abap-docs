...
The possible [arithmetic operators](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenarith_operators.htm) are applied to numbers that can be entered.