...
title: "Syntax"
description: |
  ... escape( val = text(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenstring_functions_val.htm) format = format ) ... Effect This built-in function(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenbuilt_in_functions.htm) returns the content of the characte
version: "latest"
category: "general"
type: "abap-reference"
