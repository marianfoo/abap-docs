...
description: |
  A class-based exception occurs in a statement block for one of the following reasons: -   The exception is raised explicitly using the statement RAISE EXCEPTION(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapraise_exception_class.htm) or the addition THROW(https://help.sap.c
version: "latest"
category: "oop"
type: "abap-reference"
