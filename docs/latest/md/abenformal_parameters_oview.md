...
description: |
  The parameter interface of a procedure consists of formal parameters(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenformal_parameter_glosry.htm 'Glossary Entry') and specifies the possible exceptions(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenexcepti
version: "latest"
category: "oop"
type: "abap-reference"
