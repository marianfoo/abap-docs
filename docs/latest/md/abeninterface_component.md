...
description: |
  The following declaration statements are possible in interfaces for components: -   TYPES(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abaptypes.htm), DATA(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapdata.htm), CLASS-DATA(https://help.sap.com/doc/abap
version: "latest"
category: "oop"
type: "abap-reference"
