...
description: |
  A line feed (LF) is a control character(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencontrol_character_glosry.htm 'Glossary Entry') that positions the cursor when writing an output. Other of such control characters are return (CR from carriage return) or a tabulator. There a
version: "latest"
category: "general"
type: "abap-reference"
