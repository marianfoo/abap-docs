...
description: |
  Syntax ...  '...' & '...' & '...' ...     `...` & `...` & `...` ...   ... Effect The literal operator & can be used to combine two character literals(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenuntyped_character_literals.
version: "latest"
category: "general"
type: "abap-reference"
