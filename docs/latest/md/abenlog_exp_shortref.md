...
[Reference](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenlogexp.htm)
...
Logical expression for formulating a condition for operands. A logical expression is a [relational expression](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenrelational_expression_glosry.htm "Glossary Entry") or multiple combined relational expressions, where [( )](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenlogexp_bracket.htm) can be used as parentheses. The result is a [truth value](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abentruth_value_glosry.htm "Glossary Entry").

Additions   

-   [\=*|*EQ*|*<>*|*NE*|*\>*|*GT*|*<*|*LT*|*\>=*|*GE*|*<=*|*LE](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenlogexp_any_operand.htm)
...
-   [O*|*Z*|*M](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenlogexp_bitmasks.htm)
...
-   [operand *\[*NOT*\]* IN range\_tab](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenlogexp_select_option.htm)
    Comparison expression used to check whether an operand meets the conditions of a [ranges table](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenranges_table_glosry.htm "Glossary Entry") range\_tab.
...
-   [IS *\[*NOT*\]* INSTANCE OF class*|*intf](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenlogexp_instance_of.htm)
...
-   [IS *\[*NOT*\]* REQUESTED](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenlogexp_requested.htm)
    Obsolete: Predicate expression used to check whether an output parameter para of a [procedure](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenprocedure_glosry.htm "Glossary Entry") is requested
-   [contains, contains\_...](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencontains_functions.htm)
...
-   [EQUIV](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenlogexp_and.htm)
