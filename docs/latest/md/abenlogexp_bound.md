...
title: "Syntax"
description: |
  ... ref IS NOT BOUND ... Effect This predicate expression checks whether a reference variable contains a valid reference. A reference variable(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenreference_variable_glosry.htm 'Glossary Entry') must be specified for ref. This
version: "latest"
category: "general"
type: "abap-reference"
