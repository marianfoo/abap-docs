...
-   [Introducing ABAP Objects in ABAP Release 4.5](javascript:call_link\('abennews-40-objects.htm'\))
-   [Runtime Analysis in ABAP Release 4.5](javascript:call_link\('abennews-45-se30.htm'\))
