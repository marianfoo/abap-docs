...
The documentation about [Simple Transformations](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenabap_st.htm) was integrated into the ABAP keyword documentation.