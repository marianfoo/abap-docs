...
In ABAP release 7.51, a new [ABAP version](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenabap_version_glosry.htm "Glossary Entry") [Static ABAP with restricted object use](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenabap_static_restr_glosry.htm "Glossary Entry") was introduced. The internal version ID in column UCCHECK of system table TRDIR is 3.