...
The following [exceptions in IMPORT](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenrabax_import_from_database.htm) were previously non-catchable but are now assigned to the exception class CX\_SY\_IMPORT\_FORMAT\_ERROR and hence can be handled:
