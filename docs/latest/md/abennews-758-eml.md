...
-   [RAISE ENTITY EVENT](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapraise_entity_event.htm)
    ...
    Raises a [RAP business event](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenrap_entity_event_glosry.htm "Glossary Entry").
    
-   [METHODS, FOR ENTITY EVENT](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenmethod_for_entity_event.htm)
    
    Supports [RAP event handler method](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenrap_event_handler_meth_glosry.htm "Glossary Entry") definitions.
    
-   [CLASS, FOR EVENTS OF](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenclass_for_events.htm)
    
    Support the creation of [RAP event handler classes](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenrap_event_handler_class_glosry.htm "Glossary Entry").
...
-   [Classifying APIs for Transactional Consistency](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapapi_classification.htm)
