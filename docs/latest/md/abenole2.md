...
All automation applications that can be used from ABAP are contained in the database table TOLE, which is maintained using transaction SOLE. This table contains the names of the classes and components supported by the [ABAP runtime framework](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenabap_runtime_frmwk_glosry.htm "Glossary Entry"). It also contains type information for adapting different data formats. The automation command set consists of the following ABAP statements:
...
Continue
[CREATE OBJECT, OLE](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapcreate_object_ole2.htm)
[CALL METHOD, OLE](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapcall_method_ole2.htm)
[GET PROPERTY, OLE](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapget_property.htm)
[SET PROPERTY, OLE](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapset_property.htm)
[FREE OBJECT, OLE](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapfree_object.htm)