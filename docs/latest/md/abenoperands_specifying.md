...
description: |
  There are three ways to specify the names of operands(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenoperands_names.htm): -   Static Specification(#abenoperands-specifying-1-------dynamic-specification-in-parentheses---@ITOC@@ABENOPERANDS_SPECIFYING_2) -   Dynamic Specifica
version: "latest"
category: "general"
type: "abap-reference"
...
There are three ways to specify the [names of operands](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenoperands_names.htm):
