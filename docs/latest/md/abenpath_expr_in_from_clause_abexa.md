...
description: |
  This example demonstrates path expressions(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenabap_sql_path.htm) in the FROM clause(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapfrom_clause.htm) in ABAP SQL. Source Code  Public class definition CLASS cl_
version: "latest"
category: "general"
type: "abap-reference"
