...
title: "PXA"
description: |
  Short for Program Execution Area. Memory for managing the fixed data of a running ABAP program. The PXA notably contains the byte codes(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenbytecode_glosry.htm 'Glossary Entry') of all programs running simultaneously on an AS instanc
version: "latest"
category: "general"
type: "abap-reference"
