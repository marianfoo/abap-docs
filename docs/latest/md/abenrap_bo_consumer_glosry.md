...
description: |
  Software that consumes the implementation of a RAP BO(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenrap_bo_glosry.htm 'Glossary Entry'). A RAP BO consumer is either the RAP transactional engine(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenrap_transac_
version: "latest"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenrap_bo_consumer_glosry.htm"
