...
description: |
  A message(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenrap_message_glosry.htm 'Glossary Entry') in the reported(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapeml_response.htm) RAP response parameter(https://help.sap.com/doc/abapdocu_latest_index_htm
version: "latest"
category: "general"
type: "abap-reference"
