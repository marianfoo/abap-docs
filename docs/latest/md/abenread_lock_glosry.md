...
[Area lock](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenarea_lock_glosry.htm "Glossary Entry") on an [area instance version](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenarea_instance_version_glosry.htm "Glossary Entry") in the [shared objects memory](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenshared_objects_memory_glosry.htm "Glossary Entry"). A read lock enables read accesses to the area instance version.
