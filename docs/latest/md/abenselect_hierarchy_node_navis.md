...
Call of the hierarchy navigator HIERARCHY\_SIBLINGS in the class CL\_DEMO\_HIERARCHY\_NAVIGATORS, where the [CTE hierarchy](javascript:call_link\('abencte_hierarchy_glosry.htm'\) "Glossary Entry") +hierarchy is specified a source. When executed, this class demonstrates how this hierarchy navigator works. It also displays the value of the additional hierarchy column HIERARCHY\_SIBLING\_DISTANCE.
