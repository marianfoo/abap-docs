...
description: |
  This example demonstrates how internal tables are sorted using SORT itab(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapsort_itab.htm). Source Code  Public class definition CLASS cl_demo_int_tbls_sort DEFINITION INHERITING FROM cl_demo_classrun PUBLIC CREATE PUBLIC. PU
version: "latest"
...
This example demonstrates how internal tables are sorted using [SORT itab](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapsort_itab.htm).
