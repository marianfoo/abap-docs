...
title: "Continue"
description: |
  !Example(exa.gif 'Example') sql_agg - Aggregate Function string_agg(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abensql_expr_string_agg_abexa.htm) !Example(exa.gif 'Example') sql_agg - Use in Aggregate Expressions(https://help.sap.com/doc/abapdocu_latest_index_htm/late
version: "latest"
category: "general"
type: "abap-reference"
sourceUrl: "https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abensql_agg_expr_abexas.htm"
...
Continue
![Example](exa.gif "Example") [sql\_agg - Aggregate Function string\_agg](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abensql_expr_string_agg_abexa.htm)
![Example](exa.gif "Example") [sql\_agg - Use in Aggregate Expressions](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abensql_expr_in_aggregates_abexa.htm)
![Example](exa.gif "Example") [sql\_exp - Aggregate Expressions in SQL Expressions](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abensql_expr_aggr_in_expr_abexa.htm)
![Example](exa.gif "Example") [sql\_agg - Aggregate Function ALLOW\_PRECISION\_LOSS](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abensql_expr_aggr_prec_loss_abexa.htm)