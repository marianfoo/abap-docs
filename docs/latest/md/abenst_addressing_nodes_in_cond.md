...
For addressing data nodes in [logical expressions](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenst_tt_cond.htm), a special rule applies. Data nodes as dnode operands of [preconditions](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenst_using.htm), [assertions](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenst_data.htm), or [conditions](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenst_check.htm) can be specified as follows:
