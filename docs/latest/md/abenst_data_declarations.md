...
description: |
  In ST programs, data can be declared using the following statements: -   tt:root(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenst_tt_root.htm) defines data roots for binding ABAP data interfaces. -   tt:parameter(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-
version: "latest"
category: "general"
type: "abap-reference"
