...
This example passes various types of ABAP data to the transformation DEMO\_ST\_REGIME\_OPTION and displays the result for XML and [JSON](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenabap_json.htm). The transformation applies the option [regime](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenst_option_format.htm) to the ABAP data:
...
The transformation creates [JSON-XML](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenjson_xml_glosry.htm "Glossary Entry") to represent both XML and JSON. The example shows the following:

-   Source Field of Type t
    -   Normal [asXML](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenabap_xslt_asxml_elementary.htm) representation according to the XML schema type xsd:time.
...
-   Source field of type n with length 3
    -   Normal [asXML](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenabap_xslt_asxml_elementary.htm) representation according to the XML schema type xsd:string (pattern \[0-9\]+).
