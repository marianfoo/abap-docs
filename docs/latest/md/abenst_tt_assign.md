...
title: "Syntax"
description: |
  <tt:assign to-ref='node'to-var='variable' ref='node'val='value'var='variable' /> Effect The statement tt:assign is used to assign a value to a data root(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenst_tt_root.htm), a variable(https://help.sap.com/d
version: "latest"
category: "general"
type: "abap-reference"
...
The statement tt:assign is used to assign a value to a [data root](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenst_tt_root.htm), a [variable](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenst_tt_variable.htm), or a [parameter](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenst_tt_parameter.htm).

to-ref or to-var is used to specify the target field, and ref, val, or var to specify the source field. If no target field or no source field is specified, the [current node](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenst_tt_ref.htm) is used implicitly. Target and source fields can be:

-   a node node specified in accordance with the [addressing rules](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenst_addressing_nodes.htm),
-   a [variable](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenst_tt_variable.htm) or a [parameter](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenst_tt_parameter.htm) variable,
-   a value value specified in accordance with the [rules for ABAP values](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenst_data.htm) (source field only)

An assignment between reference variables with tt:assign is possible only if the static type of the source variables is more specific or the same as the static type of the target variables (upcast). In all other cases, the [tt:cast](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenst_tt_cast.htm) statement can be used to perform a downcast.
