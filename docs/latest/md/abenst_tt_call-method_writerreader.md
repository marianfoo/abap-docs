...
title: "Syntax"
description: |
  <tt:call-method class='class'var='oref' s-d-name='meth' ... writer='p_writer' reader='p_reader'> ... </tt:call-method> Effect In the statistic method(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenst_tt_call-method_static.htm) or instance method(https://help.
version: "latest"
category: "general"
type: "abap-reference"
...
In the [statistic method](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenst_tt_call-method_static.htm) or [instance method](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenst_tt_call-method_instance.htm) called from an ST program, the attributes writer and reader can be used to access the current XML stream where the serialization or deserialization is currently taking place.
