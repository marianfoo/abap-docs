...
title: "Syntax"
description: |
  <tt:loop ref='node' name='alias'> ... </tt:loop> Effect Internal tables are serialized and deserialized within a loop defined by tt:loop that sets the current node(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenst_tt_ref.htm) to the current table line. The opt
version: "latest"
category: "general"
type: "abap-reference"
...
Internal tables are serialized and deserialized within a loop defined by tt:loop that sets the [current node](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenst_tt_ref.htm) to the current table line.
...
The transformation is [symmetrical](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenst_symmetry.htm). After deserialization, result has the same content as itab.