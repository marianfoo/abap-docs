...
The ST program DEMO\_ST\_TEXT4 below can deserialize the XML data, where all elements are skipped using [tt:skip](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenst_tt_skip.htm).
