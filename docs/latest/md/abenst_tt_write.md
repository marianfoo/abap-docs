...
title: "Syntax"
description: |
  <tt:write var='variable' map='...' lengthminLength='len' xsd-type... /> Effect The statement tt:write enables the writing of the value of a variable(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenst_tt_variable.htm) or parameter(https://help.sap.co
version: "latest"
category: "general"
type: "abap-reference"
...
The statement tt:write enables the writing of the value of a [variable](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenst_tt_variable.htm) or [parameter](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenst_tt_parameter.htm) to the target XML data.

variable is used to specify the variable to be written or to specify a parameter. The same applies to the attributes map, length, and minLength and to xsd-type... as to the statement [tt:value](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenst_tt_value_elementary.htm). The variable must represent an elementary value.
