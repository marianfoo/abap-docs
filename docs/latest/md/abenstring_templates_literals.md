...
title: "Syntax"
description: |
  c...c Effect Within a string template ..., a literal text c...c represents the exact character string it displays. Literal text consists of all characters in c that -   are not enclosed in curly brackets   -   are not control characters(https://help.sap.com/doc/abapdocu_latest_index_htm/latest
version: "latest"
category: "general"
type: "abap-reference"
