...
This example demonstrates the transformation of various [XML formats](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenabap_sxml_lib_formats.htm).
