...
title: "Source Code"
description: |
  Public class definition CLASS cl_demo_sxml_token_reader DEFINITION INHERITING FROM cl_demo_classrun PUBLIC CREATE PUBLIC. PUBLIC SECTION. METHODS main REDEFINITION. PRIVATE SECTION. METHODS get_node_type IMPORTING node_type_int           TYPE if_sxml_node=>node_type RETURNING VALUE(n
version: "latest"
category: "general"
type: "abap-reference"
...
Simple [token-based](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenabap_sxml_lib_parse_iterative.htm) reading of XML data.
