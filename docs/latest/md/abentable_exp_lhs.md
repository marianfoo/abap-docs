...
title: "Hint"
description: |
  The constructor operators VALUE and REF used to control the result(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abentable_exp_result.htm) of the table expression cannot be used in write positions. Example An internal table is prefilled with initial lines, which are overwritten w
version: "latest"
category: "general"
type: "abap-reference"
