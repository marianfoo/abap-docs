...
[TABLES table\_wa](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abaptables.htm).

[NODES table\_wa](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapnodes.htm).
...
-   TABLES and NODES declare [interface work areas](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenintern_extern_proc_call_guidl.htm "Guideline"), which are shared by multiple programs of a program group.
