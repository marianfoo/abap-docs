...
The Class Library contains the following system class for handling time stamps in [time stamp fields](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abentimestamp_field_glosry.htm "Glossary Entry"):
...
The attributes MIN and MAX contain the minimum and maximum values of the [time stamp type](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abentimestamp_type_glosry.htm "Glossary Entry") utclong.
...
Comparison of the method DIFF with the built-in function [utclong\_diff](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenutclong_diff.htm).
...
Continue
![Example](exa.gif "Example") [Read Time Stamp from String](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencl_utclong_read_abexa.htm)