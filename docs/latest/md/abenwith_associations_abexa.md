...
description: |
  This example demonstrates how CDS associations are exposed using WITH ASSOCIATIONS(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapwith_associations.htm) after a common table expression(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abencommon_table_expressio
version: "latest"
category: "general"
type: "abap-reference"
