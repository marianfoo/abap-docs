...
description: |
  This example demonstrates how common table expressions are used in the statement WITH(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapwith.htm). Source Code  Public class definition CLASS cl_demo_cte DEFINITION INHERITING FROM cl_demo_classrun PUBLIC CREATE PUBLIC. PUBLIC
version: "latest"
