...
title: "WRITE, Lines"
description: |
  When a list is output using WRITE(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapwrite-.htm), the characters - and  are replaced by suitable line elements(https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenline_element_glosry.htm 'Glossary Entry') if they
version: "latest"
category: "general"
type: "abap-reference"
...
When a list is output using [WRITE](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapwrite-.htm), the characters \- and | are replaced by suitable [line elements](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abenline_element_glosry.htm "Glossary Entry") if they are displayed directly beside or above each other. Line elements are horizontal and vertical lines, corners, crosses, and T elements. Character replacement produces continuous lines. A solitary character | is always replaced by a vertical line. When the system field sy-uline is displayed, each character in the field is always replaced by a horizontal line as in the statement [ULINE](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapuline.htm).
...
The replacement of characters by line elements can be switched off using the addition [FRAMES OFF](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapformat.htm).
...
-   The line elements used to replace characters can also be displayed explicitly as [list elements](https://help.sap.com/doc/abapdocu_latest_index_htm/latest/en-US/abapwrite_list_elements.htm). These can be used deliberately if the automatic replacements do not work as expected.